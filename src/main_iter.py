...
for hist in histlist:
    print(
        "[XSECT SUPPORT][main_iter] after find_yield_simc {} data_support={} simc_support={}".format(
            hist["phi_setting"],
...
print("[XSECT SUPPORT][main_iter] write_xsect_support returned {}".format(support_path))
