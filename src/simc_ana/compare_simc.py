...
# Description:
# ================================================================
# Time-stamp: "2024-12-30 14:29:03 trottar"
# ================================================================
#
...
def compare_simc(hist, inpDict):
    ...
    H_th_q_SIMC  = TH1D("H_th_q_SIMC","Theta Detected (th_xq)", 100, -math.pi, math.pi)
    H_ph_recoil_SIMC  = TH1D("H_ph_recoil_SIMC","Phi Recoil (ph_bq)", 100, -math.pi, math.pi)
    H_th_recoil_SIMC  = TH1D("H_th_recoil_SIMC","Theta Recoil (th_bq)", 100, -math.pi, math.pi)
    ...
    histDict["rootFileSimc"] = rootFileSimc
