...
# Description:
# ================================================================
# Time-stamp: "2024-01-15 05:03:19 trottar"
# ================================================================
#
...
def compare_simc(hist, inpDict):
    ...
    H_Weight_SIMC = TH1D("H_Weight_SIMC", "Simc Weight", 200, 0, 1e-8)
    H_hsdelta_SIMC  = TH1D("H_hsdelta_SIMC","HMS Delta", 200, -20.0, 20.0)
    H_hsxptar_SIMC  = TH1D("H_hsxptar_SIMC","HMS xptar", 200, -0.1, 0.1)
    H_hsyptar_SIMC  = TH1D("H_hsyptar_SIMC","HMS yptar", 200, -0.1, 0.1)
    H_ssxfp_SIMC    = TH1D("H_ssxfp_SIMC","SHMS xfp", 200, -25.0, 25.0)
    H_ssyfp_SIMC    = TH1D("H_ssyfp_SIMC","SHMS yfp", 200, -25.0, 25.0)
    H_ssxpfp_SIMC   = TH1D("H_ssxpfp_SIMC","SHMS xpfp", 200, -0.09, 0.09)
    H_ssypfp_SIMC   = TH1D("H_ssypfp_SIMC","SHMS ypfp", 200, -0.05, 0.04)
    H_hsxfp_SIMC    = TH1D("H_hsxfp_SIMC","HMS xfp", 200, -40.0, 40.0)
    H_hsyfp_SIMC    = TH1D("H_hsyfp_SIMC","HMS yfp", 200, -20.0, 20.0)
    H_hsxpfp_SIMC   = TH1D("H_hsxpfp_SIMC","HMS xpfp", 200, -0.09, 0.05)
    H_hsypfp_SIMC   = TH1D("H_hsypfp_SIMC","HMS ypfp", 200, -0.05, 0.04)
    H_ssdelta_SIMC  = TH1D("H_ssdelta_SIMC","SHMS delta", 200, -20.0, 20.0)
    H_ssxptar_SIMC  = TH1D("H_ssxptar_SIMC","SHMS xptar", 200, -0.1, 0.1)
    H_ssyptar_SIMC  = TH1D("H_ssyptar_SIMC","SHMS yptar", 200, -0.04, 0.04)
    H_q_SIMC        = TH1D("H_q_SIMC","q", 200, 0.0, 10.0)
    ...
    H_ph_q_SIMC  = TH1D("H_ph_q_SIMC","Phi Detected (ph_xq)", 200, 0.0, 360)
    ...
    H_pmiss_SIMC  = TH1D("H_pmiss_SIMC","pmiss", 200, 0.0, 10.0)
    H_emiss_SIMC  = TH1D("H_emiss_SIMC","emiss", 200, 0.0, 10.0)
    H_pmx_SIMC  = TH1D("H_pmx_SIMC","pmx", 200, -10.0, 10.0)
    H_pmy_SIMC  = TH1D("H_pmy_SIMC","pmy ", 200, -10.0, 10.0)
    H_pmz_SIMC  = TH1D("H_pmz_SIMC","pmz", 200, -10.0, 10.0)
    ...
    for i,evt in enumerate(TBRANCH_SIMC):
      ...
      if(HMS_Acceptance & SHMS_Acceptance & Diamond):
          ...
          polar_phiq_vs_t_SIMC.SetPoint(polar_phiq_vs_t_SIMC.GetN(), (evt.phipq-math.pi/2)*(180/math.pi), -evt.t)
          ...
          # SIMC goes from 0 to 2pi so no need for -pi/2
          H_ph_q_SIMC.Fill(((evt.phipq-math.pi/2)*(180/math.pi)), evt.Weight)
