...
# Description:
# ================================================================
# Time-stamp: "2024-12-12 00:49:52 trottar"
# ================================================================
#
...
def compare_simc(hist, inpDict):
    ...
    histDict["NumEvts_MM_SIMC"] = fit_gaussian(H_MM_SIMC, mm_min, mm_max, show_fit=False)[2]
    histDict["NumEvts_MM_unweighted_SIMC"] = fit_gaussian(H_MM_unweighted_SIMC, mm_min, mm_max, show_fit=False)[2]
