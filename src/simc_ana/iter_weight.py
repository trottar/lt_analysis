...
def iter_weight(param_file, simc_root, inpDict, phi_setting):
    ...
    for i,evt in enumerate(TBRANCH_SIMC):
      ...
      if iter_num > 1:
          ...
          # After 7/31/2025
          inp_param = '{} {} {} {} {} {} {} {} {} {} '\
                      .format(Q2, W, evt.Q2i, evt.Wi, evt.ti, evt.epscm, evt.thetacm, evt.phipqcm, evt.iter_sig, evt.iter_weight)+' '.join(param_arr)          
          ...
          # After 7/31/2025
          inp_param = '{} {} {} {} {} {} {} {} {} {} '\
                      .format(Q2, W, evt.Q2i, evt.Wi, evt.ti, evt.epscm, evt.thetacm, evt.phipqcm, evt.sigcm, evt.Weight)+' '.join(param_arr)                    
