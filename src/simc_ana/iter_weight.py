...
# ================================================================
# Time-stamp: "2024-04-05 20:33:56 trottar"
# ================================================================
#
...
def iter_weight(param_file, simc_root, inpDict, phi_setting):
    ...
    if iter_num > 1:
        ...
        iter_weight = ROOT.Double()
        iter_weight_branch = new_TBRANCH_SIMC.Branch("iter_weight", iter_weight, "iter_weight/F")  # Create a new branch in h10 tree
        iter_sig = ROOT.Double()
        iter_sig_branch = new_TBRANCH_SIMC.Branch("iter_sig", iter_sig, "iter_sig/F")  # Create a new branch in h10 tree
