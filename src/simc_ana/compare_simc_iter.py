...
# Description:
# ================================================================
# Time-stamp: "2024-09-19 10:15:18 trottar"
# ================================================================
#
...
def compare_simc(rootFileSimc, hist, inpDict):
    ...
    H_Weight_SIMC = TH1D("H_Weight_SIMC", "Simc Weight", 1000, 0, 1e-5)
    H_iWeight_SIMC = TH1D("H_iWeight_SIMC", "Simc iWeight", 1000, 0, 1e-5)
    ...
    H_MM_SIMC  = TH1D("H_MM_SIMC","MM_{K}", 1000, inpDict["mm_min"], inpDict["mm_max"])
    H_MM_unweighted_SIMC  = TH1D("H_MM_unweighted_SIMC","MM_unweighted_{K}", 1000, inpDict["mm_min"], inpDict["mm_max"])    
    H_th_SIMC  = TH1D("H_th_SIMC","X' tar", 1000, -0.1, 0.1)
    H_ph_SIMC  = TH1D("H_ph_SIMC","Y' tar", 1000, -0.1, 0.1)
    H_ph_q_SIMC  = TH1D("H_ph_q_SIMC","Phi Detected (ph_xq)", 1000, -math.pi, math.pi)
    ...
    H_pmiss_SIMC  = TH1D("H_pmiss_SIMC","pmiss", 1000, 0.0, 2.0)
    H_emiss_SIMC  = TH1D("H_emiss_SIMC","emiss", 1000, 0.0, 2.0)
