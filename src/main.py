...
# Description:
# ================================================================
# Time-stamp: "2024-01-29 16:11:33 trottar"
# ================================================================
#
...
if DEBUG:
    # Show plot pdf for each setting
    for hist in histlist:        
        show_pdf_with_evince(outputpdf.replace("{}_FullAnalysis_".format(ParticleType),"{}_{}_simc_rand_sub_".format(hist["phi_setting"],ParticleType)))
for hist in histlist:
    output_file_lst.append(outputpdf.replace("{}_FullAnalysis_".format(ParticleType),"{}_{}_simc_rand_sub_".format(hist["phi_setting"],ParticleType)))
