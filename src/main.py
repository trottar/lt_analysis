...
# Description:
# ================================================================
# Time-stamp: "2024-01-24 13:45:18 trottar"
# ================================================================
#
...
if Q2Val == 3.0:
    ...
    inpDict["Q2min"] = Q2Val - (3/6)*Q2Val
    inpDict["Q2max"] = Q2Val + (3/6)*Q2Val
    inpDict["Wmin"] = WVal - (3/6)*WVal
    inpDict["Wmax"] = WVal + (3/6)*WVal
else:
...
shutil.copy(LTANAPATH+'/src/simc_ana/par_pl', '{}/src/{}/parameters/par.{}_Q{}W{}.dat'.format(LTANAPATH, ParticleType, pol_str, Q2.replace("p",""), W.replace("p","")))
