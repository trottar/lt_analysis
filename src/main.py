...
# Description:
# ================================================================
# Time-stamp: "2024-09-17 16:35:30 trottar"
# ================================================================
#
...
if Q2Val == 2.1:
    ...
    inpDict["Q2min"] = 0.385 - (2.1/7)*0.385
    inpDict["Q2max"] = 0.385 + (2.1/7)*0.385
    inpDict["Wmin"] = WVal - (2.1/7)*WVal
    inpDict["Wmax"] = WVal + (2.1/7)*WVal
else:
