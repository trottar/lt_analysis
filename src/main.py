...
# Description:
# ================================================================
# Time-stamp: "2024-09-17 13:28:04 trottar"
# ================================================================
#
...
if Q2Val == 2.1:
    ...
    inpDict["Q2min"] = Q2Val - (2/10)*Q2Val
    inpDict["Q2max"] = Q2Val + (2/10)*Q2Val
    inpDict["Wmin"] = WVal - (2/10)*WVal
    inpDict["Wmax"] = WVal + (2/10)*WVal    
else:
