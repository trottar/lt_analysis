...
# Description:
# ================================================================
# Time-stamp: "2024-01-14 23:12:11 trottar"
# ================================================================
#
...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_hsdelta_DUMMY"] = hist["H_hsdelta_DUMMY"]
        hist["H_hsxptar_DUMMY"] = hist["H_hsxptar_DUMMY"]
        hist["H_hsyptar_DUMMY"] = hist["H_hsyptar_DUMMY"]
        hist["H_ssxfp_DUMMY"] = hist["H_ssxfp_DUMMY"]
        hist["H_ssyfp_DUMMY"] = hist["H_ssyfp_DUMMY"]
        hist["H_ssxpfp_DUMMY"] = hist["H_ssxpfp_DUMMY"]
        hist["H_ssypfp_DUMMY"] = hist["H_ssypfp_DUMMY"]
        hist["H_hsxfp_DUMMY"] = hist["H_hsxfp_DUMMY"]
        hist["H_hsyfp_DUMMY"] = hist["H_hsyfp_DUMMY"]
        hist["H_hsxpfp_DUMMY"] = hist["H_hsxpfp_DUMMY"]
        hist["H_hsypfp_DUMMY"] = hist["H_hsypfp_DUMMY"]
        hist["H_ssdelta_DUMMY"] = hist["H_ssdelta_DUMMY"]
        hist["H_ssxptar_DUMMY"] = hist["H_ssxptar_DUMMY"]
        hist["H_ssyptar_DUMMY"] = hist["H_ssyptar_DUMMY"]
        hist["H_q_DUMMY"] = hist["H_q_DUMMY"]
        hist["H_Q2_DUMMY"] = hist["H_Q2_DUMMY"]
        hist["H_t_DUMMY"] = hist["H_t_DUMMY"]
        hist["H_epsilon_DUMMY"] = hist["H_epsilon_DUMMY"]
        hist["H_MM_DUMMY"] = hist["H_MM_DUMMY"]
        hist["H_th_DUMMY"] = hist["H_th_DUMMY"]
        hist["H_ph_DUMMY"] = hist["H_ph_DUMMY"]
        hist["H_ph_q_DUMMY"] = hist["H_ph_q_DUMMY"]
        hist["H_th_q_DUMMY"] = hist["H_th_q_DUMMY"]
        hist["H_ph_recoil_DUMMY"] = hist["H_ph_recoil_DUMMY"]
        hist["H_th_recoil_DUMMY"] = hist["H_th_recoil_DUMMY"]
        hist["H_pmiss_DUMMY"] = hist["H_pmiss_DUMMY"]
        hist["H_emiss_DUMMY"] = hist["H_emiss_DUMMY"]
        hist["H_pmx_DUMMY"] = hist["H_pmx_DUMMY"]
        hist["H_pmy_DUMMY"] = hist["H_pmy_DUMMY"]
        hist["H_pmz_DUMMY"] = hist["H_pmz_DUMMY"]
        hist["H_W_DUMMY"] = hist["H_W_DUMMY"]
        hist["H_ct_DUMMY"] = hist["H_ct_DUMMY"]
        hist["MM_vs_CoinTime_DUMMY"] = hist["MM_vs_CoinTime_DUMMY"]
        hist["CoinTime_vs_beta_DUMMY"] = hist["CoinTime_vs_beta_DUMMY"]
        hist["MM_vs_beta_DUMMY"] = hist["MM_vs_beta_DUMMY"]
        hist["phiq_vs_t_DUMMY"] = hist["phiq_vs_t_DUMMY"]
        hist["polar_phiq_vs_t_DUMMY"] = hist["polar_phiq_vs_t_DUMMY"]
        hist["H_hsdelta_DATA"] = hist["H_hsdelta_DATA"]
        hist["H_hsxptar_DATA"] = hist["H_hsxptar_DATA"]
        hist["H_hsyptar_DATA"] = hist["H_hsyptar_DATA"]
        hist["H_ssxfp_DATA"] = hist["H_ssxfp_DATA"]
        hist["H_ssyfp_DATA"] = hist["H_ssyfp_DATA"]
        hist["H_ssxpfp_DATA"] = hist["H_ssxpfp_DATA"]
        hist["H_ssypfp_DATA"] = hist["H_ssypfp_DATA"]
        hist["H_hsxfp_DATA"] = hist["H_hsxfp_DATA"]
        hist["H_hsyfp_DATA"] = hist["H_hsyfp_DATA"]
        hist["H_hsxpfp_DATA"] = hist["H_hsxpfp_DATA"]
        hist["H_hsypfp_DATA"] = hist["H_hsypfp_DATA"]
        hist["H_ssdelta_DATA"] = hist["H_ssdelta_DATA"]
        hist["H_ssxptar_DATA"] = hist["H_ssxptar_DATA"]
        hist["H_ssyptar_DATA"] = hist["H_ssyptar_DATA"]
        hist["H_q_DATA"] = hist["H_q_DATA"]
        hist["H_Q2_DATA"] = hist["H_Q2_DATA"]
        hist["H_t_DATA"] = hist["H_t_DATA"]
        hist["H_epsilon_DATA"] = hist["H_epsilon_DATA"]
        hist["H_MM_DATA"] = hist["H_MM_DATA"]
        hist["H_th_DATA"] = hist["H_th_DATA"]
        hist["H_ph_DATA"] = hist["H_ph_DATA"]
        hist["H_ph_q_DATA"] = hist["H_ph_q_DATA"]
        hist["H_th_q_DATA"] = hist["H_th_q_DATA"]
        hist["H_ph_recoil_DATA"] = hist["H_ph_recoil_DATA"]
        hist["H_th_recoil_DATA"] = hist["H_th_recoil_DATA"]
        hist["H_pmiss_DATA"] = hist["H_pmiss_DATA"]
        hist["H_emiss_DATA"] = hist["H_emiss_DATA"]
        hist["H_pmx_DATA"] = hist["H_pmx_DATA"]
        hist["H_pmy_DATA"] = hist["H_pmy_DATA"]
        hist["H_pmz_DATA"] = hist["H_pmz_DATA"]
        hist["H_W_DATA"] = hist["H_W_DATA"]
        hist["H_ct_DATA"] = hist["H_ct_DATA"]
        hist["H_cal_etottracknorm_DATA"] = hist["H_cal_etottracknorm_DATA"]
        hist["H_cer_npeSum_DATA"] = hist["H_cer_npeSum_DATA"]
        hist["P_cal_etottracknorm_DATA"] = hist["P_cal_etottracknorm_DATA"]
        hist["P_hgcer_npeSum_DATA"] = hist["P_hgcer_npeSum_DATA"]
        hist["P_aero_npeSum_DATA"] = hist["P_aero_npeSum_DATA"]
        hist["MM_vs_CoinTime_DATA"] = hist["MM_vs_CoinTime_DATA"]
        hist["CoinTime_vs_beta_DATA"] = hist["CoinTime_vs_beta_DATA"]
        hist["MM_vs_beta_DATA"] = hist["MM_vs_beta_DATA"]
        hist["phiq_vs_t_DATA"] = hist["phiq_vs_t_DATA"]
        hist["polar_phiq_vs_t_DATA"] = hist["polar_phiq_vs_t_DATA"]
        hist["Q2_vs_W_DATA"] = hist["Q2_vs_W_DATA"]
