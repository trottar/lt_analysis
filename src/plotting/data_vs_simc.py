...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssyptar_ssxptar_simc = TH1D_to_TH2D(hist["H_ssxptar_SIMC"], hist["H_ssyptar_SIMC"], h2d_name="h_ssyptar_ssxptar_simc", title=f"{phisetlist[i]} Simc;SHMS xptar;SHMS yptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsyptar_hsxptar_simc = TH1D_to_TH2D(hist["H_hsxptar_SIMC"], hist["H_hsyptar_SIMC"], h2d_name="h_hsyptar_hsxptar_simc", title=f"{phisetlist[i]} Simc;HMS xptar;HMS yptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsdelta_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_hsdelta_SIMC"], h2d_name="h_hsdelta_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;HMS Delta", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssxptar_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_ssxptar_SIMC"], h2d_name="h_ssxptar_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS Delta;SHMS xptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsxptar_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_hsxptar_SIMC"], h2d_name="h_hsxptar_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS Delta;HMS xptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssyptar_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_ssyptar_SIMC"], h2d_name="h_ssyptar_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS Delta;SHMS yptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsyptar_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_hsyptar_SIMC"], h2d_name="h_hsyptar_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS Delta;HMS yptar", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_Q2[i].cd(2)
        h_Q2_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_Q2_SIMC"], h2d_name="h_Q2_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;Q2", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_Q2[i].cd(2)
        h_Q2_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_Q2_SIMC"], h2d_name="h_Q2_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;Q2", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_W[i].cd(2)
        h_W_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_W_SIMC"], h2d_name="h_W_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;W", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_W[i].cd(2)
        h_W_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_W_SIMC"], h2d_name="h_W_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;W", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_t[i].cd(2)
        h_t_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_t_SIMC"], h2d_name="h_t_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;|-t|", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_t[i].cd(2)
        h_t_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_t_SIMC"], h2d_name="h_t_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;|-t|", n_bins=50)
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ph_q_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_ph_q_SIMC"], h2d_name="h_ph_q_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;ph_q", n_bins=50)
