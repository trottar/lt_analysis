...
# Description:
# ================================================================
# Time-stamp: "2024-01-14 23:16:19 trottar"
# ================================================================
#
...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_hsdelta_SIMC"] = hist["H_hsdelta_SIMC"]*hist["normfac_simc"]
        hist["H_hsxptar_SIMC"] = hist["H_hsxptar_SIMC"]*hist["normfac_simc"]
        hist["H_hsyptar_SIMC"] = hist["H_hsyptar_SIMC"]*hist["normfac_simc"]
        hist["H_ssxfp_SIMC"] = hist["H_ssxfp_SIMC"]*hist["normfac_simc"]
        hist["H_ssyfp_SIMC"] = hist["H_ssyfp_SIMC"]*hist["normfac_simc"]
        hist["H_ssxpfp_SIMC"] = hist["H_ssxpfp_SIMC"]*hist["normfac_simc"]
        hist["H_ssypfp_SIMC"] = hist["H_ssypfp_SIMC"]*hist["normfac_simc"]
        hist["H_hsxfp_SIMC"] = hist["H_hsxfp_SIMC"]*hist["normfac_simc"]
        hist["H_hsyfp_SIMC"] = hist["H_hsyfp_SIMC"]*hist["normfac_simc"]
        hist["H_hsxpfp_SIMC"] = hist["H_hsxpfp_SIMC"]*hist["normfac_simc"]
        hist["H_hsypfp_SIMC"] = hist["H_hsypfp_SIMC"]*hist["normfac_simc"]
        hist["H_ssdelta_SIMC"] = hist["H_ssdelta_SIMC"]*hist["normfac_simc"]
        hist["H_ssxptar_SIMC"] = hist["H_ssxptar_SIMC"]*hist["normfac_simc"]
        hist["H_ssyptar_SIMC"] = hist["H_ssyptar_SIMC"]*hist["normfac_simc"]
        hist["H_q_SIMC"] = hist["H_q_SIMC"]*hist["normfac_simc"]
        hist["H_Q2_SIMC"] = hist["H_Q2_SIMC"]*hist["normfac_simc"]
        hist["H_t_SIMC"] = hist["H_t_SIMC"]*hist["normfac_simc"]
        hist["H_epsilon_SIMC"] = hist["H_epsilon_SIMC"]*hist["normfac_simc"]
        hist["H_MM_SIMC"] = hist["H_MM_SIMC"]*hist["normfac_simc"]
        hist["H_th_SIMC"] = hist["H_th_SIMC"]*hist["normfac_simc"]
        hist["H_ph_SIMC"] = hist["H_ph_SIMC"]*hist["normfac_simc"]
        hist["H_ph_q_SIMC"] = hist["H_ph_q_SIMC"]*hist["normfac_simc"]
        hist["H_th_q_SIMC"] = hist["H_th_q_SIMC"]*hist["normfac_simc"]
        hist["H_ph_recoil_SIMC"] = hist["H_ph_recoil_SIMC"]*hist["normfac_simc"]
        hist["H_th_recoil_SIMC"] = hist["H_th_recoil_SIMC"]*hist["normfac_simc"]
        hist["H_pmiss_SIMC"] = hist["H_pmiss_SIMC"]*hist["normfac_simc"]
        hist["H_emiss_SIMC"] = hist["H_emiss_SIMC"]*hist["normfac_simc"]
        hist["H_pmx_SIMC"] = hist["H_pmx_SIMC"]*hist["normfac_simc"]
        hist["H_pmy_SIMC"] = hist["H_pmy_SIMC"]*hist["normfac_simc"]
        hist["H_pmz_SIMC"] = hist["H_pmz_SIMC"]*hist["normfac_simc"]
        hist["H_W_SIMC"] = hist["H_W_SIMC"]*hist["normfac_simc"]
        hist["polar_phiq_vs_t_SIMC"] = hist["polar_phiq_vs_t_SIMC"]*hist["normfac_simc"]

        hist["H_hsdelta_DUMMY"] = hist["H_hsdelta_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsxptar_DUMMY"] = hist["H_hsxptar_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsyptar_DUMMY"] = hist["H_hsyptar_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssxfp_DUMMY"] = hist["H_ssxfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssyfp_DUMMY"] = hist["H_ssyfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssxpfp_DUMMY"] = hist["H_ssxpfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssypfp_DUMMY"] = hist["H_ssypfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsxfp_DUMMY"] = hist["H_hsxfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsyfp_DUMMY"] = hist["H_hsyfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsxpfp_DUMMY"] = hist["H_hsxpfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_hsypfp_DUMMY"] = hist["H_hsypfp_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssdelta_DUMMY"] = hist["H_ssdelta_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssxptar_DUMMY"] = hist["H_ssxptar_DUMMY"]*hist["normfac_dummy"]
        hist["H_ssyptar_DUMMY"] = hist["H_ssyptar_DUMMY"]*hist["normfac_dummy"]
        hist["H_q_DUMMY"] = hist["H_q_DUMMY"]*hist["normfac_dummy"]
        hist["H_Q2_DUMMY"] = hist["H_Q2_DUMMY"]*hist["normfac_dummy"]
        hist["H_t_DUMMY"] = hist["H_t_DUMMY"]*hist["normfac_dummy"]
        hist["H_epsilon_DUMMY"] = hist["H_epsilon_DUMMY"]*hist["normfac_dummy"]
        hist["H_MM_DUMMY"] = hist["H_MM_DUMMY"]*hist["normfac_dummy"]
        hist["H_th_DUMMY"] = hist["H_th_DUMMY"]*hist["normfac_dummy"]
        hist["H_ph_DUMMY"] = hist["H_ph_DUMMY"]*hist["normfac_dummy"]
        hist["H_ph_q_DUMMY"] = hist["H_ph_q_DUMMY"]*hist["normfac_dummy"]
        hist["H_th_q_DUMMY"] = hist["H_th_q_DUMMY"]*hist["normfac_dummy"]
        hist["H_ph_recoil_DUMMY"] = hist["H_ph_recoil_DUMMY"]*hist["normfac_dummy"]
        hist["H_th_recoil_DUMMY"] = hist["H_th_recoil_DUMMY"]*hist["normfac_dummy"]
        hist["H_pmiss_DUMMY"] = hist["H_pmiss_DUMMY"]*hist["normfac_dummy"]
        hist["H_emiss_DUMMY"] = hist["H_emiss_DUMMY"]*hist["normfac_dummy"]
        hist["H_pmx_DUMMY"] = hist["H_pmx_DUMMY"]*hist["normfac_dummy"]
        hist["H_pmy_DUMMY"] = hist["H_pmy_DUMMY"]*hist["normfac_dummy"]
        hist["H_pmz_DUMMY"] = hist["H_pmz_DUMMY"]*hist["normfac_dummy"]
        hist["H_W_DUMMY"] = hist["H_W_DUMMY"]*hist["normfac_dummy"]
        hist["H_ct_DUMMY"] = hist["H_ct_DUMMY"]*hist["normfac_dummy"]
        hist["MM_vs_CoinTime_DUMMY"] = hist["MM_vs_CoinTime_DUMMY"]*hist["normfac_dummy"]
        hist["CoinTime_vs_beta_DUMMY"] = hist["CoinTime_vs_beta_DUMMY"]*hist["normfac_dummy"]
        hist["MM_vs_beta_DUMMY"] = hist["MM_vs_beta_DUMMY"]*hist["normfac_dummy"]
        hist["phiq_vs_t_DUMMY"] = hist["phiq_vs_t_DUMMY"]*hist["normfac_dummy"]
        hist["polar_phiq_vs_t_DUMMY"] = hist["polar_phiq_vs_t_DUMMY"]*hist["normfac_dummy"]
        
        hist["H_hsdelta_DATA"] = hist["H_hsdelta_DATA"]*hist["normfac_data"]
        hist["H_hsxptar_DATA"] = hist["H_hsxptar_DATA"]*hist["normfac_data"]
        hist["H_hsyptar_DATA"] = hist["H_hsyptar_DATA"]*hist["normfac_data"]
        hist["H_ssxfp_DATA"] = hist["H_ssxfp_DATA"]*hist["normfac_data"]
        hist["H_ssyfp_DATA"] = hist["H_ssyfp_DATA"]*hist["normfac_data"]
        hist["H_ssxpfp_DATA"] = hist["H_ssxpfp_DATA"]*hist["normfac_data"]
        hist["H_ssypfp_DATA"] = hist["H_ssypfp_DATA"]*hist["normfac_data"]
        hist["H_hsxfp_DATA"] = hist["H_hsxfp_DATA"]*hist["normfac_data"]
        hist["H_hsyfp_DATA"] = hist["H_hsyfp_DATA"]*hist["normfac_data"]
        hist["H_hsxpfp_DATA"] = hist["H_hsxpfp_DATA"]*hist["normfac_data"]
        hist["H_hsypfp_DATA"] = hist["H_hsypfp_DATA"]*hist["normfac_data"]
        hist["H_ssdelta_DATA"] = hist["H_ssdelta_DATA"]*hist["normfac_data"]
        hist["H_ssxptar_DATA"] = hist["H_ssxptar_DATA"]*hist["normfac_data"]
        hist["H_ssyptar_DATA"] = hist["H_ssyptar_DATA"]*hist["normfac_data"]
        hist["H_q_DATA"] = hist["H_q_DATA"]*hist["normfac_data"]
        hist["H_Q2_DATA"] = hist["H_Q2_DATA"]*hist["normfac_data"]
        hist["H_t_DATA"] = hist["H_t_DATA"]*hist["normfac_data"]
        hist["H_epsilon_DATA"] = hist["H_epsilon_DATA"]*hist["normfac_data"]
        hist["H_MM_DATA"] = hist["H_MM_DATA"]*hist["normfac_data"]
        hist["H_th_DATA"] = hist["H_th_DATA"]*hist["normfac_data"]
        hist["H_ph_DATA"] = hist["H_ph_DATA"]*hist["normfac_data"]
        hist["H_ph_q_DATA"] = hist["H_ph_q_DATA"]*hist["normfac_data"]
        hist["H_th_q_DATA"] = hist["H_th_q_DATA"]*hist["normfac_data"]
        hist["H_ph_recoil_DATA"] = hist["H_ph_recoil_DATA"]*hist["normfac_data"]
        hist["H_th_recoil_DATA"] = hist["H_th_recoil_DATA"]*hist["normfac_data"]
        hist["H_pmiss_DATA"] = hist["H_pmiss_DATA"]*hist["normfac_data"]
        hist["H_emiss_DATA"] = hist["H_emiss_DATA"]*hist["normfac_data"]
        hist["H_pmx_DATA"] = hist["H_pmx_DATA"]*hist["normfac_data"]
        hist["H_pmy_DATA"] = hist["H_pmy_DATA"]*hist["normfac_data"]
        hist["H_pmz_DATA"] = hist["H_pmz_DATA"]*hist["normfac_data"]
        hist["H_W_DATA"] = hist["H_W_DATA"]*hist["normfac_data"]
        hist["H_ct_DATA"] = hist["H_ct_DATA"]*hist["normfac_data"]
        hist["H_cal_etottracknorm_DATA"] = hist["H_cal_etottracknorm_DATA"]*hist["normfac_data"]
        hist["H_cer_npeSum_DATA"] = hist["H_cer_npeSum_DATA"]*hist["normfac_data"]
        hist["P_cal_etottracknorm_DATA"] = hist["P_cal_etottracknorm_DATA"]*hist["normfac_data"]
        hist["P_hgcer_npeSum_DATA"] = hist["P_hgcer_npeSum_DATA"]*hist["normfac_data"]
        hist["P_aero_npeSum_DATA"] = hist["P_aero_npeSum_DATA"]*hist["normfac_data"]
        hist["MM_vs_CoinTime_DATA"] = hist["MM_vs_CoinTime_DATA"]*hist["normfac_data"]
        hist["CoinTime_vs_beta_DATA"] = hist["CoinTime_vs_beta_DATA"]*hist["normfac_data"]
        hist["MM_vs_beta_DATA"] = hist["MM_vs_beta_DATA"]*hist["normfac_data"]
        hist["phiq_vs_t_DATA"] = hist["phiq_vs_t_DATA"]*hist["normfac_data"]
        hist["polar_phiq_vs_t_DATA"] = hist["polar_phiq_vs_t_DATA"]*hist["normfac_data"]
        hist["Q2_vs_W_DATA"] = hist["Q2_vs_W_DATA"]*hist["normfac_data"]
