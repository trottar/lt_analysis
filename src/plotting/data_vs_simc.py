...
# Description:
# ================================================================
# Time-stamp: "2024-08-29 15:43:35 trottar"
# ================================================================
#
...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssyptar_ssxptar_data = TH1D_to_TH2D(hist["H_ssxptar_DATA"], hist["H_ssyptar_DATA"], h2d_name="h_ssyptar_ssxptar_data", title=f"{phisetlist[i]} Data;SHMS xptar;SHMS yptar", n_bins=50)
        h_ssyptar_ssxptar_data.Draw("COLZ")
        C_ssxptar_ssyptar[i].cd(2)
        h_ssyptar_ssxptar_simc = TH1D_to_TH2D(hist["H_ssxptar_SIMC"], hist["H_ssyptar_SIMC"], h2d_name="h_ssyptar_ssxptar_simc", title=f"{phisetlist[i]} Simc;SHMS xptar;SHMS yptar", n_bins=50, z_min=1e-12, z_max=h_ssyptar_ssxptar_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsyptar_hsxptar_data = TH1D_to_TH2D(hist["H_hsxptar_DATA"], hist["H_hsyptar_DATA"], h2d_name="h_hsyptar_hsxptar_data", title=f"{phisetlist[i]} Data;HMS xptar;HMS yptar", n_bins=50)
        h_hsyptar_hsxptar_data.Draw("COLZ")
        C_hsxptar_hsyptar[i].cd(2)
        h_hsyptar_hsxptar_simc = TH1D_to_TH2D(hist["H_hsxptar_SIMC"], hist["H_hsyptar_SIMC"], h2d_name="h_hsyptar_hsxptar_simc", title=f"{phisetlist[i]} Simc;HMS xptar;HMS yptar", n_bins=50, z_min=1e-12, z_max=h_hsyptar_hsxptar_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsdelta_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_hsdelta_DATA"], h2d_name="h_hsdelta_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS delta;HMS Delta", n_bins=50)
        h_hsdelta_ssdelta_data.Draw("COLZ")
        C_ssdelta_hsdelta[i].cd(2)
        h_hsdelta_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_hsdelta_SIMC"], h2d_name="h_hsdelta_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;HMS Delta", n_bins=50, z_min=1e-12, z_max=h_hsdelta_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssxptar_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_ssxptar_DATA"], h2d_name="h_ssxptar_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS Delta;SHMS xptar", n_bins=50)
        h_ssxptar_ssdelta_data.Draw("COLZ")
        C_ssdelta_ssxptar[i].cd(2)
        h_ssxptar_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_ssxptar_SIMC"], h2d_name="h_ssxptar_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS Delta;SHMS xptar", n_bins=50, z_min=1e-12, z_max=h_ssxptar_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsxptar_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_hsxptar_DATA"], h2d_name="h_hsxptar_hsdelta_data", title=f"{phisetlist[i]} Data;HMS Delta;HMS xptar", n_bins=50)
        h_hsxptar_hsdelta_data.Draw("COLZ")
        C_hsdelta_hsxptar[i].cd(2)
        h_hsxptar_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_hsxptar_SIMC"], h2d_name="h_hsxptar_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS Delta;HMS xptar", n_bins=50, z_min=1e-12, z_max=h_hsxptar_hsdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_ssyptar_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_ssyptar_DATA"], h2d_name="h_ssyptar_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS Delta;SHMS yptar", n_bins=50)
        h_ssyptar_ssdelta_data.Draw("COLZ")
        C_ssdelta_ssyptar[i].cd(2)
        h_ssyptar_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_ssyptar_SIMC"], h2d_name="h_ssyptar_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS Delta;SHMS yptar", n_bins=50, z_min=1e-12, z_max=h_ssyptar_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        h_hsyptar_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_hsyptar_DATA"], h2d_name="h_hsyptar_hsdelta_data", title=f"{phisetlist[i]} Data;HMS Delta;HMS yptar", n_bins=50)
        h_hsyptar_hsdelta_data.Draw("COLZ")
        C_hsdelta_hsyptar[i].cd(2)
        h_hsyptar_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_hsyptar_SIMC"], h2d_name="h_hsyptar_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS Delta;HMS yptar", n_bins=50, z_min=1e-12, z_max=h_hsyptar_hsdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_Q2[i].cd(1)
        h_Q2_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_Q2_DATA"], h2d_name="h_Q2_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS delta;Q2", n_bins=50)
        h_Q2_ssdelta_data.Draw("COLZ")
        C_ssdelta_Q2[i].cd(2)
        h_Q2_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_Q2_SIMC"], h2d_name="h_Q2_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;Q2", n_bins=50, z_min=1e-12, z_max=h_Q2_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_Q2[i].cd(1)
        h_Q2_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_Q2_DATA"], h2d_name="h_Q2_hsdelta_data", title=f"{phisetlist[i]} Data;HMS delta;Q2", n_bins=50)
        h_Q2_hsdelta_data.Draw("COLZ")
        C_hsdelta_Q2[i].cd(2)
        h_Q2_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_Q2_SIMC"], h2d_name="h_Q2_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;Q2", n_bins=50, z_min=1e-12, z_max=h_Q2_hsdelta_data.GetMaximum())
        h_Q2_hsdelta_simc.Draw("COLZ")
        C_hsdelta_Q2[i].Print(outputpdf)

    C_ssdelta_MM_nosub = []        
    for i,hist in enumerate(histlist_copy):
        C_ssdelta_MM_nosub.append(TCanvas())
        C_ssdelta_MM_nosub[i].Divide(1,2)
        C_ssdelta_MM_nosub[i].cd(1)
        h_MM_nosub_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_MM_nosub_DATA"], h2d_name="h_MM_nosub_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS delta;MM_nosub", n_bins=50)
        h_MM_nosub_ssdelta_data.Draw("COLZ")
        C_ssdelta_MM_nosub[i].cd(2)
        h_MM_nosub_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_MM_nosub_SIMC"], h2d_name="h_MM_nosub_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;MM_nosub", n_bins=50, z_min=1e-12, z_max=h_MM_nosub_ssdelta_data.GetMaximum())
        h_MM_nosub_ssdelta_simc.Draw("COLZ")
        C_ssdelta_MM_nosub[i].Print(outputpdf)

    C_hsdelta_MM_nosub = []        
    for i,hist in enumerate(histlist_copy):
        C_hsdelta_MM_nosub.append(TCanvas())
        C_hsdelta_MM_nosub[i].Divide(1,2)
        C_hsdelta_MM_nosub[i].cd(1)
        h_MM_nosub_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_MM_nosub_DATA"], h2d_name="h_MM_nosub_hsdelta_data", title=f"{phisetlist[i]} Data;HMS delta;MM_nosub", n_bins=50)
        h_MM_nosub_hsdelta_data.Draw("COLZ")
        C_hsdelta_MM_nosub[i].cd(2)
        h_MM_nosub_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_MM_nosub_SIMC"], h2d_name="h_MM_nosub_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;MM_nosub", n_bins=50, z_min=1e-12, z_max=h_MM_nosub_hsdelta_data.GetMaximum())
        h_MM_nosub_hsdelta_simc.Draw("COLZ")
        C_hsdelta_MM_nosub[i].Print(outputpdf)        
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_W[i].cd(1)
        h_W_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_W_DATA"], h2d_name="h_W_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS delta;W", n_bins=50)
        h_W_ssdelta_data.Draw("COLZ")
        C_ssdelta_W[i].cd(2)
        h_W_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_W_SIMC"], h2d_name="h_W_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;W", n_bins=50, z_min=1e-12, z_max=h_W_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_W[i].cd(1)
        h_W_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_W_DATA"], h2d_name="h_W_hsdelta_data", title=f"{phisetlist[i]} Data;HMS delta;W", n_bins=50)
        h_W_hsdelta_data.Draw("COLZ")
        C_hsdelta_W[i].cd(2)
        h_W_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_W_SIMC"], h2d_name="h_W_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;W", n_bins=50, z_min=1e-12, z_max=h_W_hsdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_t[i].cd(1)
        h_t_ssdelta_data = TH1D_to_TH2D(hist["H_ssdelta_DATA"], hist["H_t_DATA"], h2d_name="h_t_ssdelta_data", title=f"{phisetlist[i]} Data;SHMS delta;|-t|", n_bins=50)
        h_t_ssdelta_data.Draw("COLZ")
        C_ssdelta_t[i].cd(2)
        h_t_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_t_SIMC"], h2d_name="h_t_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;|-t|", n_bins=50, z_min=1e-12, z_max=h_t_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_t[i].cd(1)
        h_t_hsdelta_data = TH1D_to_TH2D(hist["H_hsdelta_DATA"], hist["H_t_DATA"], h2d_name="h_t_hsdelta_data", title=f"{phisetlist[i]} Data;HMS delta;|-t|", n_bins=50)
        h_t_hsdelta_data.Draw("COLZ")
        C_hsdelta_t[i].cd(2)
        h_t_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_t_SIMC"], h2d_name="h_t_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;|-t|", n_bins=50, z_min=1e-12, z_max=h_t_hsdelta_data.GetMaximum())
