...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_ssxfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssyfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssxpfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssypfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_hsxfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_hsyfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_hsxpfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_hsypfp_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssdelta_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssxptar_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ssyptar_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_q_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_Q2_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_t_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_epsilon_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_MM_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_th_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ph_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ph_q_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_th_q_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_ph_recoil_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_th_recoil_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_pmiss_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_emiss_SIMC"].Scale(hist["normfac_simc"]*1e6)
        hist["H_pmx_SIMC"].Scale(hist["normfac_simc"]*1e6)
