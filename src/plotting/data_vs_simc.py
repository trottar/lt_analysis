...
# Description:
# ================================================================
# Time-stamp: "2024-01-14 23:27:44 trottar"
# ================================================================
#
...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_hsdelta_SIMC"] = hist["H_hsdelta_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsxptar_SIMC"] = hist["H_hsxptar_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsyptar_SIMC"] = hist["H_hsyptar_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssxfp_SIMC"] = hist["H_ssxfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssyfp_SIMC"] = hist["H_ssyfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssxpfp_SIMC"] = hist["H_ssxpfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssypfp_SIMC"] = hist["H_ssypfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsxfp_SIMC"] = hist["H_hsxfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsyfp_SIMC"] = hist["H_hsyfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsxpfp_SIMC"] = hist["H_hsxpfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_hsypfp_SIMC"] = hist["H_hsypfp_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssdelta_SIMC"] = hist["H_ssdelta_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssxptar_SIMC"] = hist["H_ssxptar_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ssyptar_SIMC"] = hist["H_ssyptar_SIMC"].Scale(hist["normfac_simc"])
        hist["H_q_SIMC"] = hist["H_q_SIMC"].Scale(hist["normfac_simc"])
        hist["H_Q2_SIMC"] = hist["H_Q2_SIMC"].Scale(hist["normfac_simc"])
        hist["H_t_SIMC"] = hist["H_t_SIMC"].Scale(hist["normfac_simc"])
        hist["H_epsilon_SIMC"] = hist["H_epsilon_SIMC"].Scale(hist["normfac_simc"])
        hist["H_MM_SIMC"] = hist["H_MM_SIMC"].Scale(hist["normfac_simc"])
        hist["H_th_SIMC"] = hist["H_th_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ph_SIMC"] = hist["H_ph_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ph_q_SIMC"] = hist["H_ph_q_SIMC"].Scale(hist["normfac_simc"])
        hist["H_th_q_SIMC"] = hist["H_th_q_SIMC"].Scale(hist["normfac_simc"])
        hist["H_ph_recoil_SIMC"] = hist["H_ph_recoil_SIMC"].Scale(hist["normfac_simc"])
        hist["H_th_recoil_SIMC"] = hist["H_th_recoil_SIMC"].Scale(hist["normfac_simc"])
        hist["H_pmiss_SIMC"] = hist["H_pmiss_SIMC"].Scale(hist["normfac_simc"])
        hist["H_emiss_SIMC"] = hist["H_emiss_SIMC"].Scale(hist["normfac_simc"])
        hist["H_pmx_SIMC"] = hist["H_pmx_SIMC"].Scale(hist["normfac_simc"])
        ...
        hist["H_hsyptar_DUMMY"] = hist["H_hsyptar_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssxfp_DUMMY"] = hist["H_ssxfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssyfp_DUMMY"] = hist["H_ssyfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssxpfp_DUMMY"] = hist["H_ssxpfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssypfp_DUMMY"] = hist["H_ssypfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_hsxfp_DUMMY"] = hist["H_hsxfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_hsyfp_DUMMY"] = hist["H_hsyfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_hsxpfp_DUMMY"] = hist["H_hsxpfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_hsypfp_DUMMY"] = hist["H_hsypfp_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssdelta_DUMMY"] = hist["H_ssdelta_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssxptar_DUMMY"] = hist["H_ssxptar_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ssyptar_DUMMY"] = hist["H_ssyptar_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_q_DUMMY"] = hist["H_q_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_Q2_DUMMY"] = hist["H_Q2_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_t_DUMMY"] = hist["H_t_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_epsilon_DUMMY"] = hist["H_epsilon_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_MM_DUMMY"] = hist["H_MM_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_th_DUMMY"] = hist["H_th_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ph_DUMMY"] = hist["H_ph_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ph_q_DUMMY"] = hist["H_ph_q_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_th_q_DUMMY"] = hist["H_th_q_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_ph_recoil_DUMMY"] = hist["H_ph_recoil_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_th_recoil_DUMMY"] = hist["H_th_recoil_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_pmiss_DUMMY"] = hist["H_pmiss_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_emiss_DUMMY"] = hist["H_emiss_DUMMY"].Scale(hist["normfac_dummy"])
        hist["H_pmx_DUMMY"] = hist["H_pmx_DUMMY"].Scale(hist["normfac_dummy"])
        ...
        hist["MM_vs_CoinTime_DUMMY"] = hist["MM_vs_CoinTime_DUMMY"].Scale(hist["normfac_dummy"])
        ...
        hist["H_hsyptar_DATA"] = hist["H_hsyptar_DATA"].Scale(hist["normfac_data"])
        hist["H_ssxfp_DATA"] = hist["H_ssxfp_DATA"].Scale(hist["normfac_data"])
        hist["H_ssyfp_DATA"] = hist["H_ssyfp_DATA"].Scale(hist["normfac_data"])
        hist["H_ssxpfp_DATA"] = hist["H_ssxpfp_DATA"].Scale(hist["normfac_data"])
        hist["H_ssypfp_DATA"] = hist["H_ssypfp_DATA"].Scale(hist["normfac_data"])
        hist["H_hsxfp_DATA"] = hist["H_hsxfp_DATA"].Scale(hist["normfac_data"])
        hist["H_hsyfp_DATA"] = hist["H_hsyfp_DATA"].Scale(hist["normfac_data"])
        hist["H_hsxpfp_DATA"] = hist["H_hsxpfp_DATA"].Scale(hist["normfac_data"])
        hist["H_hsypfp_DATA"] = hist["H_hsypfp_DATA"].Scale(hist["normfac_data"])
        hist["H_ssdelta_DATA"] = hist["H_ssdelta_DATA"].Scale(hist["normfac_data"])
        hist["H_ssxptar_DATA"] = hist["H_ssxptar_DATA"].Scale(hist["normfac_data"])
        hist["H_ssyptar_DATA"] = hist["H_ssyptar_DATA"].Scale(hist["normfac_data"])
        hist["H_q_DATA"] = hist["H_q_DATA"].Scale(hist["normfac_data"])
        hist["H_Q2_DATA"] = hist["H_Q2_DATA"].Scale(hist["normfac_data"])
        hist["H_t_DATA"] = hist["H_t_DATA"].Scale(hist["normfac_data"])
        hist["H_epsilon_DATA"] = hist["H_epsilon_DATA"].Scale(hist["normfac_data"])
        hist["H_MM_DATA"] = hist["H_MM_DATA"].Scale(hist["normfac_data"])
        hist["H_th_DATA"] = hist["H_th_DATA"].Scale(hist["normfac_data"])
        hist["H_ph_DATA"] = hist["H_ph_DATA"].Scale(hist["normfac_data"])
        hist["H_ph_q_DATA"] = hist["H_ph_q_DATA"].Scale(hist["normfac_data"])
        hist["H_th_q_DATA"] = hist["H_th_q_DATA"].Scale(hist["normfac_data"])
        hist["H_ph_recoil_DATA"] = hist["H_ph_recoil_DATA"].Scale(hist["normfac_data"])
        hist["H_th_recoil_DATA"] = hist["H_th_recoil_DATA"].Scale(hist["normfac_data"])
        hist["H_pmiss_DATA"] = hist["H_pmiss_DATA"].Scale(hist["normfac_data"])
        hist["H_emiss_DATA"] = hist["H_emiss_DATA"].Scale(hist["normfac_data"])
        hist["H_pmx_DATA"] = hist["H_pmx_DATA"].Scale(hist["normfac_data"])
        ...
        hist["H_cal_etottracknorm_DATA"] = hist["H_cal_etottracknorm_DATA"].Scale(hist["normfac_data"])
        hist["H_cer_npeSum_DATA"] = hist["H_cer_npeSum_DATA"].Scale(hist["normfac_data"])
        hist["P_cal_etottracknorm_DATA"] = hist["P_cal_etottracknorm_DATA"].Scale(hist["normfac_data"])
        hist["P_hgcer_npeSum_DATA"] = hist["P_hgcer_npeSum_DATA"].Scale(hist["normfac_data"])
        hist["P_aero_npeSum_DATA"] = hist["P_aero_npeSum_DATA"].Scale(hist["normfac_data"])
        hist["MM_vs_CoinTime_DATA"] = hist["MM_vs_CoinTime_DATA"].Scale(hist["normfac_data"])
