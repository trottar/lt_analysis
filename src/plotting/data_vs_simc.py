...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_ssdelta_MM[i].cd(2)
        h_MM_ssdelta_simc = TH1D_to_TH2D(hist["H_ssdelta_SIMC"], hist["H_MM_SIMC"], h2d_name="h_MM_ssdelta_simc", title=f"{phisetlist[i]} Simc;SHMS delta;MM", n_bins=50, z_min=1e-12, z_max=h_MM_ssdelta_data.GetMaximum())
    ...
    for i,hist in enumerate(histlist_copy):
        ...
        C_hsdelta_MM[i].cd(2)
        h_MM_hsdelta_simc = TH1D_to_TH2D(hist["H_hsdelta_SIMC"], hist["H_MM_SIMC"], h2d_name="h_MM_hsdelta_simc", title=f"{phisetlist[i]} Simc;HMS delta;MM", n_bins=50, z_min=1e-12, z_max=h_MM_hsdelta_data.GetMaximum())
