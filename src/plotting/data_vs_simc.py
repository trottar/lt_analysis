...
# Description:
# ================================================================
# Time-stamp: "2024-02-02 12:22:43 trottar"
# ================================================================
#
...
def plot_data_vs_simc(t_bins, phi_bins, histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        # HARD CODED #
        ##############
        hist["H_hsdelta_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsxptar_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsyptar_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssxfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssyfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssxpfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssypfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsxfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsyfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsxpfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_hsypfp_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssdelta_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssxptar_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ssyptar_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_q_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_Q2_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_t_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_epsilon_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_MM_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_th_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ph_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ph_q_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_th_q_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_ph_recoil_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_th_recoil_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_pmiss_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_emiss_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_pmx_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_pmy_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_pmz_SIMC"].Scale(hist["normfac_simc"]*1e5)
        hist["H_W_SIMC"].Scale(hist["normfac_simc"]*1e5)
        ##############
        ##############
        ##############
        '''
        
        hist["H_hsdelta_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsdelta_SIMC"].Integral())
        hist["H_hsxptar_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsxptar_SIMC"].Integral())
        hist["H_hsyptar_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsyptar_SIMC"].Integral())
        hist["H_ssxfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssxfp_SIMC"].Integral())
        hist["H_ssyfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssyfp_SIMC"].Integral())
        hist["H_ssxpfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssxpfp_SIMC"].Integral())
        hist["H_ssypfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssypfp_SIMC"].Integral())
        hist["H_hsxfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsxfp_SIMC"].Integral())
        hist["H_hsyfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsyfp_SIMC"].Integral())
        hist["H_hsxpfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsxpfp_SIMC"].Integral())
        hist["H_hsypfp_SIMC"].Scale(hist["normfac_simc"]/hist["H_hsypfp_SIMC"].Integral())
        hist["H_ssdelta_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssdelta_SIMC"].Integral())
        hist["H_ssxptar_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssxptar_SIMC"].Integral())
        hist["H_ssyptar_SIMC"].Scale(hist["normfac_simc"]/hist["H_ssyptar_SIMC"].Integral())
        hist["H_q_SIMC"].Scale(hist["normfac_simc"]/hist["H_q_SIMC"].Integral())
        hist["H_Q2_SIMC"].Scale(hist["normfac_simc"]/hist["H_Q2_SIMC"].Integral())
        hist["H_t_SIMC"].Scale(hist["normfac_simc"]/hist["H_t_SIMC"].Integral())
        hist["H_epsilon_SIMC"].Scale(hist["normfac_simc"]/hist["H_epsilon_SIMC"].Integral())
        hist["H_MM_SIMC"].Scale(hist["normfac_simc"]/hist["H_MM_SIMC"].Integral())
        hist["H_th_SIMC"].Scale(hist["normfac_simc"]/hist["H_th_SIMC"].Integral())
        hist["H_ph_SIMC"].Scale(hist["normfac_simc"]/hist["H_ph_SIMC"].Integral())
        hist["H_ph_q_SIMC"].Scale(hist["normfac_simc"]/hist["H_ph_q_SIMC"].Integral())
        hist["H_th_q_SIMC"].Scale(hist["normfac_simc"]/hist["H_th_q_SIMC"].Integral())
        hist["H_ph_recoil_SIMC"].Scale(hist["normfac_simc"]/hist["H_ph_recoil_SIMC"].Integral())
        hist["H_th_recoil_SIMC"].Scale(hist["normfac_simc"]/hist["H_th_recoil_SIMC"].Integral())
        hist["H_pmiss_SIMC"].Scale(hist["normfac_simc"]/hist["H_pmiss_SIMC"].Integral())
        hist["H_emiss_SIMC"].Scale(hist["normfac_simc"]/hist["H_emiss_SIMC"].Integral())
        hist["H_pmx_SIMC"].Scale(hist["normfac_simc"]/hist["H_pmx_SIMC"].Integral())
        hist["H_pmy_SIMC"].Scale(hist["normfac_simc"]/hist["H_pmy_SIMC"].Integral())
        hist["H_pmz_SIMC"].Scale(hist["normfac_simc"]/hist["H_pmz_SIMC"].Integral())
        hist["H_W_SIMC"].Scale(hist["normfac_simc"]/hist["H_W_SIMC"].Integral())
        
        hist["H_hsdelta_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsdelta_DUMMY"].Integral())
        hist["H_hsxptar_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsxptar_DUMMY"].Integral())
        hist["H_hsyptar_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsyptar_DUMMY"].Integral())
        hist["H_ssxfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssxfp_DUMMY"].Integral())
        hist["H_ssyfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssyfp_DUMMY"].Integral())
        hist["H_ssxpfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssxpfp_DUMMY"].Integral())
        hist["H_ssypfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssypfp_DUMMY"].Integral())
        hist["H_hsxfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsxfp_DUMMY"].Integral())
        hist["H_hsyfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsyfp_DUMMY"].Integral())
        hist["H_hsxpfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsxpfp_DUMMY"].Integral())
        hist["H_hsypfp_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_hsypfp_DUMMY"].Integral())
        hist["H_ssdelta_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssdelta_DUMMY"].Integral())
        hist["H_ssxptar_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssxptar_DUMMY"].Integral())
        hist["H_ssyptar_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ssyptar_DUMMY"].Integral())
        hist["H_q_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_q_DUMMY"].Integral())
        hist["H_Q2_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_Q2_DUMMY"].Integral())
        hist["H_t_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_t_DUMMY"].Integral())
        hist["H_epsilon_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_epsilon_DUMMY"].Integral())
        hist["H_MM_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_MM_DUMMY"].Integral())
        hist["H_th_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_th_DUMMY"].Integral())
        hist["H_ph_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ph_DUMMY"].Integral())
        hist["H_ph_q_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ph_q_DUMMY"].Integral())
        hist["H_th_q_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_th_q_DUMMY"].Integral())
        hist["H_ph_recoil_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ph_recoil_DUMMY"].Integral())
        hist["H_th_recoil_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_th_recoil_DUMMY"].Integral())
        hist["H_pmiss_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_pmiss_DUMMY"].Integral())
        hist["H_emiss_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_emiss_DUMMY"].Integral())
        hist["H_pmx_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_pmx_DUMMY"].Integral())
        hist["H_pmy_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_pmy_DUMMY"].Integral())
        hist["H_pmz_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_pmz_DUMMY"].Integral())
        hist["H_W_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_W_DUMMY"].Integral())
        hist["H_ct_DUMMY"].Scale(hist["normfac_dummy"]/hist["H_ct_DUMMY"].Integral())
        
        hist["H_hsdelta_DATA"].Scale(hist["normfac_data"]/hist["H_hsdelta_DATA"].Integral())
        hist["H_hsxptar_DATA"].Scale(hist["normfac_data"]/hist["H_hsxptar_DATA"].Integral())
        hist["H_hsyptar_DATA"].Scale(hist["normfac_data"]/hist["H_hsyptar_DATA"].Integral())
        hist["H_ssxfp_DATA"].Scale(hist["normfac_data"]/hist["H_ssxfp_DATA"].Integral())
        hist["H_ssyfp_DATA"].Scale(hist["normfac_data"]/hist["H_ssyfp_DATA"].Integral())
        hist["H_ssxpfp_DATA"].Scale(hist["normfac_data"]/hist["H_ssxpfp_DATA"].Integral())
        hist["H_ssypfp_DATA"].Scale(hist["normfac_data"]/hist["H_ssypfp_DATA"].Integral())
        hist["H_hsxfp_DATA"].Scale(hist["normfac_data"]/hist["H_hsxfp_DATA"].Integral())
        hist["H_hsyfp_DATA"].Scale(hist["normfac_data"]/hist["H_hsyfp_DATA"].Integral())
        hist["H_hsxpfp_DATA"].Scale(hist["normfac_data"]/hist["H_hsxpfp_DATA"].Integral())
        hist["H_hsypfp_DATA"].Scale(hist["normfac_data"]/hist["H_hsypfp_DATA"].Integral())
        hist["H_ssdelta_DATA"].Scale(hist["normfac_data"]/hist["H_ssdelta_DATA"].Integral())
        hist["H_ssxptar_DATA"].Scale(hist["normfac_data"]/hist["H_ssxptar_DATA"].Integral())
        hist["H_ssyptar_DATA"].Scale(hist["normfac_data"]/hist["H_ssyptar_DATA"].Integral())
        hist["H_q_DATA"].Scale(hist["normfac_data"]/hist["H_q_DATA"].Integral())
        hist["H_Q2_DATA"].Scale(hist["normfac_data"]/hist["H_Q2_DATA"].Integral())
        hist["H_t_DATA"].Scale(hist["normfac_data"]/hist["H_t_DATA"].Integral())
        hist["H_epsilon_DATA"].Scale(hist["normfac_data"]/hist["H_epsilon_DATA"].Integral())
        hist["H_MM_DATA"].Scale(hist["normfac_data"]/hist["H_MM_DATA"].Integral())
        hist["H_th_DATA"].Scale(hist["normfac_data"]/hist["H_th_DATA"].Integral())
        hist["H_ph_DATA"].Scale(hist["normfac_data"]/hist["H_ph_DATA"].Integral())
        hist["H_ph_q_DATA"].Scale(hist["normfac_data"]/hist["H_ph_q_DATA"].Integral())
        hist["H_th_q_DATA"].Scale(hist["normfac_data"]/hist["H_th_q_DATA"].Integral())
        hist["H_ph_recoil_DATA"].Scale(hist["normfac_data"]/hist["H_ph_recoil_DATA"].Integral())
        hist["H_th_recoil_DATA"].Scale(hist["normfac_data"]/hist["H_th_recoil_DATA"].Integral())
        hist["H_pmiss_DATA"].Scale(hist["normfac_data"]/hist["H_pmiss_DATA"].Integral())
        hist["H_emiss_DATA"].Scale(hist["normfac_data"]/hist["H_emiss_DATA"].Integral())
        hist["H_pmx_DATA"].Scale(hist["normfac_data"]/hist["H_pmx_DATA"].Integral())
        hist["H_pmy_DATA"].Scale(hist["normfac_data"]/hist["H_pmy_DATA"].Integral())
        hist["H_pmz_DATA"].Scale(hist["normfac_data"]/hist["H_pmz_DATA"].Integral())
        hist["H_W_DATA"].Scale(hist["normfac_data"]/hist["H_W_DATA"].Integral())
        hist["H_ct_DATA"].Scale(hist["normfac_data"]/hist["H_ct_DATA"].Integral())
