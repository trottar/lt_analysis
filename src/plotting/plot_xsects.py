...
# Description:
# ================================================================
# Time-stamp: "2024-07-30 14:51:12 trottar"
# ================================================================
#
    ...
    for k in range(NumtBins):
        ...
        for i, df_key in enumerate(['unsep_file_loeps', 'unsep_file_hieps']):
            ...
            if "hi" in df_key:
                ...
                b_hi_lst.append(b_fit*(df['W'][mask][non_zero_mask][k]-float(W.replace("p","."))))
                c_hi_lst.append(c_fit)
                d_hi_lst.append(d_fit)
            else:
                a_lo_lst.append(a_fit)
                b_lo_lst.append(b_fit*(df['W'][mask][non_zero_mask][k]-float(W.replace("p","."))))
