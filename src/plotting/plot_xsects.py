...
# Description:
# ================================================================
# Time-stamp: "2024-07-29 01:04:08 trottar"
# ================================================================
#
...
with PdfPages(outputpdf) as pdf:
    ...
    for i, df_key in enumerate(['unsep_file_loeps', 'unsep_file_hieps']):
        ...
        popt, pcov = curve_fit(fit_func, (df['phi'][non_zero_mask], df['th_cm'][non_zero_mask]), ratios, sigma=errors, absolute_sigma=True)
