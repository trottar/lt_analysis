...
with PdfPages(outputpdf) as pdf:
    ...
    def fit_function(tset, a, b, c, d):
        ...
        return a + b*np.exp(c*(tval-tset)) + d * (tval-tset)
    ...
    for i, df_key in enumerate(['unsep_file_loeps', 'unsep_file_hieps']):
        ...
        popt, pcov = curve_fit(fit_func, (df['t'][non_zero_mask].to_numpy()), ratios, sigma=errors, absolute_sigma=True, maxfev = 10000)
