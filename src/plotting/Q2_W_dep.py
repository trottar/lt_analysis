...
# Description:
# ================================================================
# Time-stamp: "2024-05-22 22:31:17 trottar"
# ================================================================
#
...
for Q2, W, LOEPS, HIEPS in zip(Q2_lst,W_lst, LOEPS_lst, HIEPS_lst):
    ...
    file_df_dict['t_bin_centers'] = pd.DataFrame((t_bins[:-1] + t_bins[1:]) / 2)
    ...
    file_df_dict['phi_bin_centers'] = pd.DataFrame(phi_bins)
...
with PdfPages(outputpdf) as pdf:
    ...
    for i, df_key in enumerate(['kindata_loeps_{}'.format('center'), 'kindata_hieps_{}'.format('center')]):
        ...
        print("\n\n",df_key,"\nt_bin_centers",merged_dict['t_bin_centers'], "\nQ2", df['Q2'])
