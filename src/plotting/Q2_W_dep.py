...
# Description:
# ================================================================
# Time-stamp: "2024-05-22 23:08:14 trottar"
# ================================================================
#
...
for Q2, W, LOEPS, HIEPS in zip(Q2_lst,W_lst, LOEPS_lst, HIEPS_lst):
    ...
    file_df_dict['t_bin_centers'] = pd.DataFrame((t_bins[:-1] + t_bins[1:]) / 2, columns=['t_bin_center'], index=index[1:])
    ...
    file_df_dict['phi_bin_centers'] = pd.DataFrame(phi_bins, columns=['phi_bin_center'], index=index[1:])
