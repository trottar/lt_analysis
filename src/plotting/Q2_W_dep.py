...
# Description:
# ================================================================
# Time-stamp: "2024-08-14 01:09:39 trottar"
# ================================================================
#
...
settings = {
    ...
    'set_4': {
        ...
        'inp_dir': "2024August13_H22M17S21" # i=12
    },    
    'set_5': {
        'Q2': '5p5',
        'W': '3p02',
...
for tmin, tmax in tmin_tmax_pairs:
    ...
    with PdfPages(outputpdf) as pdf:
        ...
        for k, sig in enumerate(['sigL','sigT','sigLT','sigTT']):
            ...
            # Plot the fit
            ax.plot(t_fit, y_fit, 'lightblue-', label=f'Fit: {param_str}')
        ...
        for k, sig in enumerate(['sigL','sigT','sigLT','sigTT']):
            ...
            # Plot the fit
            ax.plot(x_fit, y_fit, 'lightblue-', label=f'Fit: {popt[0]:.2e}*exp({popt[1]:.2f}*Q^2)')
