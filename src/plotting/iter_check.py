...
# Description:
# ================================================================
# Time-stamp: "2024-02-04 14:11:56 trottar"
# ================================================================
#
...
def plot_iteration(histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        for key, val in hist.items():
            if hasattr(val, 'Clone') and callable(getattr(val, 'Clone')) and "Weight" not in key and not isinstance(val, TGraphPolar):
                ...
                for i, binIndex in enumerate(range(1, HistNumEvts + 1)):
                    ...
                    hist_copy["{}_OLD".format(key)].SetBinContent(binIndex, weight)
