...
# Description:
# ================================================================
# Time-stamp: "2024-12-05 02:54:07 trottar"
# ================================================================
#
...
def plot_iteration(histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_th_q_SIMC"] = TH1D("H_th_q_SIMC","Theta Detected (th_xq)", 100, -math.pi, math.pi)
        hist["H_ph_recoil_SIMC"] = TH1D("H_ph_recoil_SIMC","Phi Recoil (ph_bq)", 100, -math.pi, math.pi)
        hist["H_th_recoil_SIMC"] = TH1D("H_th_recoil_SIMC","Theta Recoil (th_bq)", 100, -math.pi, math.pi)
        ...
        hist["H_th_q_SIMC_OLD"] = TH1D("H_th_q_SIMC_OLD","Theta Detected (th_xq)", 100, -math.pi, math.pi)
        hist["H_ph_recoil_SIMC_OLD"] = TH1D("H_ph_recoil_SIMC_OLD","Phi Recoil (ph_bq)", 100, -math.pi, math.pi)
        hist["H_th_recoil_SIMC_OLD"] = TH1D("H_th_recoil_SIMC_OLD","Theta Recoil (th_bq)", 100, -math.pi, math.pi)
