...
# Description:
# ================================================================
# Time-stamp: "2024-12-02 06:09:37 trottar"
# ================================================================
#
...
def plot_iteration(histlist, phisetlist, inpDict):
    ...
    for hist in histlist_copy:
        ...
        hist["H_MM_SIMC"] = TH1D("H_MM_SIMC","MM_{ParticleType[0].upper()}", 100, 0.7, 1.5)
        ...
        hist["H_MM_SIMC_OLD"] = TH1D("H_MM_SIMC_OLD","MM_{ParticleType[0].upper()}", 100, 0.7, 1.5)
