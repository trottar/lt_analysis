...
fn_lo = LTANAPATH + "/{}/src/x_unsep.{}_{}_{}".format(ParticleType, POL, Q2.replace("p",""), int(float(LOEPS)*100))
fn_hi = LTANAPATH + "/{}/src/x_unsep.{}_{}_{}".format(ParticleType, POL, Q2.replace("p",""), int(float(HIEPS)*100))
