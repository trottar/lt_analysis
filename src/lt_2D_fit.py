...
# Description:
# ================================================================
# Time-stamp: "2023-12-27 10:18:45 trottar"
# ================================================================
#
...
def LT_sep_x_lo_fun(x, par):
    eps = LOEPS
    print("$$$$$$$$$$$$$$$$$$$LT_sep_x_lo_fun",float(x[0]),par[1],par[2],par[3])
    xx = float(x[0])
...
def LT_sep_x_hi_fun(x, par):
    eps = HIEPS
    print("$$$$$$$$$$$$$$$$$$$LT_sep_x_hi_fun",float(x[0]),par[1],par[2],par[3])
    xx = float(x[0])
    xs = par[0] + eps * par[1] + ROOT.TMath.Sqrt(2 * eps * (1 + eps)) * par[2] * ROOT.TMath.Cos(xx * PI / 180) + eps * par[3] * ROOT.TMath.Cos(2 * xx * PI / 180)
    return xs
...
def LT_sep_x_lo_fun_unsep(x, par):
    print("$$$$$$$$$$$$$$$$$$$LT_sep_x_lo_fun_unsep",float(x[0]),par[1],par[2],par[3])
    eps = LOEPS
    xx = float(x[0])
...
def LT_sep_x_hi_fun_unsep(x, par):
    eps = HIEPS
    print("$$$$$$$$$$$$$$$$$$$LT_sep_x_hi_fun_unsep",float(x[0]),par[1],par[2],par[3])
    xx = float(x[0])
    xs = par[0] + eps * par[1] + ROOT.TMath.Sqrt(2 * eps * (1 + eps)) * par[2] * ROOT.TMath.Cos(xx) + eps * par[3] * ROOT.TMath.Cos(2 * xx)
    return xs
