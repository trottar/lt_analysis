...
# Description:
# ================================================================
# Time-stamp: "2023-12-27 06:53:06 trottar"
# ================================================================
#
...
fn_lo = LTANAPATH + "/{}/src/x_unsep.{}_{}_{:2.f}".format(ParticleType, POL, Q2.replace("p",""), float(LOEPS)*100)
fn_hi = LTANAPATH + "/{}/src/x_unsep.{}_{}_{:2.f}".format(ParticleType, POL, Q2.replace("p",""), float(HIEPS)*100)
