...
# Description:
# ================================================================
# Time-stamp: "2024-01-23 11:28:29 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    H_MM_DATA  = TH1D("H_MM_DATA","MM_{K}", 100, 0.0, 1.5)
    ...
    H_cer_npeSum_DATA = TH1D("H_cer_npeSum_DATA", "HMS Cer Npe Sum", 100, 0, 30xo)
    ...
    H_MM_DUMMY  = TH1D("H_MM_DUMMY","MM_{K}", 100, 0.0, 1.5)
    ...
    H_MM_RAND  = TH1D("H_MM_RAND","MM_{K}", 100, 0.0, 1.5)
    ...
    H_MM_DUMMY_RAND  = TH1D("H_MM_DUMMY_RAND","MM_{K}", 100, 0.0, 1.5)
