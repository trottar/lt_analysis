...
# Description:
# ================================================================
# Time-stamp: "2024-01-15 02:37:10 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    H_ph_q_DATA  = TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 200, -2math.pi, 2*math.pi)
    ...
    H_ph_q_DUMMY  = TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 200, -2math.pi, 2*math.pi)
    ...
    H_ph_q_RAND  = TH1D("H_ph_q_RAND","Phi Detected (ph_xq)", 200, -2math.pi, 2*math.pi)
    ...
    H_ph_q_DUMMY_RAND  = TH1D("H_ph_q_DUMMY_RAND","Phi Detected (ph_xq)", 200, -2math.pi, 2*math.pi)
