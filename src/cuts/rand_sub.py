...
def rand_sub(phi_setting, inpDict):    
    ...
    H_ph_q_DATA  = TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 200, -6*math.pi, 6*math.pi)
    ...
    H_ph_q_DUMMY  = TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 200, -6*math.pi, 6*math.pi)
    ...
    H_ph_q_RAND  = TH1D("H_ph_q_RAND","Phi Detected (ph_xq)", 200, -6*math.pi, 6*math.pi)
    ...
    H_ph_q_DUMMY_RAND  = TH1D("H_ph_q_DUMMY_RAND","Phi Detected (ph_xq)", 200, -6*math.pi, 6*math.pi)
    ...
    axis = histDict["H_ph_q_DATA"].GetXaxis()
