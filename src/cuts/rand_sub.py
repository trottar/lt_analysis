...
# Description:
# ================================================================
# Time-stamp: "2024-03-19 16:50:48 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":        
        ...
        P_hgcer_xAtCer_vs_yAtCer_DATA.Add(P_hgcer_xAtCer_vs_yAtCer_DATA, -background_fit)
        P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Add(P_hgcer_nohole_xAtCer_vs_yAtCer_DATA, -background_fit)
        P_hgcer_xAtCer_vs_MM_DATA.Add(P_hgcer_xAtCer_vs_MM_DATA, -background_fit)
        P_hgcer_nohole_xAtCer_vs_MM_DATA.Add(P_hgcer_nohole_xAtCer_vs_MM_DATA, -background_fit)
        P_hgcer_yAtCer_vs_MM_DATA.Add(P_hgcer_yAtCer_vs_MM_DATA, -background_fit)
        P_hgcer_nohole_yAtCer_vs_MM_DATA.Add(P_hgcer_nohole_yAtCer_vs_MM_DATA, -background_fit)
        MM_vs_CoinTime_DATA.Add(MM_vs_CoinTime_DATA, -background_fit)
        CoinTime_vs_beta_DATA.Add(CoinTime_vs_beta_DATA, -background_fit)
        MM_vs_beta_DATA.Add(MM_vs_beta_DATA, -background_fit)
        MM_vs_H_cer_DATA.Add(MM_vs_H_cer_DATA, -background_fit)
        MM_vs_H_cal_DATA.Add(MM_vs_H_cal_DATA, -background_fit)
        MM_vs_P_cal_DATA.Add(MM_vs_P_cal_DATA, -background_fit)
        MM_vs_P_hgcer_DATA.Add(MM_vs_P_hgcer_DATA, -background_fit)
        MM_vs_P_aero_DATA.Add(MM_vs_P_aero_DATA, -background_fit)
        phiq_vs_t_DATA.Add(phiq_vs_t_DATA, -background_fit)
        Q2_vs_W_DATA.Add(Q2_vs_W_DATA, -background_fit)
        Q2_vs_t_DATA.Add(Q2_vs_t_DATA, -background_fit)
        W_vs_t_DATA.Add(W_vs_t_DATA, -background_fit)
        EPS_vs_t_DATA.Add(EPS_vs_t_DATA, -background_fit)
        MM_vs_t_DATA.Add(MM_vs_t_DATA, -background_fit)
        H_ssxfp_DATA.Add(H_ssxfp_DATA, -background_fit)
        H_ssyfp_DATA.Add(H_ssyfp_DATA, -background_fit)
        H_ssxpfp_DATA.Add(H_ssxpfp_DATA, -background_fit)
        H_ssypfp_DATA.Add(H_ssypfp_DATA, -background_fit)
        H_hsxfp_DATA.Add(H_hsxfp_DATA, -background_fit)
        H_hsyfp_DATA.Add(H_hsyfp_DATA, -background_fit)
        H_hsxpfp_DATA.Add(H_hsxpfp_DATA, -background_fit)
        H_hsypfp_DATA.Add(H_hsypfp_DATA, -background_fit)
        H_ssxptar_DATA.Add(H_ssxptar_DATA, -background_fit)
        H_ssyptar_DATA.Add(H_ssyptar_DATA, -background_fit)
        H_hsxptar_DATA.Add(H_hsxptar_DATA, -background_fit)
        H_hsyptar_DATA.Add(H_hsyptar_DATA, -background_fit)
        H_ssdelta_DATA.Add(H_ssdelta_DATA, -background_fit)
        H_hsdelta_DATA.Add(H_hsdelta_DATA, -background_fit)
        H_ph_q_DATA.Add(H_ph_q_DATA, -background_fit)
        H_th_q_DATA.Add(H_th_q_DATA, -background_fit)
        H_ph_recoil_DATA.Add(H_ph_recoil_DATA, -background_fit)
        H_th_recoil_DATA.Add(H_th_recoil_DATA, -background_fit)
        H_Q2_DATA.Add(H_Q2_DATA, -background_fit)
        H_W_DATA.Add(H_W_DATA, -background_fit)
        H_t_DATA.Add(H_t_DATA, -background_fit)
        H_epsilon_DATA.Add(H_epsilon_DATA, -background_fit)
        H_MM_DATA.Add(H_MM_DATA, -background_fit)
        H_pmiss_DATA.Add(H_pmiss_DATA, -background_fit)
        H_emiss_DATA.Add(H_emiss_DATA, -background_fit)
        H_pmx_DATA.Add(H_pmx_DATA, -background_fit)
        H_pmy_DATA.Add(H_pmy_DATA, -background_fit)
        H_pmz_DATA.Add(H_pmz_DATA, -background_fit)
        H_ct_DATA.Add(H_ct_DATA, -background_fit)
