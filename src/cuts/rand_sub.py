...
def rand_sub(phi_setting, inpDict):    
    ...
    if  inpDict["bg_stat_scale1"] > 0.0:
        ...
        #P_hgcer_xAtCer_vs_yAtCer_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #P_hgcer_xAtCer_vs_MM_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #P_hgcer_nohole_xAtCer_vs_MM_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #P_hgcer_yAtCer_vs_MM_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #P_hgcer_nohole_yAtCer_vs_MM_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_CoinTime_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #CoinTime_vs_beta_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_beta_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_H_cer_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_H_cal_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_P_cal_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_P_hgcer_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_P_aero_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #phiq_vs_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #Q2_vs_W_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #Q2_vs_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #W_vs_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #EPS_vs_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        #MM_vs_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssxfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssyfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssxpfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssypfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsxfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsyfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsxpfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsypfp_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssxptar_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssyptar_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsxptar_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsyptar_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ssdelta_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_hsdelta_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ph_q_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_th_q_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ph_recoil_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_th_recoil_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_Q2_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_W_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_t_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_epsilon_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_MM_fit2sub_DATA.Add(background_fit1[1]*inpDict["bg_stat_scale1"], -1)
        H_MM_fit1sub_DATA.Add(background_fit1[1]*inpDict["bg_stat_scale1"], -1)
        H_MM_DATA.Add(background_fit1[0]*inpDict["bg_stat_scale1"], -1)
        H_pmiss_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_emiss_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_pmx_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_pmy_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_pmz_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"])
        H_ct_DATA.Scale(background_fit1[3]*inpDict["bg_stat_scale1"]) 
    ...
    if inpDict["bg_stat_scale2"] > 0.0:
        ...
        # RLT (4/16/2023): Commented out because they return empty sometimes, probably a TH2D vs TH1D issue
        #P_hgcer_xAtCer_vs_yAtCer_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #P_hgcer_xAtCer_vs_MM_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #P_hgcer_nohole_xAtCer_vs_MM_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #P_hgcer_yAtCer_vs_MM_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #P_hgcer_nohole_yAtCer_vs_MM_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #MM_vs_CoinTime_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"]*inpDict["bg_stat_scale2"])
        #CoinTime_vs_beta_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_beta_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_H_cer_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_H_cal_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_P_cal_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_P_hgcer_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_P_aero_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #phiq_vs_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #Q2_vs_W_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #Q2_vs_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #W_vs_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #EPS_vs_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        #MM_vs_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssxfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssyfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssxpfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssypfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsxfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsyfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsxpfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsypfp_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssxptar_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssyptar_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsxptar_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsyptar_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ssdelta_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_hsdelta_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ph_q_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_th_q_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ph_recoil_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_th_recoil_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_Q2_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_W_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_t_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_epsilon_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_MM_fit2sub_DATA.Add(background_fit2[1]*inpDict["bg_stat_scale2"], -1)
        H_MM_DATA.Add(background_fit2[0]*inpDict["bg_stat_scale2"], -1)
        H_pmiss_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_emiss_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_pmx_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_pmy_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_pmz_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])
        H_ct_DATA.Scale(background_fit2[3]*inpDict["bg_stat_scale2"])     
