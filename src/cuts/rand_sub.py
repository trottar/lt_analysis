...
def rand_sub(
    ...
    if ParticleType == "kaon":
        ...
        # Phases D.6 through D.11 and E.2 are terminal presentation only.  They receive the
        ...
        try:
            ...
            _print_rand_debug(
                "detached full background-subtraction D.6 through D.11 and E.2 pages unavailable",
