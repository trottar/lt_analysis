...
def rand_sub(phi_setting, inpDict):    
    ...
    H_ph_q_DATA  = TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 200, -5.0, 5.0)
    ...
    H_pmiss_DATA  = TH1D("H_pmiss_DATA","pmiss", 200, 0.0, 10.0)
    H_emiss_DATA  = TH1D("H_emiss_DATA","emiss", 200, 0.0, 10.0)
    ...
    H_ct_DATA = TH1D("H_ct_DATA", "Electron-{} CTime".format(ParticleType.capitalize()), 200, -10, 10)
    ...
    P_hgcer_npeSum_DATA = TH1D("P_hgcer_npeSum_DATA", "SHMS HGCer Npe Sum", 200, 0, 50)
    P_aero_npeSum_DATA = TH1D("P_aero_npeSum_DATA", "SHMS Aero Npe Sum", 200, 0, 50)
    ...
    H_ph_q_DUMMY  = TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 200, -5.0, 5.0)
    ...
    H_pmiss_DUMMY  = TH1D("H_pmiss_DUMMY","pmiss", 200, 0.0, 10.0)
    H_emiss_DUMMY  = TH1D("H_emiss_DUMMY","emiss", 200, 0.0, 10.0)
    ...
    H_ct_DUMMY = TH1D("H_ct_DUMMY", "Electron-{} CTime".format(ParticleType.capitalize()), 200, -10, 10)
    ...
    H_ph_q_RAND  = TH1D("H_ph_q_RAND","Phi Detected (ph_xq)", 200, -5.0, 5.0)
    ...
    H_pmiss_RAND  = TH1D("H_pmiss_RAND","pmiss", 200, 0.0, 10.0)
    H_emiss_RAND  = TH1D("H_emiss_RAND","emiss", 200, 0.0, 10.0)
    ...
    H_ct_RAND = TH1D("H_ct_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 200, -10, 10)
    ...
    H_ph_q_DUMMY_RAND  = TH1D("H_ph_q_DUMMY_RAND","Phi Detected (ph_xq)", 200, -5.0, 5.0)
    ...
    H_pmiss_DUMMY_RAND  = TH1D("H_pmiss_DUMMY_RAND","pmiss", 200, 0.0, 10.0)
    H_emiss_DUMMY_RAND  = TH1D("H_emiss_DUMMY_RAND","emiss", 200, 0.0, 10.0)
    ...
    H_ct_DUMMY_RAND = TH1D("H_ct_DUMMY_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 200, -10, 10)

    ################################################################################################################################################
    # 2D histograms

    MM_vs_CoinTime_DATA = TH2D("MM_vs_CoinTime_DATA","Missing Mass vs CTime; MM; Coin_Time",200, 0, 2, 200, -2, 2)
    CoinTime_vs_beta_DATA = TH2D("CoinTime_vs_beta_DATA", "CTime vs SHMS #beta; Coin_Time; SHMS_#beta", 200, -2, 2, 200, 0, 2)
    ...
    MM_vs_CoinTime_DUMMY = TH2D("MM_vs_CoinTime_DUMMY","Missing Mass vs CTime; MM; Coin_Time",200, 0, 2, 200, -2, 2)
    CoinTime_vs_beta_DUMMY = TH2D("CoinTime_vs_beta_DUMMY", "CTime vs SHMS #beta; Coin_Time; SHMS_#beta", 200, -2, 2, 200, 0, 2)
    ...
    MM_vs_CoinTime_RAND = TH2D("MM_vs_CoinTime_RAND","Missing Mass vs CTime; MM; Coin_Time",200, 0, 2, 200, -2, 2)
    CoinTime_vs_beta_RAND = TH2D("CoinTime_vs_beta_RAND", "CTime vs SHMS #beta; Coin_Time; SHMS_#beta", 200, -2, 2, 200, 0, 2)
    ...
    MM_vs_CoinTime_DUMMY_RAND = TH2D("MM_vs_CoinTime_DUMMY_RAND","Missing Mass vs CTime; MM; Coin_Time",200, 0, 2, 200, -2, 2)
    CoinTime_vs_beta_DUMMY_RAND = TH2D("CoinTime_vs_beta_DUMMY_RAND", "CTime vs SHMS #beta; Coin_Time; SHMS_#beta", 200, -2, 2, 200, 0, 2)
