...
# Description:
# ================================================================
# Time-stamp: "2024-03-19 16:12:25 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":        
        ...
        P_hgcer_xAtCer_vs_yAtCer_DATA.Add(background_fit[0], -background_fit[1])
        P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Add(background_fit[0], -background_fit[1])
        ...
        Q2_vs_W_DATA.Add(background_fit[0], -background_fit[1])
        ...
        H_ssypfp_DATA.Add(background_fit[0], -background_fit[1])
        H_hsxfp_DATA.Add(background_fit[0], -background_fit[1])
        H_hsyfp_DATA.Add(background_fit[0], -background_fit[1])
        H_hsxpfp_DATA.Add(background_fit[0], -background_fit[1])
        H_hsypfp_DATA.Add(background_fit[0], -background_fit[1])
        H_ssxptar_DATA.Add(background_fit[0], -background_fit[1])
        H_ssyptar_DATA.Add(background_fit[0], -background_fit[1])
        H_hsxptar_DATA.Add(background_fit[0], -background_fit[1])
        H_hsyptar_DATA.Add(background_fit[0], -background_fit[1])
        H_ssdelta_DATA.Add(background_fit[0], -background_fit[1])
        H_hsdelta_DATA.Add(background_fit[0], -background_fit[1])
        H_ph_q_DATA.Add(background_fit[0], -background_fit[1])
        H_th_q_DATA.Add(background_fit[0], -background_fit[1])
        H_ph_recoil_DATA.Add(background_fit[0], -background_fit[1])
        H_th_recoil_DATA.Add(background_fit[0], -background_fit[1])
        H_Q2_DATA.Add(background_fit[0], -background_fit[1])
        H_W_DATA.Add(background_fit[0], -background_fit[1])
        H_t_DATA.Add(background_fit[0], -background_fit[1])
        H_epsilon_DATA.Add(background_fit[0], -background_fit[1])
        H_MM_DATA.Add(background_fit[0], -background_fit[1])
        H_pmiss_DATA.Add(background_fit[0], -background_fit[1])
        H_emiss_DATA.Add(background_fit[0], -background_fit[1])
        H_pmx_DATA.Add(background_fit[0], -background_fit[1])
        H_pmy_DATA.Add(background_fit[0], -background_fit[1])
        H_pmz_DATA.Add(background_fit[0], -background_fit[1])
        H_ct_DATA.Add(background_fit[0], -background_fit[1])
