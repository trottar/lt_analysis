...
# Description:
# ================================================================
# Time-stamp: "2024-12-05 03:15:06 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":
        ...
        ##############
            ...
            scale_factor = H_MM_nosub_DATA.Integral(H_MM_DATA.FindBin(pi_mm_min), H_MM_DATA.FindBin(pi_mm_max))/subDict["H_MM_nosub_SUB_DATA"]\
