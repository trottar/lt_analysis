...
# Description:
# ================================================================
# Time-stamp: "2024-01-17 12:24:46 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    H_MM_DATA  = TH1D("H_MM_DATA","MM_{K}", 1000, 0.0, 1.5)
    H_th_DATA  = TH1D("H_th_DATA","X' tar", 1000, -0.1, 0.1)
    H_ph_DATA  = TH1D("H_ph_DATA","Y' tar", 1000, -0.1, 0.1)
    H_ph_q_DATA  = TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 1000, 0.0, 2*math.pi)
    ...
    H_pmiss_DATA  = TH1D("H_pmiss_DATA","pmiss", 1000, 0.0, 10.0)
    H_emiss_DATA  = TH1D("H_emiss_DATA","emiss", 1000, 0.0, 10.0)
    ...
    P_hgcer_npeSum_DATA = TH1D("P_hgcer_npeSum_DATA", "SHMS HGCer Npe Sum", 1000, 0, 50)
    P_aero_npeSum_DATA = TH1D("P_aero_npeSum_DATA", "SHMS Aero Npe Sum", 1000, 0, 50)
    ...
    H_MM_DUMMY  = TH1D("H_MM_DUMMY","MM_{K}", 1000, 0.0, 1.5)
    H_th_DUMMY  = TH1D("H_th_DUMMY","X' tar", 1000, -0.1, 0.1)
    H_ph_DUMMY  = TH1D("H_ph_DUMMY","Y' tar", 1000, -0.1, 0.1)
    H_ph_q_DUMMY  = TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 1000, 0.0, 2*math.pi)
    ...
    H_pmiss_DUMMY  = TH1D("H_pmiss_DUMMY","pmiss", 1000, 0.0, 10.0)
    H_emiss_DUMMY  = TH1D("H_emiss_DUMMY","emiss", 1000, 0.0, 10.0)
    ...
    H_MM_RAND  = TH1D("H_MM_RAND","MM_{K}", 1000, 0.0, 1.5)
    H_th_RAND  = TH1D("H_th_RAND","X' tar", 1000, -0.1, 0.1)
    H_ph_RAND  = TH1D("H_ph_RAND","Y' tar", 1000, -0.1, 0.1)
    H_ph_q_RAND  = TH1D("H_ph_q_RAND","Phi Detected (ph_xq)", 1000, 0.0, 2*math.pi)
    ...
    H_pmiss_RAND  = TH1D("H_pmiss_RAND","pmiss", 1000, 0.0, 10.0)
    H_emiss_RAND  = TH1D("H_emiss_RAND","emiss", 1000, 0.0, 10.0)
    ...
    H_MM_DUMMY_RAND  = TH1D("H_MM_DUMMY_RAND","MM_{K}", 1000, 0.0, 1.5)
    H_th_DUMMY_RAND  = TH1D("H_th_DUMMY_RAND","X' tar", 1000, -0.1, 0.1)
    H_ph_DUMMY_RAND  = TH1D("H_ph_DUMMY_RAND","Y' tar", 1000, -0.1, 0.1)
    H_ph_q_DUMMY_RAND  = TH1D("H_ph_q_DUMMY_RAND","Phi Detected (ph_xq)", 1000, 0.0, 2*math.pi)
    ...
    H_pmiss_DUMMY_RAND  = TH1D("H_pmiss_DUMMY_RAND","pmiss", 1000, 0.0, 10.0)
    H_emiss_DUMMY_RAND  = TH1D("H_emiss_DUMMY_RAND","emiss", 1000, 0.0, 10.0)
