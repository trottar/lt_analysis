...
# Description:
# ================================================================
# Time-stamp: "2024-09-09 19:57:39 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    H_emiss_DATA  = TH1D("H_emiss_DATA","emiss", 100, 1.0, 2.0)
    ...
    H_emiss_DUMMY  = TH1D("H_emiss_DUMMY","emiss", 100, 1.0, 2.0)
    ...
    H_emiss_RAND  = TH1D("H_emiss_RAND","emiss", 100, 1.0, 2.0)
    ...
    H_emiss_DUMMY_RAND  = TH1D("H_emiss_DUMMY_RAND","emiss", 100, 1.0, 2.0)
    ...
    if ParticleType == "kaon":        
        ...
        subDict["H_emiss_SUB_DATA"]  = TH1D("H_emiss_SUB_DATA","emiss", 100, 1.0, 2.0)
        ...
        subDict["H_emiss_SUB_RAND"]  = TH1D("H_emiss_SUB_RAND","emiss", 100, 1.0, 2.0)
        ...
        subDict["H_emiss_SUB_DUMMY"]  = TH1D("H_emiss_SUB_DUMMY","emiss", 100, 1.0, 2.0)
        ...
        subDict["H_emiss_SUB_DUMMY_RAND"]  = TH1D("H_emiss_SUB_DUMMY_RAND","emiss", 100, 1.0, 2.0)
    ...
    for i,evt in enumerate(TBRANCH_DATA):
        ...
        if ParticleType == "kaon":
            ...
            if(NOMMCUTS):
                H_MM_nosub_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DATA.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DATA.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DATA.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DATA.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DATA.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)
          ...
          MM_vs_t_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DATA.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
          #H_MM_DATA.Fill(pow(math.sqrt(evt.emiss**2-evt.pmiss**2), 2))
    ...
    for i,evt in enumerate(TBRANCH_DUMMY):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DUMMY.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))                    
          ...
          MM_vs_CoinTime_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DUMMY.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DUMMY.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
          #H_MM_DUMMY.Fill(pow(math.sqrt(evt.emiss**2-evt.pmiss**2), 2))  
    ...
    for i,evt in enumerate(TBRANCH_RAND):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_RAND.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_RAND.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_RAND.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_RAND.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_RAND.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_RAND.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
    ...
    for i,evt in enumerate(TBRANCH_DUMMY_RAND):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_yAtCer,math.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DUMMY_RAND.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DUMMY_RAND.Fill(math.sqrt(evt.emiss**2-evt.pmiss**2))
