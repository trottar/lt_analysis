...
# Description:
# ================================================================
# Time-stamp: "2023-10-03 16:47:02 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    TBRANCH_DATA  = InFile_DATA.Get("Uncut_{}_Events".format(ParticleType.capitalize()))

    TBRANCH_RAND  = InFile_DATA.Get("Uncut_{}_Events".format(ParticleType.capitalize()))
    ...
    TBRANCH_DUMMY  = InFile_DUMMY.Get("Uncut_{}_Events".format(ParticleType.capitalize()))

    TBRANCH_DUMMY_RAND  = InFile_DUMMY.Get("Uncut_{}_Events".format(ParticleType.capitalize()))
    ...
    H_ct_DATA = TH1D("H_ct_DATA", "Electron-{} CTime".format(ParticleType.capitalize()), 500, -30, 30)
    ...
    H_ct_DUMMY = TH1D("H_ct_DUMMY", "Electron-{} CTime".format(ParticleType.capitalize()), 500, -30, 30)
    ...
    H_ct_RAND = TH1D("H_ct_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 500, -30, 30)
    ...
    H_ct_DUMMY_RAND = TH1D("H_ct_DUMMY_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 500, -30, 30)
