...
# Description:
# ================================================================
# Time-stamp: "2024-09-09 20:04:22 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    for i,evt in enumerate(TBRANCH_DATA):
        ...
        if ParticleType == "kaon":
            ...
            if(NOMMCUTS):
                H_MM_nosub_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DATA.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DATA.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DATA.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DATA.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DATA.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)
          ...
          MM_vs_t_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DATA.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
          #H_MM_DATA.Fill(pow(np.sqrt(evt.emiss**2-evt.pmiss**2), 2))
    ...
    for i,evt in enumerate(TBRANCH_DUMMY):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DUMMY.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DUMMY.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))                    
          ...
          MM_vs_CoinTime_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DUMMY.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DUMMY.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
          #H_MM_DUMMY.Fill(pow(np.sqrt(evt.emiss**2-evt.pmiss**2), 2))  
    ...
    for i,evt in enumerate(TBRANCH_RAND):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_RAND.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_RAND.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_RAND.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_RAND.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_RAND.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_RAND.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
    ...
    for i,evt in enumerate(TBRANCH_DUMMY_RAND):
        ...
        if ParticleType == "kaon":
            ...
            NOMMCUTS = apply_data_sub_cuts(evt) and not hgcer_cutg.IsInside(evt.P_hgcer_xAtCer, evt.P_hgcer_yAtCer) #and evt.P_hgcer_npeSum == 0.0
            if(NOMMCUTS):
                H_MM_nosub_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
            if(NOHOLECUTS):
                # HGCer hole comparison            
                P_hgcer_nohole_xAtCer_vs_yAtCer_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,evt.P_hgcer_yAtCer)
                P_hgcer_nohole_xAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
                P_hgcer_nohole_yAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))            
        ...
        if(ALLCUTS):
          ...
          P_hgcer_xAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_xAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))
          P_hgcer_yAtCer_vs_MM_DUMMY_RAND.Fill(evt.P_hgcer_yAtCer,np.sqrt(evt.emiss**2-evt.pmiss**2))                    

          # Phase shift to fix polar plots
          #phi_shift = (evt.ph_q+math.pi)
          phi_shift = (evt.ph_q)          
          
          MM_vs_CoinTime_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), evt.CTime_ROC1)
          CoinTime_vs_beta_DUMMY_RAND.Fill(evt.CTime_ROC1,evt.P_gtr_beta)
          MM_vs_beta_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_gtr_beta)
          MM_vs_H_cer_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cer_npeSum)
          MM_vs_H_cal_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.H_cal_etottracknorm)
          MM_vs_P_cal_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_cal_etottracknorm)
          MM_vs_P_hgcer_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_hgcer_npeSum)
          MM_vs_P_aero_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2),evt.P_aero_npeSum)          
          # SIMC goes from 0 to 2pi so no need for +pi
          ...
          MM_vs_t_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2), -evt.MandelT)
          ...
          H_MM_DUMMY_RAND.Fill(np.sqrt(evt.emiss**2-evt.pmiss**2))
