...
# Description:
# ================================================================
# Time-stamp: "2024-03-19 16:29:10 trottar"
# ================================================================
#
...
def rand_sub(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":        
        ...
        background_fit = bg_fit(inpDict, H_MM_DATA, "constant")
        P_hgcer_xAtCer_vs_yAtCer_DATA.Add(background_fit[1], -1)
        P_hgcer_nohole_xAtCer_vs_yAtCer_DATA.Add(background_fit[1], -1)
        P_hgcer_xAtCer_vs_MM_DATA.Add(background_fit[1], -1)
        P_hgcer_nohole_xAtCer_vs_MM_DATA.Add(background_fit[1], -1)
        P_hgcer_yAtCer_vs_MM_DATA.Add(background_fit[1], -1)
        P_hgcer_nohole_yAtCer_vs_MM_DATA.Add(background_fit[1], -1)
        MM_vs_CoinTime_DATA.Add(background_fit[1], -1)
        CoinTime_vs_beta_DATA.Add(background_fit[1], -1)
        MM_vs_beta_DATA.Add(background_fit[1], -1)
        MM_vs_H_cer_DATA.Add(background_fit[1], -1)
        MM_vs_H_cal_DATA.Add(background_fit[1], -1)
        MM_vs_P_cal_DATA.Add(background_fit[1], -1)
        MM_vs_P_hgcer_DATA.Add(background_fit[1], -1)
        MM_vs_P_aero_DATA.Add(background_fit[1], -1)
        phiq_vs_t_DATA.Add(background_fit[1], -1)
        Q2_vs_W_DATA.Add(background_fit[1], -1)
        Q2_vs_t_DATA.Add(background_fit[1], -1)
        W_vs_t_DATA.Add(background_fit[1], -1)
        EPS_vs_t_DATA.Add(background_fit[1], -1)
        MM_vs_t_DATA.Add(background_fit[1], -1)
        H_ssxfp_DATA.Add(background_fit[1], -1)
        H_ssyfp_DATA.Add(background_fit[1], -1)
        H_ssxpfp_DATA.Add(background_fit[1], -1)
        H_ssypfp_DATA.Add(background_fit[1], -1)
        H_hsxfp_DATA.Add(background_fit[1], -1)
        H_hsyfp_DATA.Add(background_fit[1], -1)
        H_hsxpfp_DATA.Add(background_fit[1], -1)
        H_hsypfp_DATA.Add(background_fit[1], -1)
        H_ssxptar_DATA.Add(background_fit[1], -1)
        H_ssyptar_DATA.Add(background_fit[1], -1)
        H_hsxptar_DATA.Add(background_fit[1], -1)
        H_hsyptar_DATA.Add(background_fit[1], -1)
        H_ssdelta_DATA.Add(background_fit[1], -1)
        H_hsdelta_DATA.Add(background_fit[1], -1)
        H_ph_q_DATA.Add(background_fit[1], -1)
        H_th_q_DATA.Add(background_fit[1], -1)
        H_ph_recoil_DATA.Add(background_fit[1], -1)
        H_th_recoil_DATA.Add(background_fit[1], -1)
        H_Q2_DATA.Add(background_fit[1], -1)
        H_W_DATA.Add(background_fit[1], -1)
        H_t_DATA.Add(background_fit[1], -1)
        H_epsilon_DATA.Add(background_fit[1], -1)
        H_MM_DATA.Add(background_fit[1], -1)
        H_pmiss_DATA.Add(background_fit[1], -1)
        H_emiss_DATA.Add(background_fit[1], -1)
        H_pmx_DATA.Add(background_fit[1], -1)
        H_pmy_DATA.Add(background_fit[1], -1)
        H_pmz_DATA.Add(background_fit[1], -1)
        H_ct_DATA.Add(background_fit[1], -1)
