...
# Data W(0.5,2.0)
y_data_nooffset = [6.5e1, 1.07e2, 3.23e2, 1.46e3, 9.11e2]
...
plt.plot(Q2, slope_data_nooffset * np.array(Q2) + intercept_data_nooffset, 'b--', label=f'Linear Fit (m={slope_data_nooffset:.2f}, b={intercept_data_nooffset:.2f})')
plt.plot(Q2, slope_simc_nooffset * np.array(Q2) + intercept_simc_nooffset, 'r--', label=f'Linear Fit (m={slope_simc_nooffset:.2f}, b={intercept_simc_nooffset:.2f})')
plt.title("No Offset")
plt.xlabel('Q2')
plt.ylabel('Yield')
plt.legend()
...
plt.plot(Q2, slope_data * np.array(Q2) + intercept_data, 'b--', label=f'Linear Fit (m={slope_data:.2f}, b={intercept_data:.2f})')
plt.plot(Q2, slope_simc * np.array(Q2) + intercept_simc, 'r--', label=f'Linear Fit (m={slope_simc:.2f}, b={intercept_simc:.2f})')
plt.title("Offset")
plt.xlabel('Q2')
plt.ylabel('Yield')
plt.legend()
...
plt.plot(Ebeam, slope_data_nooffset * np.array(Ebeam) + intercept_data_nooffset, 'b--', label=f'Linear Fit (m={slope_data_nooffset:.2f}, b={intercept_data_nooffset:.2f})')
plt.plot(Ebeam, slope_simc_nooffset * np.array(Ebeam) + intercept_simc_nooffset, 'r--', label=f'Linear Fit (m={slope_simc_nooffset:.2f}, b={intercept_simc_nooffset:.2f})')
plt.title("No Offset")
plt.xlabel('Ebeam')
plt.ylabel('Yield')
plt.legend()
...
plt.plot(Ebeam, slope_data * np.array(Ebeam) + intercept_data, 'b--', label=f'Linear Fit (m={slope_data:.2f}, b={intercept_data:.2f})')
plt.plot(Ebeam, slope_simc * np.array(Ebeam) + intercept_simc, 'r--', label=f'Linear Fit (m={slope_simc:.2f}, b={intercept_simc:.2f})')
plt.title("Offset")
plt.xlabel('Ebeam')
plt.ylabel('Yield')
plt.legend()
