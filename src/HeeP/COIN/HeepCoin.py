...
# Description:
# ================================================================
# Time-stamp: "2023-09-14 10:58:50 trottar"
# ================================================================
#
...
H_pmiss_DATA  = ROOT.TH1D("H_pmiss_DATA","pmiss", 200, -1, 1)
H_pmiss_DATA_nocut  = ROOT.TH1D("H_pmiss_DATA_nocut","pmiss", 200, -1, 1)
H_pmiss_DATA_nopid  = ROOT.TH1D("H_pmiss_DATA_nopid","pmiss", 200, -1, 1)
#H_pmiss_DATA_rand  = ROOT.TH1D("H_pmiss_DATA_rand","pmiss", 200, -1, 1)
H_pmiss_DUMMY  = ROOT.TH1D("H_pmiss_DUMMY","pmiss", 200, -1, 1)
H_pmiss_DUMMY_nocut  = ROOT.TH1D("H_pmiss_DUMMY_nocut","pmiss", 200, -1, 1)
H_pmiss_DUMMY_nopid  = ROOT.TH1D("H_pmiss_DUMMY_nopid","pmiss", 200, -1, 1)
#H_pmiss_DUMMY_rand  = ROOT.TH1D("H_pmiss_DUMMY_rand","pmiss", 200, -1, 1)
H_pmiss_SIMC  = ROOT.TH1D("H_pmiss_SIMC","pmiss", 200, -1, 1)

H_emiss_DATA  = ROOT.TH1D("H_emiss_DATA","emiss", 200, -1, 1)
H_emiss_DATA_nocut  = ROOT.TH1D("H_emiss_DATA_nocut","emiss", 200, -1, 1)
H_emiss_DATA_nopid  = ROOT.TH1D("H_emiss_DATA_nopid","emiss", 200, -1, 1)
#H_emiss_DATA_rand  = ROOT.TH1D("H_emiss_DATA_rand","emiss", 200, -1, 1)
H_emiss_DUMMY  = ROOT.TH1D("H_emiss_DUMMY","emiss", 200, -1, 1)
H_emiss_DUMMY_nocut  = ROOT.TH1D("H_emiss_DUMMY_nocut","emiss", 200, -1, 1)
H_emiss_DUMMY_nopid  = ROOT.TH1D("H_emiss_DUMMY_nopid","emiss", 200, -1, 1)
#H_emiss_DUMMY_rand  = ROOT.TH1D("H_emiss_DUMMY_rand","emiss", 200, -1, 1)
H_emiss_SIMC  = ROOT.TH1D("H_emiss_SIMC","emiss", 200, -1, 1)
...
b_mean_pmiss_simc = fit_gaussian(H_pmiss_SIMC,-1, 1, "simc")
b_mean_pmiss_data = fit_gaussian(H_pmiss_DATA,-1, 1, "data")
b_mean_pmiss_dummy = fit_gaussian(H_pmiss_DUMMY,-1, 1, "dummy")
...
b_mean_emiss_simc = fit_gaussian(H_emiss_SIMC,-1, 1, "simc")
b_mean_emiss_data = fit_gaussian(H_emiss_DATA,-1, 1, "data")
b_mean_emiss_dummy = fit_gaussian(H_emiss_DUMMY,-1, 1, "dummy")
