...
# Description:
# ================================================================
# Time-stamp: "2023-09-07 20:40:37 trottar"
# ================================================================
#
...
b_mean_bpm_tar_x_data = (bpm_tar_x_DATA.Fit("gaus", "Q", "", bpm_tar_x_DATA.GetMean() - 2 * bpm_tar_x_DATA.GetRMS(), bpm_tar_x_DATA.GetMean() + 2 * bpm_tar_x_DATA.GetRMS()).GetParameter(1))
b_mean_bpm_tar_x_data_nocut = (bpm_tar_x_DATA_nocut.Fit("gaus", "Q", "", bpm_tar_x_DATA_nocut.GetMean() - 2 * bpm_tar_x_DATA_nocut.GetRMS(), bpm_tar_x_DATA_nocut.GetMean() + 2 * bpm_tar_x_DATA_nocut.GetRMS()).GetParameter(1))
b_mean_bpm_tar_x_data_nopid = (bpm_tar_x_DATA_nopid.Fit("gaus", "Q", "", bpm_tar_x_DATA_nopid.GetMean() - 2 * bpm_tar_x_DATA_nopid.GetRMS(), bpm_tar_x_DATA_nopid.GetMean() + 2 * bpm_tar_x_DATA_nopid.GetRMS()).GetParameter(1))
...
b_mean_bpm_tar_y_data = (bpm_tar_y_DATA.Fit("gaus", "Q", "", bpm_tar_y_DATA.GetMean() - 2 * bpm_tar_y_DATA.GetRMS(), bpm_tar_y_DATA.GetMean() + 2 * bpm_tar_y_DATA.GetRMS()).GetParameter(1))
b_mean_bpm_tar_y_data_nocut = (bpm_tar_y_DATA_nocut.Fit("gaus", "Q", "", bpm_tar_y_DATA_nocut.GetMean() - 2 * bpm_tar_y_DATA_nocut.GetRMS(), bpm_tar_y_DATA_nocut.GetMean() + 2 * bpm_tar_y_DATA_nocut.GetRMS()).GetParameter(1))
b_mean_bpm_tar_y_data_nopid = (bpm_tar_y_DATA_nopid.Fit("gaus", "Q", "", bpm_tar_y_DATA_nopid.GetMean() - 2 * bpm_tar_y_DATA_nopid.GetRMS(), bpm_tar_y_DATA_nopid.GetMean() + 2 * bpm_tar_y_DATA_nopid.GetRMS()).GetParameter(1))
...
b_mean_MMp2_simc = H_MMp2_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_MMp2_data = H_MMp2_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_MMp2_data_nocut = H_MMp2_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_MMp2_data_nopid = H_MMp2_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_MMp2_dummy = H_MMp2_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_ph_q_simc = H_ph_q_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_q_data = H_ph_q_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_q_data_nocut = H_ph_q_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_q_data_nopid = H_ph_q_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_q_dummy = H_ph_q_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_th_q_simc = H_th_q_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_q_data = H_th_q_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_q_data_nocut = H_th_q_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_q_data_nopid = H_th_q_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_q_dummy = H_th_q_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
#b_mean_ph_recoil_simc = H_ph_recoil_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_recoil_data = H_ph_recoil_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_recoil_data_nocut = H_ph_recoil_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_recoil_data_nopid = H_ph_recoil_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_ph_recoil_dummy = H_ph_recoil_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
#b_mean_th_recoil_simc = H_th_recoil_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_recoil_data = H_th_recoil_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_recoil_data_nocut = H_th_recoil_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_recoil_data_nopid = H_th_recoil_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_th_recoil_dummy = H_th_recoil_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_pmiss_simc = H_pmiss_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmiss_data = H_pmiss_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmiss_data_nocut = H_pmiss_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmiss_data_nopid = H_pmiss_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmiss_dummy = H_pmiss_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_emiss_simc = H_emiss_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_emiss_data = H_emiss_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_emiss_data_nocut = H_emiss_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_emiss_data_nopid = H_emiss_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_emiss_dummy = H_emiss_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_pmx_simc = H_pmx_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmx_data = H_pmx_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmx_data_nocut = H_pmx_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmx_data_nopid = H_pmx_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmx_dummy = H_pmx_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_pmy_simc = H_pmy_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmy_data = H_pmy_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmy_data_nocut = H_pmy_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmy_data_nopid = H_pmy_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmy_dummy = H_pmy_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_pmz_simc = H_pmz_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmz_data = H_pmz_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmz_data_nocut = H_pmz_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmz_data_nopid = H_pmz_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_pmz_dummy = H_pmz_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
...
b_mean_W_simc = H_W_SIMC.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_W_data = H_W_DATA.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_W_data_nocut = H_W_DATA_nocut.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_W_data_nopid = H_W_DATA_nopid.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
b_mean_W_dummy = H_W_DUMMY.Fit("gaus", "Q", "", histogram.GetMean() - 2 * histogram.GetRMS(), histogram.GetMean() + 2 * histogram.GetRMS()).GetParameter(1)
