...
# Description:
# ================================================================
# Time-stamp: "2023-09-13 20:44:48 trottar"
# ================================================================
#
...
def fit_gaussian(hist, x_min, x_max, dtype):
    ...
    min_range = hist.GetBinCenter(max_bin-1)
    max_range = hist.GetBinCenter(max_bin+1)
    ...
    fit_func = ROOT.TF1("fitFunc", "gaus(0)", min_range, max_range)
    if dtype == "simc":
