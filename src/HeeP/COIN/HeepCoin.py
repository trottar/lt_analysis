...
# Description:
# ================================================================
# Time-stamp: "2023-09-10 14:07:18 trottar"
# ================================================================
#
...
b_mean_pmiss_simc = fit_gaussian(H_pmiss_SIMC, H_pmiss_SIMC.GetMean() - H_pmiss_SIMC.GetRMS(), H_pmiss_SIMC.GetMean() + H_pmiss_SIMC.GetRMS()*0.75, "simc")
b_mean_pmiss_data = fit_gaussian(H_pmiss_DATA, H_pmiss_DATA.GetMean() - H_pmiss_DATA.GetRMS(), H_pmiss_DATA.GetMean() + H_pmiss_DATA.GetRMS()*0.75, "data")
...
b_mean_emiss_simc = fit_gaussian(H_emiss_SIMC, H_emiss_SIMC.GetMean() - H_emiss_SIMC.GetRMS(), H_emiss_SIMC.GetMean() + H_emiss_SIMC.GetRMS(), "simc")
b_mean_emiss_data = fit_gaussian(H_emiss_DATA, H_emiss_DATA.GetMean() - H_emiss_DATA.GetRMS(), H_emiss_DATA.GetMean() + H_emiss_DATA.GetRMS(), "data")
