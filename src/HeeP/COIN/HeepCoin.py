...
# Description:
# ================================================================
# Time-stamp: "2023-09-07 22:38:09 trottar"
# ================================================================
#
...
b_mean_MMp2_simc = fit_gaussian(H_MMp2_SIMC, H_MMp2_SIMC.GetMean() - H_MMp2_SIMC.GetRMS()/10, H_MMp2_SIMC.GetMean() + H_MMp2_SIMC.GetRMS()/10, "simc")
b_mean_MMp2_data = fit_gaussian(H_MMp2_DATA, H_MMp2_DATA.GetMean() - H_MMp2_DATA.GetRMS()/10, H_MMp2_DATA.GetMean() + H_MMp2_DATA.GetRMS()/10, "data")
b_mean_MMp2_dummy = fit_gaussian(H_MMp2_DUMMY, H_MMp2_DUMMY.GetMean() - H_MMp2_DUMMY.GetRMS()/10, H_MMp2_DUMMY.GetMean() + H_MMp2_DUMMY.GetRMS()/10, "dummy")
