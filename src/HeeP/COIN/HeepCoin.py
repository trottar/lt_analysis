...
# Description:
# ================================================================
# Time-stamp: "2023-09-13 17:45:08 trottar"
# ================================================================
#
...
H_hsdelta_DATA_nocut  = ROOT.TH1D("H_hsdelta_DATA_nocut","HMS Delta", 500, -20.0, 20.0)
H_hsdelta_DATA_nopid  = ROOT.TH1D("H_hsdelta_DATA_nopid","HMS Delta", 500, -20.0, 20.0)
#H_hsdelta_DATA_rand  = ROOT.TH1D("H_hsdelta_DATA_rand","HMS Delta", 500, -20.0, 20.0)
H_hsdelta_DUMMY  = ROOT.TH1D("H_hsdelta_DUMMY","HMS Delta", 500, -20.0, 20.0)
H_hsdelta_DUMMY_nocut  = ROOT.TH1D("H_hsdelta_DUMMY_nocut","HMS Delta", 500, -20.0, 20.0)
H_hsdelta_DUMMY_nopid  = ROOT.TH1D("H_hsdelta_DUMMY_nopid","HMS Delta", 500, -20.0, 20.0)
...
H_hsxptar_DATA_nocut  = ROOT.TH1D("H_hsxptar_DATA_nocut","HMS xptar", 500, -0.1, 0.1)
H_hsxptar_DATA_nopid  = ROOT.TH1D("H_hsxptar_DATA_nopid","HMS xptar", 500, -0.1, 0.1)
#H_hsxptar_DATA_rand  = ROOT.TH1D("H_hsxptar_DATA_rand","HMS xptar", 500, -0.1, 0.1)
H_hsxptar_DUMMY  = ROOT.TH1D("H_hsxptar_DUMMY","HMS xptar", 500, -0.1, 0.1)
H_hsxptar_DUMMY_nocut  = ROOT.TH1D("H_hsxptar_DUMMY_nocut","HMS xptar", 500, -0.1, 0.1)
H_hsxptar_DUMMY_nopid  = ROOT.TH1D("H_hsxptar_DUMMY_nopid","HMS xptar", 500, -0.1, 0.1)
...
H_hsyptar_DATA_nocut  = ROOT.TH1D("H_hsyptar_DATA_nocut","HMS yptar", 500, -0.1, 0.1)
H_hsyptar_DATA_nopid  = ROOT.TH1D("H_hsyptar_DATA_nopid","HMS yptar", 500, -0.1, 0.1)
#H_hsyptar_DATA_rand  = ROOT.TH1D("H_hsyptar_DATA_rand","HMS yptar", 500, -0.1, 0.1)
H_hsyptar_DUMMY  = ROOT.TH1D("H_hsyptar_DUMMY","HMS yptar", 500, -0.1, 0.1)
H_hsyptar_DUMMY_nocut  = ROOT.TH1D("H_hsyptar_DUMMY_nocut","HMS yptar", 500, -0.1, 0.1)
H_hsyptar_DUMMY_nopid  = ROOT.TH1D("H_hsyptar_DUMMY_nopid","HMS yptar", 500, -0.1, 0.1)
...
H_ssxfp_DATA_nocut    = ROOT.TH1D("H_ssxfp_DATA_nocut","SHMS xfp", 500, -25.0, 25.0)
H_ssxfp_DATA_nopid    = ROOT.TH1D("H_ssxfp_DATA_nopid","SHMS xfp", 500, -25.0, 25.0)
#H_ssxfp_DATA_rand    = ROOT.TH1D("H_ssxfp_DATA_rand","SHMS xfp", 500, -25.0, 25.0)
H_ssxfp_DUMMY    = ROOT.TH1D("H_ssxfp_DUMMY","SHMS xfp", 500, -25.0, 25.0)
H_ssxfp_DUMMY_nocut    = ROOT.TH1D("H_ssxfp_DUMMY_nocut","SHMS xfp", 500, -25.0, 25.0)
H_ssxfp_DUMMY_nopid    = ROOT.TH1D("H_ssxfp_DUMMY_nopid","SHMS xfp", 500, -25.0, 25.0)
...
H_ssyfp_DATA_nocut    = ROOT.TH1D("H_ssyfp_DATA_nocut","SHMS yfp", 500, -25.0, 25.0)
H_ssyfp_DATA_nopid    = ROOT.TH1D("H_ssyfp_DATA_nopid","SHMS yfp", 500, -25.0, 25.0)
#H_ssyfp_DATA_rand    = ROOT.TH1D("H_ssyfp_DATA_rand","SHMS yfp", 500, -25.0, 25.0)
H_ssyfp_DUMMY    = ROOT.TH1D("H_ssyfp_DUMMY","SHMS yfp", 500, -25.0, 25.0)
H_ssyfp_DUMMY_nocut    = ROOT.TH1D("H_ssyfp_DUMMY_nocut","SHMS yfp", 500, -25.0, 25.0)
H_ssyfp_DUMMY_nopid    = ROOT.TH1D("H_ssyfp_DUMMY_nopid","SHMS yfp", 500, -25.0, 25.0)
...
H_ssxpfp_DATA_nocut   = ROOT.TH1D("H_ssxpfp_DATA_nocut","SHMS xpfp", 500, -0.09, 0.09)
H_ssxpfp_DATA_nopid   = ROOT.TH1D("H_ssxpfp_DATA_nopid","SHMS xpfp", 500, -0.09, 0.09)
#H_ssxpfp_DATA_rand   = ROOT.TH1D("H_ssxpfp_DATA_rand","SHMS xpfp", 500, -0.09, 0.09)
H_ssxpfp_DUMMY   = ROOT.TH1D("H_ssxpfp_DUMMY","SHMS xpfp", 500, -0.09, 0.09)
H_ssxpfp_DUMMY_nocut   = ROOT.TH1D("H_ssxpfp_DUMMY_nocut","SHMS xpfp", 500, -0.09, 0.09)
H_ssxpfp_DUMMY_nopid   = ROOT.TH1D("H_ssxpfp_DUMMY_nopid","SHMS xpfp", 500, -0.09, 0.09)
...
H_ssypfp_DATA_nocut   = ROOT.TH1D("H_ssypfp_DATA_nocut","SHMS ypfp", 500, -0.05, 0.04)
H_ssypfp_DATA_nopid   = ROOT.TH1D("H_ssypfp_DATA_nopid","SHMS ypfp", 500, -0.05, 0.04)
#H_ssypfp_DATA_rand   = ROOT.TH1D("H_ssypfp_DATA_rand","SHMS ypfp", 500, -0.05, 0.04)
H_ssypfp_DUMMY   = ROOT.TH1D("H_ssypfp_DUMMY","SHMS ypfp", 500, -0.05, 0.04)
H_ssypfp_DUMMY_nocut   = ROOT.TH1D("H_ssypfp_DUMMY_nocut","SHMS ypfp", 500, -0.05, 0.04)
H_ssypfp_DUMMY_nopid   = ROOT.TH1D("H_ssypfp_DUMMY_nopid","SHMS ypfp", 500, -0.05, 0.04)
...
H_hsxfp_DATA_nocut    = ROOT.TH1D("H_hsxfp_DATA_nocut","HMS xfp", 500, -40.0, 40.0)
H_hsxfp_DATA_nopid    = ROOT.TH1D("H_hsxfp_DATA_nopid","HMS xfp", 500, -40.0, 40.0)
#H_hsxfp_DATA_rand    = ROOT.TH1D("H_hsxfp_DATA_rand","HMS xfp", 500, -40.0, 40.0)
H_hsxfp_DUMMY    = ROOT.TH1D("H_hsxfp_DUMMY","HMS xfp", 500, -40.0, 40.0)
H_hsxfp_DUMMY_nocut    = ROOT.TH1D("H_hsxfp_DUMMY_nocut","HMS xfp", 500, -40.0, 40.0)
H_hsxfp_DUMMY_nopid    = ROOT.TH1D("H_hsxfp_DUMMY_nopid","HMS xfp", 500, -40.0, 40.0)
...
H_hsyfp_DATA_nocut    = ROOT.TH1D("H_hsyfp_DATA_nocut","HMS yfp", 500, -20.0, 20.0)
H_hsyfp_DATA_nopid    = ROOT.TH1D("H_hsyfp_DATA_nopid","HMS yfp", 500, -20.0, 20.0)
#H_hsyfp_DATA_rand    = ROOT.TH1D("H_hsyfp_DATA_rand","HMS yfp", 500, -20.0, 20.0)
H_hsyfp_DUMMY    = ROOT.TH1D("H_hsyfp_DUMMY","HMS yfp", 500, -20.0, 20.0)
H_hsyfp_DUMMY_nocut    = ROOT.TH1D("H_hsyfp_DUMMY_nocut","HMS yfp", 500, -20.0, 20.0)
H_hsyfp_DUMMY_nopid    = ROOT.TH1D("H_hsyfp_DUMMY_nopid","HMS yfp", 500, -20.0, 20.0)
...
H_hsxpfp_DATA_nocut   = ROOT.TH1D("H_hsxpfp_DATA_nocut","HMS xpfp", 500, -0.09, 0.05)
H_hsxpfp_DATA_nopid   = ROOT.TH1D("H_hsxpfp_DATA_nopid","HMS xpfp", 500, -0.09, 0.05)
#H_hsxpfp_DATA_rand   = ROOT.TH1D("H_hsxpfp_DATA_rand","HMS xpfp", 500, -0.09, 0.05)
H_hsxpfp_DUMMY   = ROOT.TH1D("H_hsxpfp_DUMMY","HMS xpfp", 500, -0.09, 0.05)
H_hsxpfp_DUMMY_nocut   = ROOT.TH1D("H_hsxpfp_DUMMY_nocut","HMS xpfp", 500, -0.09, 0.05)
H_hsxpfp_DUMMY_nopid   = ROOT.TH1D("H_hsxpfp_DUMMY_nopid","HMS xpfp", 500, -0.09, 0.05)
...
H_hsypfp_DATA_nocut   = ROOT.TH1D("H_hsypfp_DATA_nocut","HMS ypfp", 500, -0.05, 0.04)
H_hsypfp_DATA_nopid   = ROOT.TH1D("H_hsypfp_DATA_nopid","HMS ypfp", 500, -0.05, 0.04)
#H_hsypfp_DATA_rand   = ROOT.TH1D("H_hsypfp_DATA_rand","HMS ypfp", 500, -0.05, 0.04)
H_hsypfp_DUMMY   = ROOT.TH1D("H_hsypfp_DUMMY","HMS ypfp", 500, -0.05, 0.04)
H_hsypfp_DUMMY_nocut   = ROOT.TH1D("H_hsypfp_DUMMY_nocut","HMS ypfp", 500, -0.05, 0.04)
H_hsypfp_DUMMY_nopid   = ROOT.TH1D("H_hsypfp_DUMMY_nopid","HMS ypfp", 500, -0.05, 0.04)
...
H_ssdelta_DATA_nocut  = ROOT.TH1D("H_ssdelta_DATA_nocut","SHMS delta", 500, -20.0, 20.0)
H_ssdelta_DATA_nopid  = ROOT.TH1D("H_ssdelta_DATA_nopid","SHMS delta", 500, -20.0, 20.0)
#H_ssdelta_DATA_rand  = ROOT.TH1D("H_ssdelta_DATA_rand","SHMS delta", 500, -20.0, 20.0)
H_ssdelta_DUMMY  = ROOT.TH1D("H_ssdelta_DUMMY","SHMS delta", 500, -20.0, 20.0)
H_ssdelta_DUMMY_nocut  = ROOT.TH1D("H_ssdelta_DUMMY_nocut","SHMS delta", 500, -20.0, 20.0)
H_ssdelta_DUMMY_nopid  = ROOT.TH1D("H_ssdelta_DUMMY_nopid","SHMS delta", 500, -20.0, 20.0)
...
H_ssxptar_DATA_nocut  = ROOT.TH1D("H_ssxptar_DATA_nocut","SHMS xptar", 500, -0.1, 0.1)
H_ssxptar_DATA_nopid  = ROOT.TH1D("H_ssxptar_DATA_nopid","SHMS xptar", 500, -0.1, 0.1)
#H_ssxptar_DATA_rand  = ROOT.TH1D("H_ssxptar_DATA_rand","SHMS xptar", 500, -0.1, 0.1)
H_ssxptar_DUMMY  = ROOT.TH1D("H_ssxptar_DUMMY","SHMS xptar", 500, -0.1, 0.1)
H_ssxptar_DUMMY_nocut  = ROOT.TH1D("H_ssxptar_DUMMY_nocut","SHMS xptar", 500, -0.1, 0.1)
H_ssxptar_DUMMY_nopid  = ROOT.TH1D("H_ssxptar_DUMMY_nopid","SHMS xptar", 500, -0.1, 0.1)
...
H_ssyptar_DATA_nocut  = ROOT.TH1D("H_ssyptar_DATA_nocut","SHMS yptar", 500, -0.04, 0.04)
H_ssyptar_DATA_nopid  = ROOT.TH1D("H_ssyptar_DATA_nopid","SHMS yptar", 500, -0.04, 0.04)
#H_ssyptar_DATA_rand  = ROOT.TH1D("H_ssyptar_DATA_rand","SHMS yptar", 500, -0.04, 0.04)
H_ssyptar_DUMMY  = ROOT.TH1D("H_ssyptar_DUMMY","SHMS yptar", 500, -0.04, 0.04)
H_ssyptar_DUMMY_nocut  = ROOT.TH1D("H_ssyptar_DUMMY_nocut","SHMS yptar", 500, -0.04, 0.04)
H_ssyptar_DUMMY_nopid  = ROOT.TH1D("H_ssyptar_DUMMY_nopid","SHMS yptar", 500, -0.04, 0.04)
...
H_q_DATA_nocut        = ROOT.TH1D("H_q_DATA_nocut","q", 500, 0.0, 10.0)
H_q_DATA_nopid        = ROOT.TH1D("H_q_DATA_nopid","q", 500, 0.0, 10.0)
#H_q_DATA_rand        = ROOT.TH1D("H_q_DATA_rand","q", 500, 0.0, 10.0)
H_q_DUMMY        = ROOT.TH1D("H_q_DUMMY","q", 500, 0.0, 10.0)
H_q_DUMMY_nocut        = ROOT.TH1D("H_q_DUMMY_nocut","q", 500, 0.0, 10.0)
H_q_DUMMY_nopid        = ROOT.TH1D("H_q_DUMMY_nopid","q", 500, 0.0, 10.0)
#H_q_DUMMY_rand        = ROOT.TH1D("H_q_DUMMY_rand","q", 500, 0.0, 10.0)
H_q_SIMC        = ROOT.TH1D("H_q_SIMC","q", 500, 0.0, 10.0)

H_Q2_DATA       = ROOT.TH1D("H_Q2_DATA","Q2", 500, 0.0, 10.0)  
H_Q2_DATA_nocut       = ROOT.TH1D("H_Q2_DATA_nocut","Q2", 500, 0.0, 10.0)  
H_Q2_DATA_nopid       = ROOT.TH1D("H_Q2_DATA_nopid","Q2", 500, 0.0, 10.0)  
#H_Q2_DATA_rand       = ROOT.TH1D("H_Q2_DATA_rand","Q2", 500, 0.0, 10.0)  
H_Q2_DUMMY       = ROOT.TH1D("H_Q2_DUMMY","Q2", 500, 0.0, 10.0)  
H_Q2_DUMMY_nocut       = ROOT.TH1D("H_Q2_DUMMY_nocut","Q2", 500, 0.0, 10.0)  
H_Q2_DUMMY_nopid       = ROOT.TH1D("H_Q2_DUMMY_nopid","Q2", 500, 0.0, 10.0)  
#H_Q2_DUMMY_rand       = ROOT.TH1D("H_Q2_DUMMY_rand","Q2", 500, 0.0, 10.0)  
H_Q2_SIMC       = ROOT.TH1D("H_Q2_SIMC","Q2", 500, 0.0, 10.0)  

H_epsilon_DATA  = ROOT.TH1D("H_epsilon_DATA","epsilon", 500, 0.5, 1.0)
H_epsilon_DATA_nocut  = ROOT.TH1D("H_epsilon_DATA_nocut","epsilon", 500, 0.5, 1.0)
H_epsilon_DATA_nopid  = ROOT.TH1D("H_epsilon_DATA_nopid","epsilon", 500, 0.5, 1.0)
#H_epsilon_DATA_rand  = ROOT.TH1D("H_epsilon_DATA_rand","epsilon", 500, 0.5, 1.0)
H_epsilon_DUMMY  = ROOT.TH1D("H_epsilon_DUMMY","epsilon", 500, 0.5, 1.0)
H_epsilon_DUMMY_nocut  = ROOT.TH1D("H_epsilon_DUMMY_nocut","epsilon", 500, 0.5, 1.0)
H_epsilon_DUMMY_nopid  = ROOT.TH1D("H_epsilon_DUMMY_nopid","epsilon", 500, 0.5, 1.0)
#H_epsilon_DUMMY_rand  = ROOT.TH1D("H_epsilon_DUMMY_rand","epsilon", 500, 0.5, 1.0)
H_epsilon_SIMC  = ROOT.TH1D("H_epsilon_SIMC","epsilon", 500, 0.5, 1.0)

H_MMp2_DATA  = ROOT.TH1D("H_MMp2_DATA","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_DATA_nocut  = ROOT.TH1D("H_MMp2_DATA_nocut","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_DATA_nopid  = ROOT.TH1D("H_MMp2_DATA_nopid","(MM)^{2}_{p}", 500, -0.01, 0.01)
#H_MMp2_DATA_rand  = ROOT.TH1D("H_MMp2_DATA_rand","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_DUMMY  = ROOT.TH1D("H_MMp2_DUMMY","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_DUMMY_nocut  = ROOT.TH1D("H_MMp2_DUMMY_nocut","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_DUMMY_nopid  = ROOT.TH1D("H_MMp2_DUMMY_nopid","(MM)^{2}_{p}", 500, -0.01, 0.01)
#H_MMp2_DUMMY_rand  = ROOT.TH1D("H_MMp2_DUMMY_rand","(MM)^{2}_{p}", 500, -0.01, 0.01)
H_MMp2_SIMC  = ROOT.TH1D("H_MMp2_SIMC","(MM)^{2}_{p}", 500, -0.01, 0.01)

H_th_DATA  = ROOT.TH1D("H_th_DATA","X' tar", 500, -0.1, 0.1)
H_th_DATA_nocut  = ROOT.TH1D("H_th_DATA_nocut","X' tar", 500, -0.1, 0.1)
H_th_DATA_nopid  = ROOT.TH1D("H_th_DATA_nopid","X' tar", 500, -0.1, 0.1)
#H_th_DATA_rand  = ROOT.TH1D("H_th_DATA_rand","X' tar", 500, -0.1, 0.1)
H_th_DUMMY  = ROOT.TH1D("H_th_DUMMY","X' tar", 500, -0.1, 0.1)
H_th_DUMMY_nocut  = ROOT.TH1D("H_th_DUMMY_nocut","X' tar", 500, -0.1, 0.1)
H_th_DUMMY_nopid  = ROOT.TH1D("H_th_DUMMY_nopid","X' tar", 500, -0.1, 0.1)
...
H_ph_DATA_nocut  = ROOT.TH1D("H_ph_DATA_nocut","Y' tar", 500, -0.1, 0.1)
H_ph_DATA_nopid  = ROOT.TH1D("H_ph_DATA_nopid","Y' tar", 500, -0.1, 0.1)
#H_ph_DATA_rand  = ROOT.TH1D("H_ph_DATA_rand","Y' tar", 500, -0.1, 0.1)
H_ph_DUMMY  = ROOT.TH1D("H_ph_DUMMY","Y' tar", 500, -0.1, 0.1)
H_ph_DUMMY_nocut  = ROOT.TH1D("H_ph_DUMMY_nocut","Y' tar", 500, -0.1, 0.1)
H_ph_DUMMY_nopid  = ROOT.TH1D("H_ph_DUMMY_nopid","Y' tar", 500, -0.1, 0.1)
#H_ph_DUMMY_rand  = ROOT.TH1D("H_ph_DUMMY_rand","Y' tar", 500, -0.1, 0.1)
H_ph_SIMC  = ROOT.TH1D("H_ph_SIMC","Y' tar", 500, -0.1, 0.1)

H_ph_q_DATA  = ROOT.TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_DATA_nocut  = ROOT.TH1D("H_ph_q_DATA_nocut","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_DATA_nopid  = ROOT.TH1D("H_ph_q_DATA_nopid","Phi Detected (ph_xq)", 500, -10.0, 10.0)
#H_ph_q_DATA_rand  = ROOT.TH1D("H_ph_q_DATA_rand","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_DUMMY  = ROOT.TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_DUMMY_nocut  = ROOT.TH1D("H_ph_q_DUMMY_nocut","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_DUMMY_nopid  = ROOT.TH1D("H_ph_q_DUMMY_nopid","Phi Detected (ph_xq)", 500, -10.0, 10.0)
#H_ph_q_DUMMY_rand  = ROOT.TH1D("H_ph_q_DUMMY_rand","Phi Detected (ph_xq)", 500, -10.0, 10.0)
H_ph_q_SIMC  = ROOT.TH1D("H_ph_q_SIMC","Phi Detected (ph_xq)", 500, -10.0, 10.0)

H_th_q_DATA  = ROOT.TH1D("H_th_q_DATA","Theta Detected (th_xq)", 500, -0.2, 0.2)
H_th_q_DATA_nocut  = ROOT.TH1D("H_th_q_DATA_nocut","Theta Detected (th_xq)", 500, -0.2, 0.2)
H_th_q_DATA_nopid  = ROOT.TH1D("H_th_q_DATA_nopid","Theta Detected (th_xq)", 500, -0.2, 0.2)
#H_th_q_DATA_rand  = ROOT.TH1D("H_th_q_DATA_rand","Theta Detected (th_xq)", 500, -0.2, 0.2)
H_th_q_DUMMY  = ROOT.TH1D("H_th_q_DUMMY","Theta Detected (th_xq)", 500, -0.2, 0.2)
H_th_q_DUMMY_nocut  = ROOT.TH1D("H_th_q_DUMMY_nocut","Theta Detected (th_xq)", 500, -0.2, 0.2)
H_th_q_DUMMY_nopid  = ROOT.TH1D("H_th_q_DUMMY_nopid","Theta Detected (th_xq)", 500, -0.2, 0.2)
...
H_ph_recoil_DATA_nocut  = ROOT.TH1D("H_ph_recoil_DATA_nocut","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
H_ph_recoil_DATA_nopid  = ROOT.TH1D("H_ph_recoil_DATA_nopid","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
#H_ph_recoil_DATA_rand  = ROOT.TH1D("H_ph_recoil_DATA_rand","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
H_ph_recoil_DUMMY  = ROOT.TH1D("H_ph_recoil_DUMMY","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
H_ph_recoil_DUMMY_nocut  = ROOT.TH1D("H_ph_recoil_DUMMY_nocut","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
H_ph_recoil_DUMMY_nopid  = ROOT.TH1D("H_ph_recoil_DUMMY_nopid","Phi Recoil (ph_bq)", 500, -10.0, 10.0)
...
H_th_recoil_DATA_nocut  = ROOT.TH1D("H_th_recoil_DATA_nocut","Theta Recoil (th_bq)", 500, -10.0, 10.0)
H_th_recoil_DATA_nopid  = ROOT.TH1D("H_th_recoil_DATA_nopid","Theta Recoil (th_bq)", 500, -10.0, 10.0)
#H_th_recoil_DATA_rand  = ROOT.TH1D("H_th_recoil_DATA_rand","Theta Recoil (th_bq)", 500, -10.0, 10.0)
H_th_recoil_DUMMY  = ROOT.TH1D("H_th_recoil_DUMMY","Theta Recoil (th_bq)", 500, -10.0, 10.0)
H_th_recoil_DUMMY_nocut  = ROOT.TH1D("H_th_recoil_DUMMY_nocut","Theta Recoil (th_bq)", 500, -10.0, 10.0)
H_th_recoil_DUMMY_nopid  = ROOT.TH1D("H_th_recoil_DUMMY_nopid","Theta Recoil (th_bq)", 500, -10.0, 10.0)
...
H_pmiss_DATA  = ROOT.TH1D("H_pmiss_DATA","pmiss", 500, -0.03, -0.04)
H_pmiss_DATA_nocut  = ROOT.TH1D("H_pmiss_DATA_nocut","pmiss", 500, -0.03, -0.04)
H_pmiss_DATA_nopid  = ROOT.TH1D("H_pmiss_DATA_nopid","pmiss", 500, -0.03, -0.04)
#H_pmiss_DATA_rand  = ROOT.TH1D("H_pmiss_DATA_rand","pmiss", 500, -0.03, -0.04)
H_pmiss_DUMMY  = ROOT.TH1D("H_pmiss_DUMMY","pmiss", 500, -0.03, -0.04)
H_pmiss_DUMMY_nocut  = ROOT.TH1D("H_pmiss_DUMMY_nocut","pmiss", 500, -0.03, -0.04)
H_pmiss_DUMMY_nopid  = ROOT.TH1D("H_pmiss_DUMMY_nopid","pmiss", 500, -0.03, -0.04)
#H_pmiss_DUMMY_rand  = ROOT.TH1D("H_pmiss_DUMMY_rand","pmiss", 500, -0.03, -0.04)
H_pmiss_SIMC  = ROOT.TH1D("H_pmiss_SIMC","pmiss", 500, -0.03, -0.04)

H_emiss_DATA  = ROOT.TH1D("H_emiss_DATA","emiss", 500, -0.03, -0.04)
H_emiss_DATA_nocut  = ROOT.TH1D("H_emiss_DATA_nocut","emiss", 500, -0.03, -0.04)
H_emiss_DATA_nopid  = ROOT.TH1D("H_emiss_DATA_nopid","emiss", 500, -0.03, -0.04)
#H_emiss_DATA_rand  = ROOT.TH1D("H_emiss_DATA_rand","emiss", 500, -0.03, -0.04)
H_emiss_DUMMY  = ROOT.TH1D("H_emiss_DUMMY","emiss", 500, -0.03, -0.04)
H_emiss_DUMMY_nocut  = ROOT.TH1D("H_emiss_DUMMY_nocut","emiss", 500, -0.03, -0.04)
H_emiss_DUMMY_nopid  = ROOT.TH1D("H_emiss_DUMMY_nopid","emiss", 500, -0.03, -0.04)
#H_emiss_DUMMY_rand  = ROOT.TH1D("H_emiss_DUMMY_rand","emiss", 500, -0.03, -0.04)
H_emiss_SIMC  = ROOT.TH1D("H_emiss_SIMC","emiss", 500, -0.03, -0.04)

H_pmx_DATA  = ROOT.TH1D("H_pmx_DATA","pmx", 500, -0.1, 0.1)
H_pmx_DATA_nocut  = ROOT.TH1D("H_pmx_DATA_nocut","pmx", 500, -0.1, 0.1)
H_pmx_DATA_nopid  = ROOT.TH1D("H_pmx_DATA_nopid","pmx", 500, -0.1, 0.1)
#H_pmx_DATA_rand  = ROOT.TH1D("H_pmx_DATA_rand","pmx", 500, -0.1, 0.1)
H_pmx_DUMMY  = ROOT.TH1D("H_pmx_DUMMY","pmx", 500, -0.1, 0.1)
H_pmx_DUMMY_nocut  = ROOT.TH1D("H_pmx_DUMMY_nocut","pmx", 500, -0.1, 0.1)
H_pmx_DUMMY_nopid  = ROOT.TH1D("H_pmx_DUMMY_nopid","pmx", 500, -0.1, 0.1)
#H_pmx_DUMMY_rand  = ROOT.TH1D("H_pmx_DUMMY_rand","pmx", 500, -0.1, 0.1)
H_pmx_SIMC  = ROOT.TH1D("H_pmx_SIMC","pmx", 500, -0.1, 0.1)

H_pmy_DATA  = ROOT.TH1D("H_pmy_DATA","pmy ", 500, -0.1, 0.1)
H_pmy_DATA_nocut  = ROOT.TH1D("H_pmy_DATA_nocut","pmy ", 500, -0.1, 0.1)
H_pmy_DATA_nopid  = ROOT.TH1D("H_pmy_DATA_nopid","pmy ", 500, -0.1, 0.1)
#H_pmy_DATA_rand  = ROOT.TH1D("H_pmy_DATA_rand","pmy ", 500, -0.1, 0.1)
H_pmy_DUMMY  = ROOT.TH1D("H_pmy_DUMMY","pmy ", 500, -0.1, 0.1)
H_pmy_DUMMY_nocut  = ROOT.TH1D("H_pmy_DUMMY_nocut","pmy ", 500, -0.1, 0.1)
H_pmy_DUMMY_nopid  = ROOT.TH1D("H_pmy_DUMMY_nopid","pmy ", 500, -0.1, 0.1)
#H_pmy_DUMMY_rand  = ROOT.TH1D("H_pmy_DUMMY_rand","pmy ", 500, -0.1, 0.1)
H_pmy_SIMC  = ROOT.TH1D("H_pmy_SIMC","pmy", 500, -0.1, 0.1)

H_pmz_DATA  = ROOT.TH1D("H_pmz_DATA","pmz", 500, -0.1, 0.1)
H_pmz_DATA_nocut  = ROOT.TH1D("H_pmz_DATA_nocut","pmz", 500, -0.1, 0.1)
H_pmz_DATA_nopid  = ROOT.TH1D("H_pmz_DATA_nopid","pmz", 500, -0.1, 0.1)
#H_pmz_DATA_rand  = ROOT.TH1D("H_pmz_DATA_rand","pmz", 500, -0.1, 0.1)
H_pmz_DUMMY  = ROOT.TH1D("H_pmz_DUMMY","pmz", 500, -0.1, 0.1)
H_pmz_DUMMY_nocut  = ROOT.TH1D("H_pmz_DUMMY_nocut","pmz", 500, -0.1, 0.1)
H_pmz_DUMMY_nopid  = ROOT.TH1D("H_pmz_DUMMY_nopid","pmz", 500, -0.1, 0.1)
#H_pmz_DUMMY_rand  = ROOT.TH1D("H_pmz_DUMMY_rand","pmz", 500, -0.1, 0.1)
H_pmz_SIMC  = ROOT.TH1D("H_pmz_SIMC","pmz", 500, -0.1, 0.1)

H_W_DATA  = ROOT.TH1D("H_W_DATA","W ", 500, 0.7, 1.1)
H_W_DATA_nocut  = ROOT.TH1D("H_W_DATA_nocut","W ", 500, 0.7, 1.1)
H_W_DATA_nopid  = ROOT.TH1D("H_W_DATA_nopid","W ", 500, 0.7, 1.1)
#H_W_DATA_rand  = ROOT.TH1D("H_W_DATA_rand","W ", 500, 0.7, 1.1)
H_W_DUMMY  = ROOT.TH1D("H_W_DUMMY","W ", 500, 0.7, 1.1)
H_W_DUMMY_nocut  = ROOT.TH1D("H_W_DUMMY_nocut","W ", 500, 0.7, 1.1)
H_W_DUMMY_nopid  = ROOT.TH1D("H_W_DUMMY_nopid","W ", 500, 0.7, 1.1)
#H_W_DUMMY_rand  = ROOT.TH1D("H_W_DUMMY_rand","W ", 500, 0.7, 1.1)
H_W_SIMC  = ROOT.TH1D("H_W_SIMC","W", 500, 0.7, 1.1)

H_ct_ep_DATA = ROOT.TH1D("H_ct_ep_DATA", "Electron-Proton CTime", 500, -10, 10)
H_ct_ep_DATA_nocut = ROOT.TH1D("H_ct_ep_DATA_nocut", "Electron-Proton CTime", 500, -10, 10)
H_ct_ep_DATA_nopid = ROOT.TH1D("H_ct_ep_DATA_nopid", "Electron-Proton CTime", 500, -10, 10)
H_ct_ep_DUMMY = ROOT.TH1D("H_ct_ep_DUMMY", "Electron-Proton CTime", 500, -10, 10)
H_ct_ep_DUMMY_nocut = ROOT.TH1D("H_ct_ep_DUMMY_nocut", "Electron-Proton CTime", 500, -10, 10)
H_ct_ep_DUMMY_nopid = ROOT.TH1D("H_ct_ep_DUMMY_nopid", "Electron-Proton CTime", 500, -10, 10)

H_ct_ep_vs_H_MMp2_DATA = ROOT.TH2D("H_ct_ep_vs_H_MMp2_DATA","Electron-Proton CTime vs (MM)^{2}_{p}; e p Coin_Time; (MM)^{2}_{p}", 500, -10, 10, 500, -0.1, 0.1)
#H_ct_ep_vs_H_MMp2_DATA_rand = ROOT.TH2D("H_ct_ep_vs_H_MMp2_DATA_rand","Electron-Proton CTime vs (MM)^{2}_{p}; e p Coin_Time; (MM)^{2}_{p}", 500, -10, 10, 500, -0.1, 0.1)

H_emiss_vs_H_hsdelta_DATA = ROOT.TH2D("H_emiss_vs_H_hsdelta_DATA","Emiss vs HMS Delta;  Emiss; HMS Delta", 500, -0.1, 0.1, 500, -20.0, 20.0)
H_emiss_vs_H_ssdelta_DATA = ROOT.TH2D("H_emiss_vs_H_ssdelta_DATA","Emiss vs SHMS Delta;  Emiss; SHMS Delta", 500, -0.1, 0.1, 500, -20.0, 20.0)

H_pmiss_vs_H_hsdelta_DATA = ROOT.TH2D("H_pmiss_vs_H_hsdelta_DATA","Pmiss vs HMS Delta;  Pmiss; HMS Delta", 500, -0.1, 0.1, 500, -20.0, 20.0)
H_pmiss_vs_H_ssdelta_DATA = ROOT.TH2D("H_pmiss_vs_H_ssdelta_DATA","Pmiss vs SHMS Delta;  Pmiss; SHMS Delta", 500, -0.1, 0.1, 500, -20.0, 20.0)

H_hsdelta_vs_H_ssdelta_DATA = ROOT.TH2D("H_hsdelta_vs_H_ssdelta_DATA","HMS Delta vs SHMS Delta;  HMS Delta; SHMS Delta", 500, -20.0,20.0, 500, -20.0, 20.0)

H_raster_x_vs_H_pmiss_DATA = ROOT.TH2D("H_raster_x_vs_H_pmiss_DATA","Raster_X vs pmiss;  pmiss; Raster_X", 500, -0.1,0.1, 500, -0.25,0.25)
H_raster_x_vs_H_emiss_DATA = ROOT.TH2D("H_raster_x_vs_H_emiss_DATA","Raster_X vs emiss;  emiss; Raster_X", 500, -0.1,0.1, 500, -0.25,0.25)
H_raster_y_vs_H_pmiss_DATA = ROOT.TH2D("H_raster_y_vs_H_pmiss_DATA","Raster_Y vs pmiss;  pmiss; Raster_Y", 500, -0.1,0.1, 500, -0.05,0.25)
H_raster_y_vs_H_emiss_DATA = ROOT.TH2D("H_raster_y_vs_H_emiss_DATA","Raster_Y vs emiss;  emiss; Raster_Y", 500, -0.1,0.1, 500, -0.05,0.25)
H_raster_x_vs_H_raster_y_DATA = ROOT.TH2D("H_raster_x_vs_H_raster_y_DATA","Raster_X vs Raster_Y;  Raster_X; Raster_Y", 500, -0.25,0.25, 500, -0.05,0.25)
...
H_cal_etottracknorm_DATA_nocut = ROOT.TH1D("H_cal_etottracknorm_DATA_nocut", "HMS Cal etottracknorm", 500, 0.2, 1.8)
H_cal_etottracknorm_DATA_nopid = ROOT.TH1D("H_cal_etottracknorm_DATA_nopid", "HMS Cal etottracknorm", 500, 0.2, 1.8)
H_cer_npeSum_DATA_nocut = ROOT.TH1D("H_cer_npeSum_DATA_nocut", "HMS Cer Npe Sum", 500, 0, 30)
H_cer_npeSum_DATA_nopid = ROOT.TH1D("H_cer_npeSum_DATA_nopid", "HMS Cer Npe Sum", 500, 0, 30)

P_cal_etottracknorm_DATA_nocut = ROOT.TH1D("P_cal_etottracknorm_DATA_nocut", "SHMS Cal etottracknorm", 500, 0, 1)
P_cal_etottracknorm_DATA_nopid = ROOT.TH1D("P_cal_etottracknorm_DATA_nopid", "SHMS Cal etottracknorm", 500, 0, 1)
P_hgcer_npeSum_DATA_nocut = ROOT.TH1D("P_hgcer_npeSum_DATA_nocut", "SHMS HGCer Npe Sum", 500, 0, 50)
P_hgcer_npeSum_DATA_nopid = ROOT.TH1D("P_hgcer_npeSum_DATA_nopid", "SHMS HGCer Npe Sum", 500, 0, 50)
P_aero_npeSum_DATA_nocut = ROOT.TH1D("P_aero_npeSum_DATA_nocut", "SHMS Aero Npe Sum", 500, 0, 50)
P_aero_npeSum_DATA_nopid = ROOT.TH1D("P_aero_npeSum_DATA_nopid", "SHMS Aero Npe Sum", 500, 0, 50)

H_cal_etottracknorm_vs_H_cer_npeSum_DATA = ROOT.TH2D("H_cal_etottracknorm_vs_H_cer_npeSum_DATA","HMS Cal etottracknorm vs HMS Cer Npe Sum;  HMS Cal etottracknorm; HMS Cer Npe Sum", 500, 0.2, 1.8, 500, 0, 30)
P_cal_etottracknorm_vs_P_hgcer_npeSum_DATA = ROOT.TH2D("P_cal_etottracknorm_vs_P_hgcer_npeSum_DATA","SHMS Cal etottracknorm vs SHMS HGCer Npe Sum;  SHMS Cal etottracknorm; SHMS HGCer Npe Sum", 500, 0, 1, 500, 0, 50)
P_cal_etottracknorm_vs_P_aero_npeSum_DATA = ROOT.TH2D("P_cal_etottracknorm_vs_P_aero_npeSum_DATA","SHMS Cal etottracknorm vs SHMS Aero Npe Sum;  SHMS Cal etottracknorm; SHMS Aero Npe Sum", 500, 0, 1, 500, 0, 50)
P_hgcer_npeSum_vs_P_aero_npeSum_DATA = ROOT.TH2D("P_hgcer_npeSum_vs_P_aero_npeSum_DATA","SHMS HGCer Npe Sum vs SHMS Aero Npe Sum;  SHMS HGCer Npe Sum; SHMS Aero Npe Sum", 500, 0, 50, 500, 0, 50)

bpm_tar_x_DATA  = ROOT.TH1D("bpm_tar_x_DATA","BPM Target x", 500, -0.1, 0.1)
bpm_tar_x_DATA_nocut  = ROOT.TH1D("bpm_tar_x_DATA_nocut","BPM Target x", 500, -0.1, 0.1)
bpm_tar_x_DATA_nopid  = ROOT.TH1D("bpm_tar_x_DATA_nopid","BPM Target x", 500, -0.1, 0.1)

bpm_tar_y_DATA  = ROOT.TH1D("bpm_tar_y_DATA","BPM Target y", 500, 0.0, 0.2)
bpm_tar_y_DATA_nocut  = ROOT.TH1D("bpm_tar_y_DATA_nocut","BPM Target y", 500, 0.0, 0.2)
bpm_tar_y_DATA_nopid  = ROOT.TH1D("bpm_tar_y_DATA_nopid","BPM Target y", 500, 0.0, 0.2)
...
b_mean_MMp2_simc = fit_gaussian(H_MMp2_SIMC, "simc")
b_mean_MMp2_data = fit_gaussian(H_MMp2_DATA, "data")
b_mean_MMp2_dummy = fit_gaussian(H_MMp2_DUMMY, "dummy")
...
b_mean_ph_q_simc = fit_gaussian(H_ph_q_SIMC, "simc")
b_mean_ph_q_data = fit_gaussian(H_ph_q_DATA, "data")
b_mean_ph_q_dummy = fit_gaussian(H_ph_q_DUMMY, "dummy")

l_ph_q.AddEntry(H_ph_q_SIMC,"SIMC, INT = {:.0f}".format( b_int_ph_q_simc))
l_ph_q.AddEntry(H_ph_q_DATA,"DATA, INT = {:.0f}".format( b_int_ph_q_data))
if DEBUG:
...
b_mean_th_q_simc = fit_gaussian(H_th_q_SIMC, "simc")
b_mean_th_q_data = fit_gaussian(H_th_q_DATA, "data")
b_mean_th_q_dummy = fit_gaussian(H_th_q_DUMMY, "dummy")

l_th_q.AddEntry(H_th_q_SIMC,"SIMC, INT = {:.0f}".format( b_int_th_q_simc))
l_th_q.AddEntry(H_th_q_DATA,"DATA, INT = {:.0f}".format( b_int_th_q_data))
if DEBUG:
...
b_mean_pmiss_simc = fit_gaussian(H_pmiss_SIMC, "simc")
b_mean_pmiss_data = fit_gaussian(H_pmiss_DATA, "data")
b_mean_pmiss_dummy = fit_gaussian(H_pmiss_DUMMY, "dummy")
...
b_mean_emiss_simc = fit_gaussian(H_emiss_SIMC, "simc")
b_mean_emiss_data = fit_gaussian(H_emiss_DATA, "data")
b_mean_emiss_dummy = fit_gaussian(H_emiss_DUMMY, "dummy")
...
b_mean_pmx_simc = fit_gaussian(H_pmx_SIMC, "simc")
b_mean_pmx_data = fit_gaussian(H_pmx_DATA, "data")
b_mean_pmx_dummy = fit_gaussian(H_pmx_DUMMY, "dummy")
...
b_mean_pmy_simc = fit_gaussian(H_pmy_SIMC, "simc")
b_mean_pmy_data = fit_gaussian(H_pmy_DATA, "data")
b_mean_pmy_dummy = fit_gaussian(H_pmy_DUMMY, "dummy")
...
b_mean_pmz_simc = fit_gaussian(H_pmz_SIMC, "simc")
b_mean_pmz_data = fit_gaussian(H_pmz_DATA, "data")
b_mean_pmz_dummy = fit_gaussian(H_pmz_DUMMY, "dummy")
...
b_mean_W_simc = fit_gaussian(H_W_SIMC, "simc")
b_mean_W_data = fit_gaussian(H_W_DATA, "data")
b_mean_W_dummy = fit_gaussian(H_W_DUMMY, "dummy")
