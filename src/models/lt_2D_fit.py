...
# Description:
# ================================================================
# Time-stamp: "2024-03-01 00:15:30 trottar"
# ================================================================
#
...
def single_setting(q2_set, fn_lo, fn_hi):
    ...
    for i in range(0, t_bin_num):
        ...
        sig_lo.GetYaxis().SetTitle("#bar{#it{#epsilon}_{Low}}")
        ...
        sig_hi.GetYaxis().SetTitle("#bar{#it{#epsilon}_{High}}")
        ...
        sig_diff_g.GetYaxis().SetTitle("#frac{#it{#Delta#epsilon}_{Truth}}{#it{#Delta#epsilon}}")
