...
# Description:
# ================================================================
# Time-stamp: "2024-02-28 00:56:02 trottar"
# ================================================================
#
...
def single_setting(q2_set, fn_lo, fn_hi):
    ...
    for i in range(0, t_bin_num):
        ...
        for j in range(nlo.GetSelectedRows()):
            ...
            if nlo.GetV3()[j] > nlo.GetV1()[j]*1.10:
                continue
        ...
        for j in range(nhi.GetSelectedRows()):
            ...
            # Skip insane uncertainty bins
            if nhi.GetV3()[j] > nhi.GetV1()[j]*1.10:
                continue
        ...
        for ii in range(glo.GetN()):
            ...
            # Skip insane uncertainty bins
            if nlo.GetV3()[ii] > nlo.GetV1()[ii]*1.10:
                continue
        ...
        for ii in range(ghi.GetN()):
            ...
            # Skip insane uncertainty bins
            if nhi.GetV3()[ii] > nhi.GetV1()[ii]*1.10:
                continue
