...
# Description:
# ================================================================
# Time-stamp: "2024-02-04 19:12:03 trottar"
# ================================================================
#
...
def single_setting(q2_set, fn_lo, fn_hi):
    ...
    for i in range(0, t_bin_num):
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit 1".format(i))
        if i == 0:
            c1.Print(outputpdf+'(')
        else:
            c1.Print(outputpdf)
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit 2".format(i))
        c2.Print(outputpdf)
        c2.Clear()
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit 3".format(i))
        c3.Print(outputpdf)
        c3.Clear()
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit 4".format(i))
        c4.Print(outputpdf)
        c4.Clear()
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit 5".format(i))
        c5.Print(outputpdf)
        c5.Clear()
        ...
        g_plot_err.GetXaxis().Draw("perr")
        g_plot_err.GetXaxis().SetTitle("t-bin {}: Fit All".format(i))
        c6.Print(outputpdf)
        c6.Clear()
