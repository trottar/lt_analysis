...
# Description:
# ================================================================
# Time-stamp: "2024-03-23 12:14:38 trottar"
# ================================================================
#
...
def single_setting(q2_set, w_set, fn_lo, fn_hi):
    ...
    for i in range(0, t_bin_num):
        ...
        fit_status.DrawTextNDC(0.15, 0.85, "t={:.3f}, {}={:.1f}, W={:.2f}".format(t_list[i], ROOT.TLatex("Q^{2}"), float(q2_set.replace("p",".")), float(w_set.replace("p","."))))
