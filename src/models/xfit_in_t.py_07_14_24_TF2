...
# Description:
# ================================================================
# Time-stamp: "2024-07-14 22:39:20 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range, Q2min_range, Q2max_range, iter_num, max_iterations):
    ...
    for start in range(num_starts):
        ...
        while iteration <= max_iterations:
            ...
            try:
                ...
                f_sigL = TF2("sig_L", fun_Sig_L, tmin_range, tmax_range, Q2min_range, Q2max_range, 2)
    ...
    f_sigL_pre = TF2("sig_L", fun_Sig_L, tmin_range, tmax_range, Q2min_range, Q2max_range, 2)
    ...
    f_sigL_xproj = TF12("f_sigL_xproj", f_sigL, q2_set.replace("p","."), "x")
    ...
    for start in range(num_starts):
        ...
        while iteration <= max_iterations:
            ...
            try:
                ...
                f_sigL = TF2("sig_L", fun_Sig_L, tmin_range, tmax_range, 3)
    ...
    f_sigL_pre = TF2("sig_L", fun_Sig_L, tmin_range, tmax_range, 3)
    ...
    r_sigt_fit = g_q2_sigt_fit.Fit(f_sigT, "SQ")
    # TF2 projected to 1D along x-axis (ie only t-dependence, fixed Q2)    
    f_sigT_xproj = TF12("f_sigT_xproj", f_sigT, q2_set.replace("p","."), "x")
    ...
    for start in range(num_starts):
        ...
        while iteration <= max_iterations:
            ...
            try:
                ...
                f_sigT = TF2("sig_T", fun_Sig_T, tmin_range, tmax_range, 3)
    ...
    f_sigT_pre = TF2("sig_T", fun_Sig_T, tmin_range, tmax_range, 3)
    ...
    for start in range(num_starts):
        ...
        while iteration <= max_iterations:
            ...
            try:
                ...
                f_sigLT = TF2("sig_LT", fun_Sig_LT, tmin_range, tmax_range, Q2min_range, Q2max_range, 2)
    ...
    f_sigLT_pre = TF2("sig_LT", fun_Sig_LT, tmin_range, tmax_range, Q2min_range, Q2max_range, 2)
    ...
    r_siglt_fit = g_q2_siglt_fit.Fit(f_sigLT, "SQ")
    # TF2 projected to 1D along x-axis (ie only t-dependence, fixed Q2)    
    f_sigLT_xproj = TF12("f_sigLT_xproj", f_sigLT, q2_set.replace("p","."), "x")
    ...
    r_sigtt_fit = g_q2_sigtt_fit.Fit(f_sigTT, "SQ")
    # TF2 projected to 1D along x-axis (ie only t-dependence, fixed Q2)
    f_sigTT_xproj = TF12("f_sigTT_xproj", f_sigTT, q2_set.replace("p","."), "x")
