...
# Description:
# ================================================================
# Time-stamp: "2024-10-07 00:40:19 trottar"
# ================================================================
#
...
def import_model(inp_model, arg_str):
    ...
    # Apply weight factor
    #g = 1 / ((ww**2) - (m_p**2))**2
    #g = 1 / ((ww**2) - (m_p**2))**2.45 # Q2=5.5,W=3.02, Q2=2.115, W=2.95
    #g = 1 / ((ww**2) - (m_p**2))**2.65 # Q2=4.4,W=2.74
    #g = 1 / ((ww**2) - (m_p**2))**2.25 # Q2=3.0,W=3.14
    g = 1 / ((ww**2) - (m_p**2))**3.4 # Q2=3.0,W=2.32
    sig_sep = sig_sep*g
