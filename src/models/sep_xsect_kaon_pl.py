...
# Description:
# ================================================================
# Time-stamp: "2024-07-16 00:35:34 trottar"
# ================================================================
#
    ...
    def sig_LT(*par):
        if inp_model == "sigLT":
            ...
            try:
                ...
                f=(par[0]/(1+math.log(qq)))*math.sin(theta_cm)*math.exp(-par[1]*(abs(tt)))
    ...
    def sig_TT(*par):
        if inp_model == "sigTT":
            ...
            try:
                ...
                f=(-par[0]/(1+math.log(qq)))*(math.sin(theta_cm)**2)*math.exp(-par[1]*(abs(tt)))                
