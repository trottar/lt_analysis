...
# Description:
# ================================================================
# Time-stamp: "2024-07-24 14:32:54 trottar"
# ================================================================
#
...
def fun_Sig_L(x, par):
    ...
    try:
        ...
        f=(par[0]*Qdep_L*f_tt)*math.exp(-par[1]*(abs(tt)/qq))
...
def fun_Sig_LT(x, par):
    ...
    try:
        ...
        f=(par[0]/(1+qq))*math.exp(-par[1]*(abs(tt)/qq))
