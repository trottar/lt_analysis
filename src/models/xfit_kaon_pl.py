...
def fun_Sig_L(g, qq, ww, theta_cm, x, par):
    ...
    print("xfit_kaon_pl.py sigL: theta_cm = {phi_cm}, theta_cm = {phi_cm}")
...
def fun_Sig_T(g, qq, ww, theta_cm, x, par):
    ...
    par1, par2, par3, par4 = [par[i] if i < len(par) else 0.0 for i in range(4)]
    # Convert degrees to radians
    print("xfit_kaon_pl.py sigT: theta_cm = {phi_cm}, theta_cm = {phi_cm}")
    theta_cm = theta_cm * math.pi/180    
    # Calculate SigT
...
def fun_Sig_LT(g, qq, ww, theta_cm, x, par):
    ...
    # Convert degrees to radians
    print("xfit_kaon_pl.py sigLT: theta_cm = {phi_cm}, theta_cm = {phi_cm}")
    theta_cm = theta_cm * math.pi/180
    # Calculate SigLT
...
def fun_Sig_TT(g, qq, ww, theta_cm, x, par):
    ...
    # Convert degrees to radians
    print("xfit_kaon_pl.py sigTT: theta_cm = {phi_cm}, theta_cm = {phi_cm}")
    theta_cm = theta_cm * math.pi/180    
    # Calculate SigTT
