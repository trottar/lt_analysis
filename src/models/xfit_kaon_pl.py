...
# Description:
# ================================================================
# Time-stamp: "2024-12-16 03:11:49 trottar"
# ================================================================
#
...
def fun_Sig_L(g, qq, ww, x, par):
    ...
    # Calculate SigL
    return fun_Sig_L_optimized(q2_set, w_set, qq, ww, tt, par1, par2, par3, par4) / 1e3
...
def fun_Sig_T(g, qq, ww, x, par):
    ...
    # Calculate SigT
    return fun_Sig_T_optimized(q2_set, w_set, qq, ww, tt, par5, par6, par7, par8) / 1e3
...
def fun_Sig_LT(g, qq, ww, theta_cm, x, par):
    ...
    # Calculate SigLT
    return fun_Sig_LT_optimized(q2_set, w_set, qq, ww, tt, theta_cm, par9, par10, par11, par12) / 1e3
...
def fun_Sig_TT(g, qq, ww, theta_cm, x, par):
    ...
    theta_cm = theta_cm * math.pi/180    
    # Calculate SigTT
    return fun_Sig_TT_optimized(q2_set, w_set, qq, ww, tt, theta_cm, par13, par14, par15, par16) / 1e3
