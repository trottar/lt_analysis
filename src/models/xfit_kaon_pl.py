...
# Description:
# ================================================================
# Time-stamp: "2024-12-16 10:56:49 trottar"
# ================================================================
#
...
def fun_Sig_L(g, qq, ww, x, par):
    ...
    # Calculate SigL
    return 1e5 * fun_Sig_L_optimized(q2_set, w_set, qq, ww, tt, par1, par2, par3, par4)
...
def fun_Sig_T(g, qq, ww, x, par):
    ...
    # Calculate SigT
    return 1e5 * fun_Sig_T_optimized(q2_set, w_set, qq, ww, tt, par5, par6, par7, par8)
...
def fun_Sig_LT(g, qq, ww, theta_cm, x, par):
    ...
    # Calculate SigLT
    return 1e5 * fun_Sig_LT_optimized(q2_set, w_set, qq, ww, tt, theta_cm, par9, par10, par11, par12)
...
def fun_Sig_TT(g, qq, ww, theta_cm, x, par):
    ...
    theta_cm = theta_cm * math.pi/180    
    # Calculate SigTT
    return 1e5 * fun_Sig_TT_optimized(q2_set, w_set, qq, ww, tt, theta_cm, par13, par14, par15, par16)
