...
# Description:
# ================================================================
# Time-stamp: "2024-02-05 21:52:10 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range):
    ...
    f_sigL_xproj = ROOT.TF12("f_sigL_xproj",f_sigL_pre,2.115,"z")
    ...
    for i in range(len(w_vec)):
        ...
        siglt_X_fit = g_siglt.GetY()[i] / (g_vec[i]/2/PI/1e6)
        siglt_X_fit_err = g_siglt.GetEY()[i] / (g_vec[i]/2/PI/1e6)
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X_fit = g_sigtt.GetY()[i] / (g_vec[i]/2/PI/1e6)
        sigtt_X_fit_err = g_sigtt.GetEY()[i] / (g_vec[i]/2/PI/1e6)
