...
# Description:
# ================================================================
# Time-stamp: "2024-04-05 23:23:46 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range, Q2min_range, Q2max_range):
    ...
    if t0 != 0.0:
        ...
        f_sigT_pre.SetParLimits(0, -par_limit, par_limit)       
    if t1 != 0.0:
        f_sigT_pre.SetParLimits(1, t1-abs(t1*par_lim), t1+abs(t1*par_lim))
    else: 
        f_sigT_pre.SetParLimits(1, -par_limit, par_limit)
    ...
    if t0 != 0.0:
        ...
        f_sigT.SetParLimits(0, -par_limit, par_limit)       
    if t1 != 0.0:
        f_sigT.SetParLimits(1, t1-abs(t1*par_lim), t1+abs(t1*par_lim))
    else: 
        f_sigT.SetParLimits(1, -par_limit, par_limit)
    # Fixing sigT terms for testing
    ...
    if lt0 != 0.0:
        ...
        f_sigLT_pre.SetParLimits(0, -par_limit, par_limit)       
    if lt1 != 0.0:
        f_sigLT_pre.SetParLimits(1, lt1-abs(lt1*par_lim), lt1+abs(lt1*par_lim))
    else: 
        f_sigLT_pre.SetParLimits(1, -par_limit, par_limit)       
    if lt2 != 0.0:
        f_sigLT_pre.SetParLimits(2, lt2-abs(lt2*par_lim), lt2+abs(lt2*par_lim))
    else: 
        f_sigLT_pre.SetParLimits(2, -par_limit, par_limit)
    ...
    if lt0 != 0.0:
        ...
        f_sigLT.SetParLimits(0, -par_limit, par_limit)       
    if lt1 != 0.0:
        f_sigLT.SetParLimits(1, lt1-abs(lt1*par_lim), lt1+abs(lt1*par_lim))
    else: 
        f_sigLT.SetParLimits(1, -par_limit, par_limit)       
    if lt2 != 0.0:
        f_sigLT.SetParLimits(2, lt2-abs(lt2*par_lim), lt2+abs(lt2*par_lim))
    else: 
        f_sigLT.SetParLimits(2, -par_limit, par_limit)
    ...
    if tt0 != 0.0:
        ...
        f_sigTT_pre.SetParLimits(0, -par_limit, par_limit)
    ...
    if tt0 != 0.0:
        ...
        f_sigTT.SetParLimits(0, -par_limit, par_limit)
