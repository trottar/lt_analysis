...
# Description:
# ================================================================
# Time-stamp: "2024-06-27 18:38:26 trottar"
# ================================================================
#
...
def x_fit_in_t(ParticleType, pol_str, closest_date, Q2, W, inpDict):
    ...
    single_setting(ParticleType, pol_str, closest_date, Q2, W, tmin_range, tmax_range, Q2min_range, Q2max_range, iter_num, par_lim, max_iterations)
    
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range, Q2min_range, Q2max_range, iter_num, par_lim, max_iterations):
    ...
    while iteration < max_iterations:
        ...
        try:
            ...
            if l2 != 0.0:
                ...
                f_sigL_pre.SetParLimits(2, -par_lim_sigl_2, par_lim_sig_2)
            ...
            f_sigL_status_message = "Fit Successful" if f_sigL_status.IsValid() else "Fit Failed"
    ...
    while iteration < max_iterations:
        ...
        try:
            ...
            f_sigT_status_message = "Fit Successful" if f_sigT_status.IsValid() else "Fit Failed"
    ...
    while iteration < max_iterations:
        ...
        try:
            ...
            f_sigLT_status_message = "Fit Successful" if f_sigLT_status.IsValid() else "Fit Failed"
    ...
    while iteration < max_iterations:    
        ...
        try:
            ...
            f_sigTT_status_message = "Fit Successful" if f_sigTT_status.IsValid() else "Fit Failed"
