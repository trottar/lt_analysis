...
# Description:
# ================================================================
# Time-stamp: "2024-02-05 20:32:20 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range):
    ...
    for i in range(len(w_vec)):
        ...
        sigl_X_pre = (f_sigL_pre.Eval(g_sigl.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        sigl_X = (f_sigL.Eval(g_sigl.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        sigt_X_pre = (f_sigT_pre.Eval(g_sigt.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        sigt_X = (f_sigT.Eval(g_sigt.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        siglt_X_pre = (f_sigLT_pre.Eval(g_siglt.GetX()[i], q2_vec[i]) * math.sin(th_vec[i] * PI / 180)) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        siglt_X = (f_sigLT.Eval(g_siglt.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X_pre = (f_sigTT_pre.Eval(g_sigtt.GetX()[i], q2_vec[i]) * math.sin(th_vec[i] * PI / 180)**2) * g_vec[i]/2/PI/1e5
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X = (f_sigTT.Eval(g_sigtt.GetX()[i], q2_vec[i])) * g_vec[i]/2/PI/1e5
