...
# Description:
# ================================================================
# Time-stamp: "2024-06-22 17:13:22 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range, Q2min_range, Q2max_range, par_lim):
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X_fit = g_sigtt.GetY()[i] / ((math.sin(th_vec[i] * PI / 180)**2) * (g_vec[i]))
        sigtt_X_fit_err = g_sigtt.GetEY()[i] / ((math.sin(th_vec[i] * PI / 180)**2) * (g_vec[i]))
