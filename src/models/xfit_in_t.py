...
# Description:
# ================================================================
# Time-stamp: "2023-12-29 00:35:18 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set):
    ...
    nlo.Draw("t:t_min", "", "goff")
    t_tmin_map = TGraph(nlo.GetSelectedRows(), nlo.GetV1(), nlo.GetV2())
    ...
    nlo.Draw("sigt:t:sigt_e", "", "goff")
    g_sigt = TGraphErrors(nlo.GetSelectedRows(), nlo.GetV2(), nlo.GetV1(), [0] * nlo.GetSelectedRows(), nlo.GetV3())
    ...
    nlo.Draw("sigl:t:sigl_e", "", "goff")

    f_sigL_pre = TF1("sig_L", fun_Sig_L, 0, 0.5, 2)
    f_sigL_pre.SetParameters(l0, l1)
    
    g_sigl = TGraphErrors(nlo.GetSelectedRows(), nlo.GetV2(), nlo.GetV1(), 0, nlo.GetV3())
    ...
    nlo.Draw("siglt:t:siglt_e", "", "goff")

    f_sigLT_pre = TF1("sig_LT", fun_Sig_LT, 0, 0.5, 2)
    f_sigLT_pre.SetParameters(lt0, lt1)
    
    g_siglt = TGraphErrors(nlo.GetSelectedRows(), nlo.GetV2(), nlo.GetV1(), ROOT.nullptr, nlo.GetV3())
    ...
    nlo.Draw("sigtt:t:sigtt_e", "", "goff")
    
    f_sigTT_pre = TF1("sig_TT", fun_Sig_TT, 0, 0.5, 2)
    f_sigTT_pre.SetParameters(tt0, tt1)
    
    g_sigtt = TGraphErrors(nlo.GetSelectedRows(), nlo.GetV2(), nlo.GetV1(), [0]*nlo.GetSelectedRows(), nlo.GetV3())
    ...
    for i in range(len(w_vec)):
        ...
        g_sigtt_prv.SetPoint(i, nlo.GetV2()[i], sigtt_X_pre)
