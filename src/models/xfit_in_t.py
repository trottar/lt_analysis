...
# Description:
# ================================================================
# Time-stamp: "2024-03-10 05:59:30 trottar"
# ================================================================
#
...
def single_setting(ParticleType, pol_str, dir_iter, q2_set, w_set, tmin_range, tmax_range, Q2min_range, Q2max_range):
    ...
    for i in range(len(w_vec)):
        ...
        f_sigL_xproj = ROOT.TF12("f_sigL_xproj","f_sigL/(g_vec[i])",q2_vec[i],"x")
    ...
    if t0 != 0.0:
        ...
        f_sigT_pre.SetParLimits(0, -0.001, 0.001)       
    if t1 != 0.0:
    ...
    for i in range(len(w_vec)):
        ...
        sigt_X_pre = (f_sigT_pre.Eval(g_sigt.GetX()[i], q2_vec[i]))
    ...
    if t0 != 0.0:
        ...
        f_sigT.SetParLimits(0, -0.001, 0.001)       
    if t1 != 0.0:
    ...
    for i in range(len(w_vec)):
        ...
        siglt_X = (f_sigLT.Eval(g_siglt.GetX()[i], q2_vec[i]) * math.sin(th_vec[i] * PI / 180))
    ...
    if tt0 != 0.0:
        ...
        f_sigTT_pre.SetParLimits(0, -0.001, 0.001)       
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X_pre = (f_sigTT_pre.Eval(g_sigtt.GetX()[i], q2_vec[i]) * math.sin(th_vec[i] * PI / 180)**2)
    ...
    if tt0 != 0.0:
        ...
        f_sigTT.SetParLimits(0, -0.001, 0.001)       
    ...
    for i in range(len(w_vec)):
        ...
        sigtt_X = (f_sigTT.Eval(g_sigtt.GetX()[i], q2_vec[i]) * math.sin(th_vec[i] * PI / 180)**2)
