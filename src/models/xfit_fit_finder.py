...
# Description:
# ================================================================
# Time-stamp: "2024-11-18 01:05:32 trottar"
# ================================================================
#
...
def find_fit(inpDict, par_vec, par_err_vec, par_chi2_vec):
    ...
    t_center_val = get_central_value(t_vec)
    q2_center_val = get_central_value(q2_vec)
    w_center_val = get_central_value(w_vec)
    th_center_val = get_central_value(th_vec)
    #g_center_val = g_vec[1]
    #t_center_val = t_vec[1]
    #q2_center_val = q2_vec[1]
    #w_center_val = w_vec[1]
    #th_center_val = th_vec[1]
    print(f"\n\nDetermining best fit off the bin values...\n t={t_center_val:.3f}, Q2={q2_center_val:.3f}, W={w_center_val:.3f}, theta={th_center_val:.3f}")
            ...
            for start in range(num_optimizations):
                ...
                while iteration <= max_iterations:
                    ...
                    try:
                        ...
                        max_param_bounds = max_param_bounds - (0.10 * max_param_bounds)
                        iteration += 1
                        total_iteration += 1 if iteration % max_iterations == 0 else 0                
