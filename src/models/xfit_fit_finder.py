...
# Description:
# ================================================================
# Time-stamp: "2024-10-11 21:02:21 trottar"
# ================================================================
#
...
def find_fit(sig_fit_dict, inp_dict, par_vec, par_err_vec, par_chi2_vec):
    ...
    for it, (key, val) in enumerate(sig_fit_dict.items()):
        ...
        if num_events > num_params:
            print(f"\n\nWARNING: The number of parameters ({num_params}) for Sig {sig_name} is greater than or equal to the number of data points ({num_events})! Using alternative methods for finding quality of fit...")
