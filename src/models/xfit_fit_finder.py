...
# Description:
# ================================================================
# Time-stamp: "2024-11-06 10:01:25 trottar"
# ================================================================
#
                    ...
                    while iteration <= max_iterations:
                        ...
                        try:
                            ...
                            if sig_name == "L":
                                ...
                                f_sig = TF1(f"sig_{sig_name}", fun_Sig_LT, -100.0, 100.0, num_params)
                            elif sig_name == "TT":
                                ...
                                f_sig = TF1(f"sig_{sig_name}", fun_Sig_TT, -100.0, 100.0, num_params)
