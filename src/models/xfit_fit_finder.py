...
# Description:
# ================================================================
# Time-stamp: "2024-10-25 09:23:43 trottar"
# ================================================================
#
...
def find_fit(inpDict, par_vec, par_err_vec, par_chi2_vec):
    ...
    for it, (key, val) in enumerate(fit_params.items()):
        ...
        if num_params == 1:
                ...
                for b in range(len(w_vec)):
                    ...
                    while iteration <= max_iterations:
                        ...
                        try:
                            ...
                            if sig_name == "L":
                                fun_Sig = fun_Sig_L_wrapper(g_vec[b], q2_vec[b], w_vec[b])
                            elif sig_name == "T":
                                fun_Sig = fun_Sig_T_wrapper(g_vec[b], q2_vec[b], w_vec[b])
                            elif sig_name == "LT":
            ...
            if sig_name == "L":
                fun_Sig = fun_Sig_L_wrapper(g_vec[best_overall_bin], q2_vec[best_overall_bin], w_vec[best_overall_bin])
            elif sig_name == "T":
                fun_Sig = fun_Sig_T_wrapper(g_vec[best_overall_bin], q2_vec[best_overall_bin], w_vec[best_overall_bin])
            elif sig_name == "LT":
