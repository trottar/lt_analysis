...
# Description:
# ================================================================
# Time-stamp: "2025-01-19 23:42:43 trottar"
# ================================================================
#
    ...
    for it, (key, val) in enumerate(fit_params.items()):
        ...
        if key not in fixed_params:
            ...
            if num_params == 1:
                ...
                graph_sig_p0 = TGraph(1)
                graph_sig_chi2 = TGraph(1)
                graph_sig_temp = TGraph(1)
                graph_sig_accept = TGraph(1)
                graph_sig_residuals = TGraph(1)
                graph_sig_aic = TGraph(1)
                graph_sig_bic = TGraph(1)
                graph_sig_p0.SetPoint(0, 0.0, 0.0)
                graph_sig_chi2.SetPoint(0, 0.0, 0.0)
                graph_sig_temp.SetPoint(0, 0.0, 0.0)
                graph_sig_accept.SetPoint(0, 0.0, 0.0)
                graph_sig_residuals.SetPoint(0, 0.0, 0.0)
                graph_sig_aic.SetPoint(0, 0.0, 0.0)
                graph_sig_bic.SetPoint(0, 0.0, 0.0)                
                ...
                graph_sig_bic = TGraph(1)
                graph_sig_p0.SetPoint(0, 0.0, 0.0)
                graph_sig_p1.SetPoint(0, 0.0, 0.0)
                graph_sig_chi2.SetPoint(0, 0.0, 0.0)
                graph_sig_temp.SetPoint(0, 0.0, 0.0)
                graph_sig_accept.SetPoint(0, 0.0, 0.0)
                graph_sig_residuals.SetPoint(0, 0.0, 0.0)
                ...
                graph_sig_p0.SetPoint(0, 0.0, 0.0)
                graph_sig_p1.SetPoint(0, 0.0, 0.0)
                graph_sig_p2.SetPoint(0, 0.0, 0.0)
                graph_sig_chi2.SetPoint(0, 0.0, 0.0)
                graph_sig_temp.SetPoint(0, 0.0, 0.0)
                graph_sig_accept.SetPoint(0, 0.0, 0.0)
                graph_sig_residuals.SetPoint(0, 0.0, 0.0)
                ...
                graph_sig_p1.SetPoint(0, 0.0, 0.0)
                graph_sig_p2.SetPoint(0, 0.0, 0.0)
                graph_sig_p3.SetPoint(0, 0.0, 0.0)
                graph_sig_chi2.SetPoint(0, 0.0, 0.0)
                graph_sig_temp.SetPoint(0, 0.0, 0.0)
                graph_sig_accept.SetPoint(0, 0.0, 0.0)
                graph_sig_residuals.SetPoint(0, 0.0, 0.0)
