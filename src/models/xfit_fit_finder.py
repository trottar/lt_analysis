...
# Description:
# ================================================================
# Time-stamp: "2024-10-11 05:21:15 trottar"
# ================================================================
#
...
def find_fit(sig_fit_dict, inp_dict, par_vec, par_err_vec, par_chi2_vec):
    ...
    for it, (key, val) in enumerate(sig_fit_dict.items()):
        ...
        if (num_events - num_params) <= 0.0:            
            print(f"WARNING: The number of parameters ({num_params}) for Sig {sig_name} is greater than or equal to the number of data points ({num_events})! Fitting one parameter at a time...")
            ...
            # Remove used parameter, but keep track of unused for further iterations
            original_params = val["params"].copy()
            original_params.remove(initial_params[0])
            num_params = len(initial_params)
