...
# Description:
# ================================================================
# Time-stamp: "2024-07-24 03:23:56 trottar"
# ================================================================
#
...
def iterWeight(arg_str):
    ...
    try:
        ...
        sigl=(p1*Qdep_L*ft)*math.exp(-p2*(abs(t_gev)*(q2_gev)))
    ...
    try:
        ...
        sigt=p5*(ft)*math.exp(-p6*(abs(t_gev)))*(Qdep_T**p7)
    ...
    try:
        ...
        siglt=(p9/(1+q2_gev))*math.sin(thetacm_sim)*ft*math.exp(-p10*(q2_gev))
