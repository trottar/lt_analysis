...
# Description:
# ================================================================
# Time-stamp: "2024-02-11 15:19:57 trottar"
# ================================================================
#
...
def create_lists(aveDict, yieldDict, histlist, inpDict, phisetlist, output_file_lst):
    ...
    if float(runNumCenter[0]) != 0:        
        ...
        print("$$$$$$$$$$$$$center",yield_data_center, yield_data_err_center, tbin_center, phibin_center)
        print("$$$$$$$$$$$$$left",yield_data_left, yield_data_err_left, tbin_left, phibin_left)
        print("!!!!!!!!!!!!!center",yield_simc_center, yield_simc_err_center, tbin_center, phibin_center)
        print("!!!!!!!!!!!!!left",yield_simc_left, yield_simc_err_left, tbin_left, phibin_left)
