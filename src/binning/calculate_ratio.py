...
# Description:
# ================================================================
# Time-stamp: "2024-02-10 17:28:03 trottar"
# ================================================================
#
...
def calculate_ratio(kin_type, phiset, yieldDict):
    ...
    for data_key_tuple,simc_key_tuple in zip(data_key_tuples,simc_key_tuples):
        ...
        yield_err_data = data_nested_dict[kin_type][data_key_tuple]["{}_err".format(kin_type)][1]
        yield_err_simc = simc_nested_dict[kin_type][simc_key_tuple]["{}_err".format(kin_type)][1]        
