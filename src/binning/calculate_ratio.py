...
# Description:
# ================================================================
# Time-stamp: "2024-03-14 11:13:38 trottar"
# ================================================================
#
...
def calculate_ratio(kin_type, phiset, yieldDict):
    ...
    for data_key_tuple,simc_key_tuple in zip(data_key_tuples,simc_key_tuples):
        ...
        try:
            ...
            # Matching formatting from average_ratio.f
            ratio_err = (yield_err_data/yield_simc)**2
            ratio_err += ((ratio/yield_simc)**2)*(yield_err_simc**2)
