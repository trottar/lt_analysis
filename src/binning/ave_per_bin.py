...
# Description:
# ================================================================
# Time-stamp: "2024-02-26 13:44:28 trottar"
# ================================================================
#
...
def process_hist_data(tree_data, tree_dummy, t_bins, nWindows, inpDict):
    ...
    for i,evt in enumerate(TBRANCH_DATA):
        ...
        Diamond = (evt.W/evt.Q2>a1+b1/evt.Q2) & (evt.W/evt.Q2<a2+b2/evt.Q2) & (evt.W/evt.Q2>a3+b3/evt.Q2) & (evt.W/evt.Q2<a4+b4/evt.Q2) & (1.10<evt.MM) & (evt.MM<1.18)
...
def process_hist_simc(tree_simc, t_bins, inpDict, iteration):
    ...
    for i,evt in enumerate(TBRANCH_SIMC):
        ...
        Diamond = (evt.W/evt.Q2>a1+b1/evt.Q2) & (evt.W/evt.Q2<a2+b2/evt.Q2) & (evt.W/evt.Q2>a3+b3/evt.Q2) & (evt.W/evt.Q2<a4+b4/evt.Q2) & (1.10<evt.missmass) & (evt.missmass<1.18)
