...
# Description:
# ================================================================
# Time-stamp: "2024-02-12 04:20:26 trottar"
# ================================================================
#
...
def process_hist_data(tree_data, tree_dummy, t_bins, nWindows, inpDict):
    ...
    for j in range(len(t_bins)-1):
        ...
        for i,evt in enumerate(TBRANCH_DATA):
            ...
            Diamond = (evt.W/evt.Q2>a1+b1/evt.Q2) & (evt.W/evt.Q2<a2+b2/evt.Q2) & (evt.W/evt.Q2>a3+b3/evt.Q2) & (evt.W/evt.Q2<a4+b4/evt.Q2) & (evt.P_aero_npeSum > 4.5)
        ...
        processed_dict["t_bin{}".format(j+1)] = {
            ...
            "H_Q2_DUMMY" : H_Q2_DUMMY,
            "H_W_DUMMY" : H_W_DUMMY,
            "H_t_DUMMY" : H_t_DUMMY,
            "H_epsilon_DUMMY" : H_epsilon_DUMMY,            
        }
