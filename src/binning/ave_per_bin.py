...
# Description:
# ================================================================
# Time-stamp: "2024-03-28 14:36:20 trottar"
# ================================================================
#
...
def process_hist_data(tree_data, tree_dummy, t_bins, nWindows, phi_setting, inpDict):
    ...
    for j in range(len(t_bins)-1):
        ...
        # Pion subtraction by scaling simc to peak size
        if ParticleType == "kaon":
            particle_subtraction_ave(t_bins, subDict, inpDict, SubtractedParticle, hist_bin_dict["H_MM_DATA_{}".format(j)].Integral(H_MM_DATA.FindBin(0.88), H_MM_DATA.FindBin(0.93)), hgcer_cutg)
