...
# Description:
# ================================================================
# Time-stamp: "2023-08-24 21:51:07 trottar"
# ================================================================
#
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        for edge, val in data_nested_dict["Q2"][(i,j)]["Q2_arr"]:
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        j = simc_key_tuple[1] # phi bin    
        # Fill histogram
        for edge, val in simc_nested_dict["Q2"][(i,j)]["Q2_arr"]:
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        j = data_key_tuple[1] # phi bin    
        # Fill histogram
        for edge, val in data_nested_dict["W"][(i,j)]["W_arr"]:
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        j = simc_key_tuple[1] # phi bin    
        # Fill histogram
        for edge, val in simc_nested_dict["W"][(i,j)]["W_arr"]:
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        j = data_key_tuple[1] # phi bin
        # Fill histogram
        for edge, val in data_nested_dict["t"][(i,j)]["t_arr"]:
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        j = simc_key_tuple[1] # phi bin    
        # Fill histogram
        for edge, val in simc_nested_dict["t"][(i,j)]["t_arr"]:
