...
# Description:
# ================================================================
# Time-stamp: "2023-08-25 00:25:38 trottar"
# ================================================================
#
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        histbinDict["H_Q2_tbin_DATA_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        histbinDict["H_Q2_tbin_SIMC_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        histbinDict["H_W_tbin_DATA_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        histbinDict["H_W_tbin_SIMC_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, data_key_tuple in enumerate(data_key_tuples):
        ...
        histbinDict["H_t_tbin_DATA_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    for k, simc_key_tuple in enumerate(simc_key_tuples):
        ...
        histbinDict["H_t_tbin_SIMC_{}_{}_{}".format(phiset,str(i+1),str(j+1))].Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    H_tbins_DATA.Draw("same, E1, hist")
...
for it,phiset in enumerate(phisetlist):
    ...
    H_phibins_DATA.Draw("same, E1, hist")
