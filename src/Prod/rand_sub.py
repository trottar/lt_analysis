...
def rand_sub(phi_setting, inpDict):    
    ...
    H_Q2_DATA       = ROOT.TH1D("H_Q2_DATA","Q2", 1000, inpDict["Q2min"], inpDict["Q2max"])
    H_W_DATA  = ROOT.TH1D("H_W_DATA","W ", 1000, inpDict["Wmin"], inpDict["Wmax"])
    H_t_DATA       = ROOT.TH1D("H_t_DATA","-t", 1000, inpDict["tmin"], inpDict["tmax"])
    ...
    H_ct_DATA = ROOT.TH1D("H_ct_DATA", "Electron-{} CTime".format(ParticleType.capitalize()), 1000, -10, 10)
    ...
    H_Q2_DUMMY       = ROOT.TH1D("H_Q2_DUMMY","Q2", 1000, inpDict["Q2min"], inpDict["Q2max"])
    H_W_DUMMY  = ROOT.TH1D("H_W_DUMMY","W ", 1000, inpDict["Wmin"], inpDict["Wmax"])
    H_t_DUMMY       = ROOT.TH1D("H_t_DUMMY","-t", 1000, inpDict["tmin"], inpDict["tmax"])  
    ...
    H_ct_DUMMY = ROOT.TH1D("H_ct_DUMMY", "Electron-{} CTime".format(ParticleType.capitalize()), 1000, -10, 10)
    ...
    H_Q2_RAND       = ROOT.TH1D("H_Q2_RAND","Q2", 1000, inpDict["Q2min"], inpDict["Q2max"])
    H_W_RAND  = ROOT.TH1D("H_W_RAND","W ", 1000, inpDict["Wmin"], inpDict["Wmax"])
    H_t_RAND       = ROOT.TH1D("H_t_RAND","-t", 1000, inpDict["tmin"], inpDict["tmax"])
    ...
    H_ct_RAND = ROOT.TH1D("H_ct_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 1000, -10, 10)
    ...
    H_Q2_DUMMY_RAND       = ROOT.TH1D("H_Q2_DUMMY_RAND","Q2", 1000, inpDict["Q2min"], inpDict["Q2max"])
    H_W_DUMMY_RAND  = ROOT.TH1D("H_W_DUMMY_RAND","W ", 1000, inpDict["Wmin"], inpDict["Wmax"])
    H_t_DUMMY_RAND       = ROOT.TH1D("H_t_DUMMY_RAND","-t", 1000, inpDict["tmin"], inpDict["tmax"])
    ...
    H_ct_DUMMY_RAND = ROOT.TH1D("H_ct_DUMMY_RAND", "Electron-{} CTime".format(ParticleType.capitalize()), 1000, -10, 10)
    ...
    Q2_vs_W_DATA = ROOT.TH2D("Q2_vs_W_DATA", "Q^{2} vs W; Q^{2}; W", 1000, inpDict["Q2min"], inpDict["Q2max"], 1000, inpDict["Wmin"], inpDict["Wmax"])
