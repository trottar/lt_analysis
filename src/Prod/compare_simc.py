...
# Description:
# ================================================================
# Time-stamp: "2023-08-04 14:55:16 trottar"
# ================================================================
#
...
def compare_simc(hist, inpDict):
    ...
    H_Q2_SIMC       = ROOT.TH1D("H_Q2_SIMC","Q2", 1000, inpDict["Q2min"], inpDict["Q2max"])
    H_W_SIMC  = ROOT.TH1D("H_W_SIMC","W ", 1000, inpDict["Wmin"], inpDict["Wmax"])
    H_t_SIMC       = ROOT.TH1D("H_t_SIMC","-t", 1000, inpDict["tmin"], inpDict["tmax"])  
