...
def DiamondPlot(ParticleType, Q2Val, Q2min, Q2max, WVal, Wmin, Wmax, phi_setting, tmin, tmax, inpDict):
    ...
    if (highe_input !=False):
        #print("test high")
        Q2vsW_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
        Q2vsW_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)
        Q2vsW_cut.Draw("col")
        ex1.Draw()
        Q2vsW_cut.Draw("col same")
        if (mide_input !=False):
            #print("test high mid")
            Q2vsW_mide_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
            Q2vsW_mide_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)
            ex2.Draw()
            Q2vsW_mide_cut.Draw("col same")
            pages = 3
            if (lowe_input !=False):
                #print("test high mid low")
                Q2vsW_lowe_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
                Q2vsW_lowe_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)                
                ex3.Draw()
    ...
    if (highe_input != False):
        ...
        Q2vsW_hi_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
        Q2vsW_hi_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)
    ...
    if (mide_input != False):
        ...
        Q2vsW_mi_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
        Q2vsW_mi_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)        
    ...
    if (lowe_input != False):
        ...
        Q2vsW_lo_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
        Q2vsW_lo_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)        
        ...
        Q2vsW_lolo_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
        Q2vsW_lolo_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)        
        ...
        if (mide_input != False):
            ...
            Q2vsW_milo_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
            Q2vsW_milo_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)            
        ...
        if (highe_input != False):
            ...
            Q2vsW_hilo_cut.GetXaxis().SetRangeUser(Q2min-Q2min*2.0, Q2max+Q2max*2.0)
            Q2vsW_hilo_cut.GetYaxis().SetRangeUser(Wmin-Wmin*2.0, Wmax+Wmax*2.0)
