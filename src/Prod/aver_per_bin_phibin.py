...
# Description:
# ================================================================
# Time-stamp: "2023-08-13 20:14:30 trottar"
# ================================================================
#
...
def calculate_aver_data(kin_type, hist_data, hist_dummy, phi_data, phi_bins, t_bins, eff_charge, EPSSET, Q2, W, ParticleType):
    ...
    for data, dummy in zip(binned_hist_data, binned_hist_dummy):
        ...
        if sub_val.size != 0:
            ...
            data_for_csv.append([kin_type, phi_bins[i], total_count, yield_val, EPSSET])  # Replace 'EPSSET' with the actual value
    ...
    with open(csv_filename, 'a', newline='') as file:
        ...
        if not file_exists:
            writer.writerow(['kin_value', 'total_count', 'yield_val', 'EPSSET'])
