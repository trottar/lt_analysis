...
class ParticleStageTBinPionParentTests(unittest.TestCase):
    ...
    def test_rand_sub_builds_only_after_committed_proton_cleaning(self):
        ...
        self.assertIn("kaon_data_coordinate_summary", self.main_source)
        self.assertIn("coordinate_contract=coordinate_contract", self.rand_source)
        self.assertIn("coordinate_fingerprint", self.rand_source)
        self.assertIn("pion_control_coordinate_fingerprint", self.parent_source)
