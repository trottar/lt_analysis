...
# Description:
# ================================================================
# Time-stamp: "2023-02-10 13:31:01 trottar"
# ================================================================
#
...
H_pmiss_DATA  = ROOT.TH1D("H_pmiss_DATA","pmiss", 200, -0.5, 0.5)
H_pmiss_DATA_nocut  = ROOT.TH1D("H_pmiss_DATA_nocut","pmiss", 200, -0.5, 0.5)
H_pmiss_DATA_nopid  = ROOT.TH1D("H_pmiss_DATA_nopid","pmiss", 200, -0.5, 0.5)
#H_pmiss_DATA_rand  = ROOT.TH1D("H_pmiss_DATA_rand","pmiss", 200, -0.5, 0.5)
H_pmiss_DUMMY  = ROOT.TH1D("H_pmiss_DUMMY","pmiss", 200, -0.5, 0.5)
H_pmiss_DUMMY_nocut  = ROOT.TH1D("H_pmiss_DUMMY_nocut","pmiss", 200, -0.5, 0.5)
H_pmiss_DUMMY_nopid  = ROOT.TH1D("H_pmiss_DUMMY_nopid","pmiss", 200, -0.5, 0.5)
#H_pmiss_DUMMY_rand  = ROOT.TH1D("H_pmiss_DUMMY_rand","pmiss", 200, -0.5, 0.5)
H_pmiss_SIMC  = ROOT.TH1D("H_pmiss_SIMC","pmiss", 200, -0.5, 0.5)

H_emiss_DATA  = ROOT.TH1D("H_emiss_DATA","emiss", 200, -0.5, 0.5)
H_emiss_DATA_nocut  = ROOT.TH1D("H_emiss_DATA_nocut","emiss", 200, -0.5, 0.5)
H_emiss_DATA_nopid  = ROOT.TH1D("H_emiss_DATA_nopid","emiss", 200, -0.5, 0.5)
#H_emiss_DATA_rand  = ROOT.TH1D("H_emiss_DATA_rand","emiss", 200, -0.5, 0.5)
H_emiss_DUMMY  = ROOT.TH1D("H_emiss_DUMMY","emiss", 200, -0.5, 0.5)
H_emiss_DUMMY_nocut  = ROOT.TH1D("H_emiss_DUMMY_nocut","emiss", 200, -0.5, 0.5)
H_emiss_DUMMY_nopid  = ROOT.TH1D("H_emiss_DUMMY_nopid","emiss", 200, -0.5, 0.5)
#H_emiss_DUMMY_rand  = ROOT.TH1D("H_emiss_DUMMY_rand","emiss", 200, -0.5, 0.5)
H_emiss_SIMC  = ROOT.TH1D("H_emiss_SIMC","emiss", 200, -0.5, 0.5)

H_pmx_DATA  = ROOT.TH1D("H_pmx_DATA","pmx", 200, -0.5, 0.5)
H_pmx_DATA_nocut  = ROOT.TH1D("H_pmx_DATA_nocut","pmx", 200, -0.5, 0.5)
H_pmx_DATA_nopid  = ROOT.TH1D("H_pmx_DATA_nopid","pmx", 200, -0.5, 0.5)
#H_pmx_DATA_rand  = ROOT.TH1D("H_pmx_DATA_rand","pmx", 200, -0.5, 0.5)
H_pmx_DUMMY  = ROOT.TH1D("H_pmx_DUMMY","pmx", 200, -0.5, 0.5)
H_pmx_DUMMY_nocut  = ROOT.TH1D("H_pmx_DUMMY_nocut","pmx", 200, -0.5, 0.5)
H_pmx_DUMMY_nopid  = ROOT.TH1D("H_pmx_DUMMY_nopid","pmx", 200, -0.5, 0.5)
#H_pmx_DUMMY_rand  = ROOT.TH1D("H_pmx_DUMMY_rand","pmx", 200, -0.5, 0.5)
H_pmx_SIMC  = ROOT.TH1D("H_pmx_SIMC","pmx", 200, -0.5, 0.5)

H_pmy_DATA  = ROOT.TH1D("H_pmy_DATA","pmy ", 200, -0.5, 0.5)
H_pmy_DATA_nocut  = ROOT.TH1D("H_pmy_DATA_nocut","pmy ", 200, -0.5, 0.5)
H_pmy_DATA_nopid  = ROOT.TH1D("H_pmy_DATA_nopid","pmy ", 200, -0.5, 0.5)
#H_pmy_DATA_rand  = ROOT.TH1D("H_pmy_DATA_rand","pmy ", 200, -0.5, 0.5)
H_pmy_DUMMY  = ROOT.TH1D("H_pmy_DUMMY","pmy ", 200, -0.5, 0.5)
H_pmy_DUMMY_nocut  = ROOT.TH1D("H_pmy_DUMMY_nocut","pmy ", 200, -0.5, 0.5)
H_pmy_DUMMY_nopid  = ROOT.TH1D("H_pmy_DUMMY_nopid","pmy ", 200, -0.5, 0.5)
#H_pmy_DUMMY_rand  = ROOT.TH1D("H_pmy_DUMMY_rand","pmy ", 200, -0.5, 0.5)
H_pmy_SIMC  = ROOT.TH1D("H_pmy_SIMC","pmy", 200, -0.5, 0.5)

H_pmz_DATA  = ROOT.TH1D("H_pmz_DATA","pmz", 200, -0.5, 0.5)
H_pmz_DATA_nocut  = ROOT.TH1D("H_pmz_DATA_nocut","pmz", 200, -0.5, 0.5)
H_pmz_DATA_nopid  = ROOT.TH1D("H_pmz_DATA_nopid","pmz", 200, -0.5, 0.5)
#H_pmz_DATA_rand  = ROOT.TH1D("H_pmz_DATA_rand","pmz", 200, -0.5, 0.5)
H_pmz_DUMMY  = ROOT.TH1D("H_pmz_DUMMY","pmz", 200, -0.5, 0.5)
H_pmz_DUMMY_nocut  = ROOT.TH1D("H_pmz_DUMMY_nocut","pmz", 200, -0.5, 0.5)
H_pmz_DUMMY_nopid  = ROOT.TH1D("H_pmz_DUMMY_nopid","pmz", 200, -0.5, 0.5)
#H_pmz_DUMMY_rand  = ROOT.TH1D("H_pmz_DUMMY_rand","pmz", 200, -0.5, 0.5)
H_pmz_SIMC  = ROOT.TH1D("H_pmz_SIMC","pmz", 200, -0.5, 0.5)
...
for evt in TBRANCH_SIMC:
  ...
  if(HMS_Acceptance & SHMS_Acceptance):
      ...
      H_pmx_SIMC.Fill(evt.Pmx-3.809, evt.Weight)
      H_pmy_SIMC.Fill(evt.Pmy, evt.Weight)
      H_pmz_SIMC.Fill(evt.Pmz+1.866, evt.Weight)
