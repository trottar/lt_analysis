...
l_bpm_tar_x.AddEntry(bpm_tar_x_DATA,"DATA, Mean = {:.3e}".format( b_mean_bpm_tar_x_data))
if DEBUG:
    l_bpm_tar_x.AddEntry(bpm_tar_x_DATA_nocut,"DATA (no cut), Mean = {:.3e}".format( b_mean_bpm_tar_x_data_nocut))
    l_bpm_tar_x.AddEntry(bpm_tar_x_DATA_nopid,"DATA (no PID cut), Mean = {:.3e}".format( b_mean_bpm_tar_x_data_nopid))
...
l_bpm_tar_x.AddEntry(bpm_tar_x_DATA,"DATA, Stddev = {:.3e}".format( b_stddev_bpm_tar_x_data))
if DEBUG:
    l_bpm_tar_x.AddEntry(bpm_tar_x_DATA_nocut,"DATA (no cut), Stddev = {:.3e}".format( b_stddev_bpm_tar_x_data_nocut))
    l_bpm_tar_x.AddEntry(bpm_tar_x_DATA_nopid,"DATA (no PID cut), Stddev = {:.3e}".format( b_stddev_bpm_tar_x_data_nopid))
...
l_bpm_tar_y.AddEntry(bpm_tar_y_DATA,"DATA, Mean = {:.3e}".format( b_mean_bpm_tar_y_data))
if DEBUG:
    l_bpm_tar_y.AddEntry(bpm_tar_y_DATA_nocut,"DATA (no cut), Mean = {:.3e}".format( b_mean_bpm_tar_y_data_nocut))
    l_bpm_tar_y.AddEntry(bpm_tar_y_DATA_nopid,"DATA (no PID cut), Mean = {:.3e}".format( b_mean_bpm_tar_y_data_nopid))
...
l_bpm_tar_y.AddEntry(bpm_tar_y_DATA,"DATA, Stddev = {:.3e}".format( b_stddev_bpm_tar_y_data))
if DEBUG:
    l_bpm_tar_y.AddEntry(bpm_tar_y_DATA_nocut,"DATA (no cut), Stddev = {:.3e}".format( b_stddev_bpm_tar_y_data_nocut))
    l_bpm_tar_y.AddEntry(bpm_tar_y_DATA_nopid,"DATA (no PID cut), Stddev = {:.3e}".format( b_stddev_bpm_tar_y_data_nopid))
...
l_MMp2.AddEntry(H_MMp2_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_MMp2_simc))
l_MMp2.AddEntry(H_MMp2_DATA,"DATA, MEAN = {:.3e}".format(b_mean_MMp2_data))
if DEBUG:
    l_MMp2.AddEntry(H_MMp2_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_MMp2_data_nocut))
    l_MMp2.AddEntry(H_MMp2_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_MMp2_data_nopid))
l_MMp2.AddEntry(H_MMp2_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_MMp2_dummy))
...
l_ph_q.AddEntry(H_ph_q_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_ph_q_simc))
l_ph_q.AddEntry(H_ph_q_DATA,"DATA, MEAN = {:.3e}".format(b_mean_ph_q_data))
if DEBUG:
    l_ph_q.AddEntry(H_ph_q_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_ph_q_data_nocut))
    l_ph_q.AddEntry(H_ph_q_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_ph_q_data_nopid))
l_ph_q.AddEntry(H_ph_q_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_ph_q_dummy))
...
l_th_q.AddEntry(H_th_q_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_th_q_simc))
l_th_q.AddEntry(H_th_q_DATA,"DATA, MEAN = {:.3e}".format(b_mean_th_q_data))
if DEBUG:
    l_th_q.AddEntry(H_th_q_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_th_q_data_nocut))
    l_th_q.AddEntry(H_th_q_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_th_q_data_nopid))
l_th_q.AddEntry(H_th_q_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_th_q_dummy))
...
#l_ph_recoil.AddEntry(H_ph_recoil_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_ph_recoil_simc))
l_ph_recoil.AddEntry(H_ph_recoil_DATA,"DATA, MEAN = {:.3e}".format(b_mean_ph_recoil_data))
if DEBUG:
    l_ph_recoil.AddEntry(H_ph_recoil_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_ph_recoil_data_nocut))
    l_ph_recoil.AddEntry(H_ph_recoil_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_ph_recoil_data_nopid))
l_ph_recoil.AddEntry(H_ph_recoil_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_ph_recoil_dummy))
...
#l_th_recoil.AddEntry(H_th_recoil_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_th_recoil_simc))
l_th_recoil.AddEntry(H_th_recoil_DATA,"DATA, MEAN = {:.3e}".format(b_mean_th_recoil_data))
if DEBUG:
    l_th_recoil.AddEntry(H_th_recoil_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_th_recoil_data_nocut))
    l_th_recoil.AddEntry(H_th_recoil_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_th_recoil_data_nopid))
l_th_recoil.AddEntry(H_th_recoil_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_th_recoil_dummy))
...
l_pmiss.AddEntry(H_pmiss_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_pmiss_simc))
l_pmiss.AddEntry(H_pmiss_DATA,"DATA, MEAN = {:.3e}".format(b_mean_pmiss_data))
if DEBUG:
    l_pmiss.AddEntry(H_pmiss_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_pmiss_data_nocut))
    l_pmiss.AddEntry(H_pmiss_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_pmiss_data_nopid))
l_pmiss.AddEntry(H_pmiss_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_pmiss_dummy))
...
l_emiss.AddEntry(H_emiss_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_emiss_simc))
l_emiss.AddEntry(H_emiss_DATA,"DATA, MEAN = {:.3e}".format(b_mean_emiss_data))
if DEBUG:
    l_emiss.AddEntry(H_emiss_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_emiss_data_nocut))
    l_emiss.AddEntry(H_emiss_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_emiss_data_nopid))
l_emiss.AddEntry(H_emiss_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_emiss_dummy))
...
l_pmx.AddEntry(H_pmx_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_pmx_simc))
l_pmx.AddEntry(H_pmx_DATA,"DATA, MEAN = {:.3e}".format(b_mean_pmx_data))
if DEBUG:
    l_pmx.AddEntry(H_pmx_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_pmx_data_nocut))
    l_pmx.AddEntry(H_pmx_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_pmx_data_nopid))
l_pmx.AddEntry(H_pmx_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_pmx_dummy))
...
l_pmy.AddEntry(H_pmy_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_pmy_simc))
l_pmy.AddEntry(H_pmy_DATA,"DATA, MEAN = {:.3e}".format(b_mean_pmy_data))
if DEBUG:
    l_pmy.AddEntry(H_pmy_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_pmy_data_nocut))
    l_pmy.AddEntry(H_pmy_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_pmy_data_nopid))
l_pmy.AddEntry(H_pmy_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_pmy_dummy))
...
l_pmz.AddEntry(H_pmz_SIMC,"SIMC, MEAN = {:.3e}".format(b_mean_pmz_simc))
l_pmz.AddEntry(H_pmz_DATA,"DATA, MEAN = {:.3e}".format(b_mean_pmz_data))
if DEBUG:
    l_pmz.AddEntry(H_pmz_DATA_nocut,"DATA (no cut), MEAN = {:.3e}".format(b_mean_pmz_data_nocut))
    l_pmz.AddEntry(H_pmz_DATA_nopid,"DATA (no PID cut), MEAN = {:.3e}".format(b_mean_pmz_data_nopid))
l_pmz.AddEntry(H_pmz_DUMMY,"DUMMY, MEAN = {:.3e}".format(b_mean_pmz_dummy))
