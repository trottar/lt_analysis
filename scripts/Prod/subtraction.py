...
# Description:
# ================================================================
# Time-stamp: "2023-07-24 04:14:41 trottar"
# ================================================================
#
...
def defineHists(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":
        ...
        H_MM_SIMC  = ROOT.TH1D("H_MM_SIMC","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_DATA  = ROOT.TH1D("H_MM_DATA","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_DUMMY  = ROOT.TH1D("H_MM_DUMMY","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_RAND  = ROOT.TH1D("H_MM_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_DUMMY_RAND  = ROOT.TH1D("H_MM_DUMMY_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPION_DATA  = ROOT.TH1D("H_MM_SUBPION_DATA","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPION_DUMMY  = ROOT.TH1D("H_MM_SUBPION_DUMMY","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPION_RAND  = ROOT.TH1D("H_MM_SUBPION_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPION_DUMMY_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DATA  = ROOT.TH1D("H_MM_SUBPROTON_DATA","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DUMMY  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_RAND  = ROOT.TH1D("H_MM_SUBPROTON_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY_RAND","MM_{K}", 500, 0.0, 2.0)
        ...
        for i,evt in enumerate(TBRANCH_SUBPION_DATA):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPION_DATA = np.append(arr_MM_SUBPION_DATA, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPION_DUMMY):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPION_DUMMY = np.append(arr_MM_SUBPION_DUMMY, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPION_RAND):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPION_RAND = np.append(arr_MM_SUBPION_RAND, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPION_DUMMY_RAND):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPION_DUMMY_RAND = np.append(arr_MM_SUBPION_DUMMY_RAND, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPROTON_DATA):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPROTON_DATA = np.append(arr_MM_SUBPROTON_DATA, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPROTON_DUMMY):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPROTON_DUMMY = np.append(arr_MM_SUBPROTON_DUMMY, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPROTON_RAND):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPROTON_RAND = np.append(arr_MM_SUBPROTON_RAND, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        for i,evt in enumerate(TBRANCH_SUBPROTON_DUMMY_RAND):
            ...
            if(HMS_FixCut & HMS_Acceptance & SHMS_FixCut & SHMS_Acceptance & Diamond):
              ...
              arr_MM_SUBPROTON_DUMMY_RAND = np.append(arr_MM_SUBPROTON_DUMMY_RAND, np.sqrt(pow(evt.emiss, 2) - pow(evt.pmiss, 2)))
        ...
        H_t_SIMC       = ROOT.TH1D("H_t_SIMC","-t", 200, tmin, tmax)  
        ...
        H_t_DATA       = ROOT.TH1D("H_t_DATA","-t", 200, tmin, tmax)  
        ...
        H_t_DUMMY       = ROOT.TH1D("H_t_DUMMY","-t", 200, tmin, tmax)  
        ...
        H_t_RAND       = ROOT.TH1D("H_t_RAND","-t", 200, tmin, tmax)
        ...
        H_t_DUMMY_RAND       = ROOT.TH1D("H_t_DUMMY_RAND","-t", 200, tmin, tmax)
