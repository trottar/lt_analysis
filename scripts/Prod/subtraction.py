...
# Description:
# ================================================================
# Time-stamp: "2023-07-27 10:47:32 trottar"
# ================================================================
#
...
def defineHists(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":
        ...
        H_Weight_SIMC = ROOT.TH1D("H_Weight_SIMC", "Simc Weight", 1000, 0, 1e-8)
        H_hsdelta_SIMC  = ROOT.TH1D("H_hsdelta_SIMC","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SIMC  = ROOT.TH1D("H_hsxptar_SIMC","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SIMC  = ROOT.TH1D("H_hsyptar_SIMC","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SIMC    = ROOT.TH1D("H_ssxfp_SIMC","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SIMC    = ROOT.TH1D("H_ssyfp_SIMC","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SIMC   = ROOT.TH1D("H_ssxpfp_SIMC","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SIMC   = ROOT.TH1D("H_ssypfp_SIMC","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SIMC    = ROOT.TH1D("H_hsxfp_SIMC","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SIMC    = ROOT.TH1D("H_hsyfp_SIMC","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SIMC   = ROOT.TH1D("H_hsxpfp_SIMC","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SIMC   = ROOT.TH1D("H_hsypfp_SIMC","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SIMC  = ROOT.TH1D("H_ssdelta_SIMC","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SIMC  = ROOT.TH1D("H_ssxptar_SIMC","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SIMC  = ROOT.TH1D("H_ssyptar_SIMC","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SIMC        = ROOT.TH1D("H_q_SIMC","q", 1000, 0.0, 10.0)
        H_Q2_SIMC       = ROOT.TH1D("H_Q2_SIMC","Q2", 1000, Q2min, Q2max)
        H_W_SIMC  = ROOT.TH1D("H_W_SIMC","W ", 1000, Wmin, Wmax)
        H_t_SIMC       = ROOT.TH1D("H_t_SIMC","-t", 1000, tmin, tmax)  
        H_epsilon_SIMC  = ROOT.TH1D("H_epsilon_SIMC","epsilon", 1000, 0., 1.0)
        H_MM_SIMC  = ROOT.TH1D("H_MM_SIMC","MM_{K}", 1000, 0.0, 1.5)
        H_th_SIMC  = ROOT.TH1D("H_th_SIMC","X' tar", 1000, -0.1, 0.1)
        H_ph_SIMC  = ROOT.TH1D("H_ph_SIMC","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SIMC  = ROOT.TH1D("H_ph_q_SIMC","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SIMC  = ROOT.TH1D("H_th_q_SIMC","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SIMC  = ROOT.TH1D("H_ph_recoil_SIMC","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SIMC  = ROOT.TH1D("H_th_recoil_SIMC","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SIMC  = ROOT.TH1D("H_pmiss_SIMC","pmiss", 1000, 0.0, 10.0)
        H_emiss_SIMC  = ROOT.TH1D("H_emiss_SIMC","emiss", 1000, 0.0, 10.0)
        H_pmx_SIMC  = ROOT.TH1D("H_pmx_SIMC","pmx", 1000, -10.0, 10.0)
        H_pmy_SIMC  = ROOT.TH1D("H_pmy_SIMC","pmy ", 1000, -10.0, 10.0)
        H_pmz_SIMC  = ROOT.TH1D("H_pmz_SIMC","pmz", 1000, -10.0, 10.0)
        H_yield_SIMC = ROOT.TH1D("H_yield_SIMC", "Simc Yield", NumtBins*NumPhiBins, 0, 1.0)

        H_hsdelta_DATA  = ROOT.TH1D("H_hsdelta_DATA","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_DATA  = ROOT.TH1D("H_hsxptar_DATA","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_DATA  = ROOT.TH1D("H_hsyptar_DATA","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_DATA    = ROOT.TH1D("H_ssxfp_DATA","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_DATA    = ROOT.TH1D("H_ssyfp_DATA","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_DATA   = ROOT.TH1D("H_ssxpfp_DATA","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_DATA   = ROOT.TH1D("H_ssypfp_DATA","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_DATA    = ROOT.TH1D("H_hsxfp_DATA","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_DATA    = ROOT.TH1D("H_hsyfp_DATA","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_DATA   = ROOT.TH1D("H_hsxpfp_DATA","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_DATA   = ROOT.TH1D("H_hsypfp_DATA","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_DATA  = ROOT.TH1D("H_ssdelta_DATA","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_DATA  = ROOT.TH1D("H_ssxptar_DATA","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_DATA  = ROOT.TH1D("H_ssyptar_DATA","SHMS yptar", 1000, -0.04, 0.04)
        H_q_DATA        = ROOT.TH1D("H_q_DATA","q", 1000, 0.0, 10.0)
        H_Q2_DATA       = ROOT.TH1D("H_Q2_DATA","Q2", 1000, Q2min, Q2max)
        H_W_DATA  = ROOT.TH1D("H_W_DATA","W ", 1000, Wmin, Wmax)
        H_t_DATA       = ROOT.TH1D("H_t_DATA","-t", 1000, tmin, tmax)
        H_epsilon_DATA  = ROOT.TH1D("H_epsilon_DATA","epsilon", 1000, 0., 1.0)
        H_MM_DATA  = ROOT.TH1D("H_MM_DATA","MM_{K}", 1000, 0.0, 1.5)
        H_th_DATA  = ROOT.TH1D("H_th_DATA","X' tar", 1000, -0.1, 0.1)
        H_ph_DATA  = ROOT.TH1D("H_ph_DATA","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_DATA  = ROOT.TH1D("H_ph_q_DATA","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_DATA  = ROOT.TH1D("H_th_q_DATA","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_DATA  = ROOT.TH1D("H_ph_recoil_DATA","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_DATA  = ROOT.TH1D("H_th_recoil_DATA","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_DATA  = ROOT.TH1D("H_pmiss_DATA","pmiss", 1000, 0.0, 10.0)
        H_emiss_DATA  = ROOT.TH1D("H_emiss_DATA","emiss", 1000, 0.0, 10.0)
        H_pmx_DATA  = ROOT.TH1D("H_pmx_DATA","pmx", 1000, -10.0, 10.0)
        H_pmy_DATA  = ROOT.TH1D("H_pmy_DATA","pmy ", 1000, -10.0, 10.0)
        H_pmz_DATA  = ROOT.TH1D("H_pmz_DATA","pmz", 1000, -10.0, 10.0)
        H_ct_DATA = ROOT.TH1D("H_ct_DATA", "Electron-Kaon CTime", 1000, -10, 10)
        H_cal_etottracknorm_DATA = ROOT.TH1D("H_cal_etottracknorm_DATA", "HMS Cal etottracknorm", 1000, 0.2, 1.8)
        H_cer_npeSum_DATA = ROOT.TH1D("H_cer_npeSum_DATA", "HMS Cer Npe Sum", 1000, 0, 30)
        P_cal_etottracknorm_DATA = ROOT.TH1D("P_cal_etottracknorm_DATA", "SHMS Cal etottracknorm", 1000, 0, 1)
        P_hgcer_npeSum_DATA = ROOT.TH1D("P_hgcer_npeSum_DATA", "SHMS HGCer Npe Sum", 1000, 0, 50)
        P_aero_npeSum_DATA = ROOT.TH1D("P_aero_npeSum_DATA", "SHMS Aero Npe Sum", 1000, 0, 50)

        H_hsdelta_DUMMY  = ROOT.TH1D("H_hsdelta_DUMMY","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_DUMMY  = ROOT.TH1D("H_hsxptar_DUMMY","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_DUMMY  = ROOT.TH1D("H_hsyptar_DUMMY","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_DUMMY    = ROOT.TH1D("H_ssxfp_DUMMY","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_DUMMY    = ROOT.TH1D("H_ssyfp_DUMMY","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_DUMMY   = ROOT.TH1D("H_ssxpfp_DUMMY","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_DUMMY   = ROOT.TH1D("H_ssypfp_DUMMY","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_DUMMY    = ROOT.TH1D("H_hsxfp_DUMMY","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_DUMMY    = ROOT.TH1D("H_hsyfp_DUMMY","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_DUMMY   = ROOT.TH1D("H_hsxpfp_DUMMY","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_DUMMY   = ROOT.TH1D("H_hsypfp_DUMMY","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_DUMMY  = ROOT.TH1D("H_ssdelta_DUMMY","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_DUMMY  = ROOT.TH1D("H_ssxptar_DUMMY","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_DUMMY  = ROOT.TH1D("H_ssyptar_DUMMY","SHMS yptar", 1000, -0.04, 0.04)
        H_q_DUMMY        = ROOT.TH1D("H_q_DUMMY","q", 1000, 0.0, 10.0)
        H_Q2_DUMMY       = ROOT.TH1D("H_Q2_DUMMY","Q2", 1000, Q2min, Q2max)
        H_W_DUMMY  = ROOT.TH1D("H_W_DUMMY","W ", 1000, Wmin, Wmax)
        H_t_DUMMY       = ROOT.TH1D("H_t_DUMMY","-t", 1000, tmin, tmax)  
        H_epsilon_DUMMY  = ROOT.TH1D("H_epsilon_DUMMY","epsilon", 1000, 0., 1.0)
        H_MM_DUMMY  = ROOT.TH1D("H_MM_DUMMY","MM_{K}", 1000, 0.0, 1.5)
        H_th_DUMMY  = ROOT.TH1D("H_th_DUMMY","X' tar", 1000, -0.1, 0.1)
        H_ph_DUMMY  = ROOT.TH1D("H_ph_DUMMY","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_DUMMY  = ROOT.TH1D("H_ph_q_DUMMY","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_DUMMY  = ROOT.TH1D("H_th_q_DUMMY","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_DUMMY  = ROOT.TH1D("H_ph_recoil_DUMMY","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_DUMMY  = ROOT.TH1D("H_th_recoil_DUMMY","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_DUMMY  = ROOT.TH1D("H_pmiss_DUMMY","pmiss", 1000, 0.0, 10.0)
        H_emiss_DUMMY  = ROOT.TH1D("H_emiss_DUMMY","emiss", 1000, 0.0, 10.0)
        H_pmx_DUMMY  = ROOT.TH1D("H_pmx_DUMMY","pmx", 1000, -10.0, 10.0)
        H_pmy_DUMMY  = ROOT.TH1D("H_pmy_DUMMY","pmy ", 1000, -10.0, 10.0)
        H_pmz_DUMMY  = ROOT.TH1D("H_pmz_DUMMY","pmz", 1000, -10.0, 10.0)
        H_ct_DUMMY = ROOT.TH1D("H_ct_DUMMY", "Electron-Kaon CTime", 1000, -10, 10)

        H_hsdelta_RAND  = ROOT.TH1D("H_hsdelta_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_RAND  = ROOT.TH1D("H_hsxptar_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_RAND  = ROOT.TH1D("H_hsyptar_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_RAND    = ROOT.TH1D("H_ssxfp_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_RAND    = ROOT.TH1D("H_ssyfp_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_RAND   = ROOT.TH1D("H_ssxpfp_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_RAND   = ROOT.TH1D("H_ssypfp_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_RAND    = ROOT.TH1D("H_hsxfp_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_RAND    = ROOT.TH1D("H_hsyfp_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_RAND   = ROOT.TH1D("H_hsxpfp_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_RAND   = ROOT.TH1D("H_hsypfp_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_RAND  = ROOT.TH1D("H_ssdelta_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_RAND  = ROOT.TH1D("H_ssxptar_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_RAND  = ROOT.TH1D("H_ssyptar_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_RAND        = ROOT.TH1D("H_q_RAND","q", 1000, 0.0, 10.0)
        H_Q2_RAND       = ROOT.TH1D("H_Q2_RAND","Q2", 1000, Q2min, Q2max)
        H_W_RAND  = ROOT.TH1D("H_W_RAND","W ", 1000, Wmin, Wmax)
        H_t_RAND       = ROOT.TH1D("H_t_RAND","-t", 1000, tmin, tmax)
        H_epsilon_RAND  = ROOT.TH1D("H_epsilon_RAND","epsilon", 1000, 0., 1.0)
        H_MM_RAND  = ROOT.TH1D("H_MM_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_RAND  = ROOT.TH1D("H_th_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_RAND  = ROOT.TH1D("H_ph_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_RAND  = ROOT.TH1D("H_ph_q_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_RAND  = ROOT.TH1D("H_th_q_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_RAND  = ROOT.TH1D("H_ph_recoil_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_RAND  = ROOT.TH1D("H_th_recoil_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_RAND  = ROOT.TH1D("H_pmiss_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_RAND  = ROOT.TH1D("H_emiss_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_RAND  = ROOT.TH1D("H_pmx_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_RAND  = ROOT.TH1D("H_pmy_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_RAND  = ROOT.TH1D("H_pmz_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_RAND = ROOT.TH1D("H_ct_RAND", "Electron-Kaon CTime", 1000, -10, 10)

        H_hsdelta_DUMMY_RAND  = ROOT.TH1D("H_hsdelta_DUMMY_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_DUMMY_RAND  = ROOT.TH1D("H_hsxptar_DUMMY_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_DUMMY_RAND  = ROOT.TH1D("H_hsyptar_DUMMY_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_DUMMY_RAND    = ROOT.TH1D("H_ssxfp_DUMMY_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_DUMMY_RAND    = ROOT.TH1D("H_ssyfp_DUMMY_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_DUMMY_RAND   = ROOT.TH1D("H_ssxpfp_DUMMY_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_DUMMY_RAND   = ROOT.TH1D("H_ssypfp_DUMMY_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_DUMMY_RAND    = ROOT.TH1D("H_hsxfp_DUMMY_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_DUMMY_RAND    = ROOT.TH1D("H_hsyfp_DUMMY_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_DUMMY_RAND   = ROOT.TH1D("H_hsxpfp_DUMMY_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_DUMMY_RAND   = ROOT.TH1D("H_hsypfp_DUMMY_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_DUMMY_RAND  = ROOT.TH1D("H_ssdelta_DUMMY_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_DUMMY_RAND  = ROOT.TH1D("H_ssxptar_DUMMY_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_DUMMY_RAND  = ROOT.TH1D("H_ssyptar_DUMMY_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_DUMMY_RAND        = ROOT.TH1D("H_q_DUMMY_RAND","q", 1000, 0.0, 10.0)
        H_Q2_DUMMY_RAND       = ROOT.TH1D("H_Q2_DUMMY_RAND","Q2", 1000, Q2min, Q2max)
        H_W_DUMMY_RAND  = ROOT.TH1D("H_W_DUMMY_RAND","W ", 1000, Wmin, Wmax)
        H_t_DUMMY_RAND       = ROOT.TH1D("H_t_DUMMY_RAND","-t", 1000, tmin, tmax)
        H_epsilon_DUMMY_RAND  = ROOT.TH1D("H_epsilon_DUMMY_RAND","epsilon", 1000, 0., 1.0)
        H_MM_DUMMY_RAND  = ROOT.TH1D("H_MM_DUMMY_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_DUMMY_RAND  = ROOT.TH1D("H_th_DUMMY_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_DUMMY_RAND  = ROOT.TH1D("H_ph_DUMMY_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_DUMMY_RAND  = ROOT.TH1D("H_ph_q_DUMMY_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_DUMMY_RAND  = ROOT.TH1D("H_th_q_DUMMY_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_DUMMY_RAND  = ROOT.TH1D("H_ph_recoil_DUMMY_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_DUMMY_RAND  = ROOT.TH1D("H_th_recoil_DUMMY_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_DUMMY_RAND  = ROOT.TH1D("H_pmiss_DUMMY_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_DUMMY_RAND  = ROOT.TH1D("H_emiss_DUMMY_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_DUMMY_RAND  = ROOT.TH1D("H_pmx_DUMMY_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_DUMMY_RAND  = ROOT.TH1D("H_pmy_DUMMY_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_DUMMY_RAND  = ROOT.TH1D("H_pmz_DUMMY_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_DUMMY_RAND = ROOT.TH1D("H_ct_DUMMY_RAND", "Electron-Kaon CTime", 1000, -10, 10)

        H_hsdelta_SUBPION_DATA  = ROOT.TH1D("H_hsdelta_SUBPION_DATA","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPION_DATA  = ROOT.TH1D("H_hsxptar_SUBPION_DATA","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPION_DATA  = ROOT.TH1D("H_hsyptar_SUBPION_DATA","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPION_DATA    = ROOT.TH1D("H_ssxfp_SUBPION_DATA","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPION_DATA    = ROOT.TH1D("H_ssyfp_SUBPION_DATA","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPION_DATA   = ROOT.TH1D("H_ssxpfp_SUBPION_DATA","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPION_DATA   = ROOT.TH1D("H_ssypfp_SUBPION_DATA","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPION_DATA    = ROOT.TH1D("H_hsxfp_SUBPION_DATA","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPION_DATA    = ROOT.TH1D("H_hsyfp_SUBPION_DATA","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPION_DATA   = ROOT.TH1D("H_hsxpfp_SUBPION_DATA","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPION_DATA   = ROOT.TH1D("H_hsypfp_SUBPION_DATA","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPION_DATA  = ROOT.TH1D("H_ssdelta_SUBPION_DATA","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPION_DATA  = ROOT.TH1D("H_ssxptar_SUBPION_DATA","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPION_DATA  = ROOT.TH1D("H_ssyptar_SUBPION_DATA","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPION_DATA        = ROOT.TH1D("H_q_SUBPION_DATA","q", 1000, 0.0, 10.0)
        H_Q2_SUBPION_DATA       = ROOT.TH1D("H_Q2_SUBPION_DATA","Q2", 1000, Q2min, Q2max)
        H_W_SUBPION_DATA  = ROOT.TH1D("H_W_SUBPION_DATA","W ", 1000, Wmin, Wmax)
        H_t_SUBPION_DATA       = ROOT.TH1D("H_t_SUBPION_DATA","-t", 1000, tmin, tmax)  
        H_epsilon_SUBPION_DATA  = ROOT.TH1D("H_epsilon_SUBPION_DATA","epsilon", 1000, 0., 1.0)
        H_MM_SUBPION_DATA  = ROOT.TH1D("H_MM_SUBPION_DATA","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPION_DATA  = ROOT.TH1D("H_th_SUBPION_DATA","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPION_DATA  = ROOT.TH1D("H_ph_SUBPION_DATA","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPION_DATA  = ROOT.TH1D("H_ph_q_SUBPION_DATA","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPION_DATA  = ROOT.TH1D("H_th_q_SUBPION_DATA","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPION_DATA  = ROOT.TH1D("H_ph_recoil_SUBPION_DATA","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPION_DATA  = ROOT.TH1D("H_th_recoil_SUBPION_DATA","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPION_DATA  = ROOT.TH1D("H_pmiss_SUBPION_DATA","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPION_DATA  = ROOT.TH1D("H_emiss_SUBPION_DATA","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPION_DATA  = ROOT.TH1D("H_pmx_SUBPION_DATA","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPION_DATA  = ROOT.TH1D("H_pmy_SUBPION_DATA","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPION_DATA  = ROOT.TH1D("H_pmz_SUBPION_DATA","pmz", 1000, -10.0, 10.0)
        H_ct_epi_SUBPION_DATA = ROOT.TH1D("H_ct_epi_SUBPION_DATA", "Electron-Pion CTime", 1000, -10, 10)
        H_cal_etottracknorm_SUBPION_DATA = ROOT.TH1D("H_cal_etottracknorm_SUBPION_DATA", "HMS Cal etottracknorm", 1000, 0.2, 1.8)
        H_cer_npeSum_SUBPION_DATA = ROOT.TH1D("H_cer_npeSum_SUBPION_DATA", "HMS Cer Npe Sum", 1000, 0, 30)
        P_cal_etottracknorm_SUBPION_DATA = ROOT.TH1D("P_cal_etottracknorm_SUBPION_DATA", "SHMS Cal etottracknorm", 1000, 0, 1)
        P_hgcer_npeSum_SUBPION_DATA = ROOT.TH1D("P_hgcer_npeSum_SUBPION_DATA", "SHMS HGCer Npe Sum", 1000, 0, 50)
        P_aero_npeSum_SUBPION_DATA = ROOT.TH1D("P_aero_npeSum_SUBPION_DATA", "SHMS Aero Npe Sum", 1000, 0, 50)

        H_hsdelta_SUBPION_DUMMY  = ROOT.TH1D("H_hsdelta_SUBPION_DUMMY","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPION_DUMMY  = ROOT.TH1D("H_hsxptar_SUBPION_DUMMY","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPION_DUMMY  = ROOT.TH1D("H_hsyptar_SUBPION_DUMMY","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPION_DUMMY    = ROOT.TH1D("H_ssxfp_SUBPION_DUMMY","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPION_DUMMY    = ROOT.TH1D("H_ssyfp_SUBPION_DUMMY","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPION_DUMMY   = ROOT.TH1D("H_ssxpfp_SUBPION_DUMMY","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPION_DUMMY   = ROOT.TH1D("H_ssypfp_SUBPION_DUMMY","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPION_DUMMY    = ROOT.TH1D("H_hsxfp_SUBPION_DUMMY","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPION_DUMMY    = ROOT.TH1D("H_hsyfp_SUBPION_DUMMY","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPION_DUMMY   = ROOT.TH1D("H_hsxpfp_SUBPION_DUMMY","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPION_DUMMY   = ROOT.TH1D("H_hsypfp_SUBPION_DUMMY","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPION_DUMMY  = ROOT.TH1D("H_ssdelta_SUBPION_DUMMY","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPION_DUMMY  = ROOT.TH1D("H_ssxptar_SUBPION_DUMMY","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPION_DUMMY  = ROOT.TH1D("H_ssyptar_SUBPION_DUMMY","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPION_DUMMY        = ROOT.TH1D("H_q_SUBPION_DUMMY","q", 1000, 0.0, 10.0)
        H_Q2_SUBPION_DUMMY       = ROOT.TH1D("H_Q2_SUBPION_DUMMY","Q2", 1000, Q2min, Q2max)
        H_W_SUBPION_DUMMY  = ROOT.TH1D("H_W_SUBPION_DUMMY","W ", 1000, Wmin, Wmax)
        H_t_SUBPION_DUMMY       = ROOT.TH1D("H_t_SUBPION_DUMMY","-t", 1000, tmin, tmax)  
        H_epsilon_SUBPION_DUMMY  = ROOT.TH1D("H_epsilon_SUBPION_DUMMY","epsilon", 1000, 0., 1.0)
        H_MM_SUBPION_DUMMY  = ROOT.TH1D("H_MM_SUBPION_DUMMY","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPION_DUMMY  = ROOT.TH1D("H_th_SUBPION_DUMMY","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPION_DUMMY  = ROOT.TH1D("H_ph_SUBPION_DUMMY","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPION_DUMMY  = ROOT.TH1D("H_ph_q_SUBPION_DUMMY","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPION_DUMMY  = ROOT.TH1D("H_th_q_SUBPION_DUMMY","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPION_DUMMY  = ROOT.TH1D("H_ph_recoil_SUBPION_DUMMY","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPION_DUMMY  = ROOT.TH1D("H_th_recoil_SUBPION_DUMMY","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPION_DUMMY  = ROOT.TH1D("H_pmiss_SUBPION_DUMMY","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPION_DUMMY  = ROOT.TH1D("H_emiss_SUBPION_DUMMY","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPION_DUMMY  = ROOT.TH1D("H_pmx_SUBPION_DUMMY","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPION_DUMMY  = ROOT.TH1D("H_pmy_SUBPION_DUMMY","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPION_DUMMY  = ROOT.TH1D("H_pmz_SUBPION_DUMMY","pmz", 1000, -10.0, 10.0)
        H_ct_epi_SUBPION_DUMMY = ROOT.TH1D("H_ct_epi_SUBPION_DUMMY", "Electron-Pion CTime", 1000, -10, 10)

        H_hsdelta_SUBPION_RAND  = ROOT.TH1D("H_hsdelta_SUBPION_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPION_RAND  = ROOT.TH1D("H_hsxptar_SUBPION_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPION_RAND  = ROOT.TH1D("H_hsyptar_SUBPION_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPION_RAND    = ROOT.TH1D("H_ssxfp_SUBPION_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPION_RAND    = ROOT.TH1D("H_ssyfp_SUBPION_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPION_RAND   = ROOT.TH1D("H_ssxpfp_SUBPION_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPION_RAND   = ROOT.TH1D("H_ssypfp_SUBPION_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPION_RAND    = ROOT.TH1D("H_hsxfp_SUBPION_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPION_RAND    = ROOT.TH1D("H_hsyfp_SUBPION_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPION_RAND   = ROOT.TH1D("H_hsxpfp_SUBPION_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPION_RAND   = ROOT.TH1D("H_hsypfp_SUBPION_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPION_RAND  = ROOT.TH1D("H_ssdelta_SUBPION_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPION_RAND  = ROOT.TH1D("H_ssxptar_SUBPION_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPION_RAND  = ROOT.TH1D("H_ssyptar_SUBPION_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPION_RAND        = ROOT.TH1D("H_q_SUBPION_RAND","q", 1000, 0.0, 10.0)
        H_Q2_SUBPION_RAND       = ROOT.TH1D("H_Q2_SUBPION_RAND","Q2", 1000, Q2min, Q2max)
        H_W_SUBPION_RAND  = ROOT.TH1D("H_W_SUBPION_RAND","W ", 1000, Wmin, Wmax)
        H_t_SUBPION_RAND       = ROOT.TH1D("H_t_SUBPION_RAND","-t", 1000, tmin, tmax)
        H_epsilon_SUBPION_RAND  = ROOT.TH1D("H_epsilon_SUBPION_RAND","epsilon", 1000, 0., 1.0)
        H_MM_SUBPION_RAND  = ROOT.TH1D("H_MM_SUBPION_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPION_RAND  = ROOT.TH1D("H_th_SUBPION_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPION_RAND  = ROOT.TH1D("H_ph_SUBPION_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPION_RAND  = ROOT.TH1D("H_ph_q_SUBPION_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPION_RAND  = ROOT.TH1D("H_th_q_SUBPION_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPION_RAND  = ROOT.TH1D("H_ph_recoil_SUBPION_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPION_RAND  = ROOT.TH1D("H_th_recoil_SUBPION_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPION_RAND  = ROOT.TH1D("H_pmiss_SUBPION_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPION_RAND  = ROOT.TH1D("H_emiss_SUBPION_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPION_RAND  = ROOT.TH1D("H_pmx_SUBPION_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPION_RAND  = ROOT.TH1D("H_pmy_SUBPION_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPION_RAND  = ROOT.TH1D("H_pmz_SUBPION_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_epi_SUBPION_RAND = ROOT.TH1D("H_ct_epi_SUBPION_RAND", "Electron-Pion CTime", 1000, -10, 10)

        H_hsdelta_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_hsdelta_SUBPION_DUMMY_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_hsxptar_SUBPION_DUMMY_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_hsyptar_SUBPION_DUMMY_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPION_DUMMY_RAND    = ROOT.TH1D("H_ssxfp_SUBPION_DUMMY_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPION_DUMMY_RAND    = ROOT.TH1D("H_ssyfp_SUBPION_DUMMY_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPION_DUMMY_RAND   = ROOT.TH1D("H_ssxpfp_SUBPION_DUMMY_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPION_DUMMY_RAND   = ROOT.TH1D("H_ssypfp_SUBPION_DUMMY_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPION_DUMMY_RAND    = ROOT.TH1D("H_hsxfp_SUBPION_DUMMY_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPION_DUMMY_RAND    = ROOT.TH1D("H_hsyfp_SUBPION_DUMMY_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPION_DUMMY_RAND   = ROOT.TH1D("H_hsxpfp_SUBPION_DUMMY_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPION_DUMMY_RAND   = ROOT.TH1D("H_hsypfp_SUBPION_DUMMY_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ssdelta_SUBPION_DUMMY_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ssxptar_SUBPION_DUMMY_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ssyptar_SUBPION_DUMMY_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPION_DUMMY_RAND        = ROOT.TH1D("H_q_SUBPION_DUMMY_RAND","q", 1000, 0.0, 10.0)
        H_Q2_SUBPION_DUMMY_RAND       = ROOT.TH1D("H_Q2_SUBPION_DUMMY_RAND","Q2", 1000, Q2min, Q2max)
        H_W_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_W_SUBPION_DUMMY_RAND","W ", 1000, Wmin, Wmax)
        H_t_SUBPION_DUMMY_RAND       = ROOT.TH1D("H_t_SUBPION_DUMMY_RAND","-t", 1000, tmin, tmax)
        H_epsilon_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_epsilon_SUBPION_DUMMY_RAND","epsilon", 1000, 0., 1.0)
        H_MM_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPION_DUMMY_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_th_SUBPION_DUMMY_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ph_SUBPION_DUMMY_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ph_q_SUBPION_DUMMY_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_th_q_SUBPION_DUMMY_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_ph_recoil_SUBPION_DUMMY_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_th_recoil_SUBPION_DUMMY_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_pmiss_SUBPION_DUMMY_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_emiss_SUBPION_DUMMY_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_pmx_SUBPION_DUMMY_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_pmy_SUBPION_DUMMY_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_pmz_SUBPION_DUMMY_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_epi_SUBPION_DUMMY_RAND = ROOT.TH1D("H_ct_epi_SUBPION_DUMMY_RAND", "Electron-Pion CTime", 1000, -10, 10)

        H_hsdelta_SUBPROTON_DATA  = ROOT.TH1D("H_hsdelta_SUBPROTON_DATA","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPROTON_DATA  = ROOT.TH1D("H_hsxptar_SUBPROTON_DATA","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPROTON_DATA  = ROOT.TH1D("H_hsyptar_SUBPROTON_DATA","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPROTON_DATA    = ROOT.TH1D("H_ssxfp_SUBPROTON_DATA","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPROTON_DATA    = ROOT.TH1D("H_ssyfp_SUBPROTON_DATA","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPROTON_DATA   = ROOT.TH1D("H_ssxpfp_SUBPROTON_DATA","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPROTON_DATA   = ROOT.TH1D("H_ssypfp_SUBPROTON_DATA","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPROTON_DATA    = ROOT.TH1D("H_hsxfp_SUBPROTON_DATA","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPROTON_DATA    = ROOT.TH1D("H_hsyfp_SUBPROTON_DATA","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPROTON_DATA   = ROOT.TH1D("H_hsxpfp_SUBPROTON_DATA","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPROTON_DATA   = ROOT.TH1D("H_hsypfp_SUBPROTON_DATA","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPROTON_DATA  = ROOT.TH1D("H_ssdelta_SUBPROTON_DATA","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPROTON_DATA  = ROOT.TH1D("H_ssxptar_SUBPROTON_DATA","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPROTON_DATA  = ROOT.TH1D("H_ssyptar_SUBPROTON_DATA","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPROTON_DATA        = ROOT.TH1D("H_q_SUBPROTON_DATA","q", 1000, 0.0, 10.0)
        H_Q2_SUBPROTON_DATA       = ROOT.TH1D("H_Q2_SUBPROTON_DATA","Q2", 1000, Q2min, Q2max)
        H_W_SUBPROTON_DATA  = ROOT.TH1D("H_W_SUBPROTON_DATA","W ", 1000, Wmin, Wmax)
        H_t_SUBPROTON_DATA       = ROOT.TH1D("H_t_SUBPROTON_DATA","-t", 1000, tmin, tmax)  
        H_epsilon_SUBPROTON_DATA  = ROOT.TH1D("H_epsilon_SUBPROTON_DATA","epsilon", 1000, 0., 1.0)
        H_MM_SUBPROTON_DATA  = ROOT.TH1D("H_MM_SUBPROTON_DATA","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPROTON_DATA  = ROOT.TH1D("H_th_SUBPROTON_DATA","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPROTON_DATA  = ROOT.TH1D("H_ph_SUBPROTON_DATA","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPROTON_DATA  = ROOT.TH1D("H_ph_q_SUBPROTON_DATA","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPROTON_DATA  = ROOT.TH1D("H_th_q_SUBPROTON_DATA","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPROTON_DATA  = ROOT.TH1D("H_ph_recoil_SUBPROTON_DATA","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPROTON_DATA  = ROOT.TH1D("H_th_recoil_SUBPROTON_DATA","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPROTON_DATA  = ROOT.TH1D("H_pmiss_SUBPROTON_DATA","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPROTON_DATA  = ROOT.TH1D("H_emiss_SUBPROTON_DATA","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPROTON_DATA  = ROOT.TH1D("H_pmx_SUBPROTON_DATA","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPROTON_DATA  = ROOT.TH1D("H_pmy_SUBPROTON_DATA","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPROTON_DATA  = ROOT.TH1D("H_pmz_SUBPROTON_DATA","pmz", 1000, -10.0, 10.0)
        H_ct_ep_SUBPROTON_DATA = ROOT.TH1D("H_ct_ep_SUBPROTON_DATA", "Electron-Proton CTime", 1000, -10, 10)
        H_cal_etottracknorm_SUBPROTON_DATA = ROOT.TH1D("H_cal_etottracknorm_SUBPROTON_DATA", "HMS Cal etottracknorm", 1000, 0.2, 1.8)
        H_cer_npeSum_SUBPROTON_DATA = ROOT.TH1D("H_cer_npeSum_SUBPROTON_DATA", "HMS Cer Npe Sum", 1000, 0, 30)
        P_cal_etottracknorm_SUBPROTON_DATA = ROOT.TH1D("P_cal_etottracknorm_SUBPROTON_DATA", "SHMS Cal etottracknorm", 1000, 0, 1)
        P_hgcer_npeSum_SUBPROTON_DATA = ROOT.TH1D("P_hgcer_npeSum_SUBPROTON_DATA", "SHMS HGCer Npe Sum", 1000, 0, 50)
        P_aero_npeSum_SUBPROTON_DATA = ROOT.TH1D("P_aero_npeSum_SUBPROTON_DATA", "SHMS Aero Npe Sum", 1000, 0, 50)

        H_hsdelta_SUBPROTON_DUMMY  = ROOT.TH1D("H_hsdelta_SUBPROTON_DUMMY","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPROTON_DUMMY  = ROOT.TH1D("H_hsxptar_SUBPROTON_DUMMY","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPROTON_DUMMY  = ROOT.TH1D("H_hsyptar_SUBPROTON_DUMMY","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPROTON_DUMMY    = ROOT.TH1D("H_ssxfp_SUBPROTON_DUMMY","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPROTON_DUMMY    = ROOT.TH1D("H_ssyfp_SUBPROTON_DUMMY","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPROTON_DUMMY   = ROOT.TH1D("H_ssxpfp_SUBPROTON_DUMMY","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPROTON_DUMMY   = ROOT.TH1D("H_ssypfp_SUBPROTON_DUMMY","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPROTON_DUMMY    = ROOT.TH1D("H_hsxfp_SUBPROTON_DUMMY","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPROTON_DUMMY    = ROOT.TH1D("H_hsyfp_SUBPROTON_DUMMY","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPROTON_DUMMY   = ROOT.TH1D("H_hsxpfp_SUBPROTON_DUMMY","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPROTON_DUMMY   = ROOT.TH1D("H_hsypfp_SUBPROTON_DUMMY","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPROTON_DUMMY  = ROOT.TH1D("H_ssdelta_SUBPROTON_DUMMY","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPROTON_DUMMY  = ROOT.TH1D("H_ssxptar_SUBPROTON_DUMMY","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPROTON_DUMMY  = ROOT.TH1D("H_ssyptar_SUBPROTON_DUMMY","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPROTON_DUMMY        = ROOT.TH1D("H_q_SUBPROTON_DUMMY","q", 1000, 0.0, 10.0)
        H_Q2_SUBPROTON_DUMMY       = ROOT.TH1D("H_Q2_SUBPROTON_DUMMY","Q2", 1000, Q2min, Q2max)
        H_W_SUBPROTON_DUMMY  = ROOT.TH1D("H_W_SUBPROTON_DUMMY","W ", 1000, Wmin, Wmax)
        H_t_SUBPROTON_DUMMY       = ROOT.TH1D("H_t_SUBPROTON_DUMMY","-t", 1000, tmin, tmax)  
        H_epsilon_SUBPROTON_DUMMY  = ROOT.TH1D("H_epsilon_SUBPROTON_DUMMY","epsilon", 1000, 0., 1.0)
        H_MM_SUBPROTON_DUMMY  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPROTON_DUMMY  = ROOT.TH1D("H_th_SUBPROTON_DUMMY","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPROTON_DUMMY  = ROOT.TH1D("H_ph_SUBPROTON_DUMMY","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPROTON_DUMMY  = ROOT.TH1D("H_ph_q_SUBPROTON_DUMMY","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPROTON_DUMMY  = ROOT.TH1D("H_th_q_SUBPROTON_DUMMY","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPROTON_DUMMY  = ROOT.TH1D("H_ph_recoil_SUBPROTON_DUMMY","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPROTON_DUMMY  = ROOT.TH1D("H_th_recoil_SUBPROTON_DUMMY","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPROTON_DUMMY  = ROOT.TH1D("H_pmiss_SUBPROTON_DUMMY","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPROTON_DUMMY  = ROOT.TH1D("H_emiss_SUBPROTON_DUMMY","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPROTON_DUMMY  = ROOT.TH1D("H_pmx_SUBPROTON_DUMMY","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPROTON_DUMMY  = ROOT.TH1D("H_pmy_SUBPROTON_DUMMY","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPROTON_DUMMY  = ROOT.TH1D("H_pmz_SUBPROTON_DUMMY","pmz", 1000, -10.0, 10.0)
        H_ct_ep_SUBPROTON_DUMMY = ROOT.TH1D("H_ct_ep_SUBPROTON_DUMMY", "Electron-Proton CTime", 1000, -10, 10)

        H_hsdelta_SUBPROTON_RAND  = ROOT.TH1D("H_hsdelta_SUBPROTON_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPROTON_RAND  = ROOT.TH1D("H_hsxptar_SUBPROTON_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPROTON_RAND  = ROOT.TH1D("H_hsyptar_SUBPROTON_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPROTON_RAND    = ROOT.TH1D("H_ssxfp_SUBPROTON_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPROTON_RAND    = ROOT.TH1D("H_ssyfp_SUBPROTON_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPROTON_RAND   = ROOT.TH1D("H_ssxpfp_SUBPROTON_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPROTON_RAND   = ROOT.TH1D("H_ssypfp_SUBPROTON_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPROTON_RAND    = ROOT.TH1D("H_hsxfp_SUBPROTON_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPROTON_RAND    = ROOT.TH1D("H_hsyfp_SUBPROTON_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPROTON_RAND   = ROOT.TH1D("H_hsxpfp_SUBPROTON_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPROTON_RAND   = ROOT.TH1D("H_hsypfp_SUBPROTON_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPROTON_RAND  = ROOT.TH1D("H_ssdelta_SUBPROTON_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPROTON_RAND  = ROOT.TH1D("H_ssxptar_SUBPROTON_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPROTON_RAND  = ROOT.TH1D("H_ssyptar_SUBPROTON_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPROTON_RAND        = ROOT.TH1D("H_q_SUBPROTON_RAND","q", 1000, 0.0, 10.0)
        H_Q2_SUBPROTON_RAND       = ROOT.TH1D("H_Q2_SUBPROTON_RAND","Q2", 1000, Q2min, Q2max)
        H_W_SUBPROTON_RAND  = ROOT.TH1D("H_W_SUBPROTON_RAND","W ", 1000, Wmin, Wmax)
        H_t_SUBPROTON_RAND       = ROOT.TH1D("H_t_SUBPROTON_RAND","-t", 1000, tmin, tmax)
        H_epsilon_SUBPROTON_RAND  = ROOT.TH1D("H_epsilon_SUBPROTON_RAND","epsilon", 1000, 0., 1.0)
        H_MM_SUBPROTON_RAND  = ROOT.TH1D("H_MM_SUBPROTON_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPROTON_RAND  = ROOT.TH1D("H_th_SUBPROTON_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPROTON_RAND  = ROOT.TH1D("H_ph_SUBPROTON_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPROTON_RAND  = ROOT.TH1D("H_ph_q_SUBPROTON_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPROTON_RAND  = ROOT.TH1D("H_th_q_SUBPROTON_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPROTON_RAND  = ROOT.TH1D("H_ph_recoil_SUBPROTON_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPROTON_RAND  = ROOT.TH1D("H_th_recoil_SUBPROTON_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPROTON_RAND  = ROOT.TH1D("H_pmiss_SUBPROTON_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPROTON_RAND  = ROOT.TH1D("H_emiss_SUBPROTON_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPROTON_RAND  = ROOT.TH1D("H_pmx_SUBPROTON_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPROTON_RAND  = ROOT.TH1D("H_pmy_SUBPROTON_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPROTON_RAND  = ROOT.TH1D("H_pmz_SUBPROTON_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_ep_SUBPROTON_RAND = ROOT.TH1D("H_ct_ep_SUBPROTON_RAND", "Electron-Proton CTime", 1000, -10, 10)

        H_hsdelta_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_hsdelta_SUBPROTON_DUMMY_RAND","HMS Delta", 1000, -20.0, 20.0)
        H_hsxptar_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_hsxptar_SUBPROTON_DUMMY_RAND","HMS xptar", 1000, -0.1, 0.1)
        H_hsyptar_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_hsyptar_SUBPROTON_DUMMY_RAND","HMS yptar", 1000, -0.1, 0.1)
        H_ssxfp_SUBPROTON_DUMMY_RAND    = ROOT.TH1D("H_ssxfp_SUBPROTON_DUMMY_RAND","SHMS xfp", 1000, -25.0, 25.0)
        H_ssyfp_SUBPROTON_DUMMY_RAND    = ROOT.TH1D("H_ssyfp_SUBPROTON_DUMMY_RAND","SHMS yfp", 1000, -25.0, 25.0)
        H_ssxpfp_SUBPROTON_DUMMY_RAND   = ROOT.TH1D("H_ssxpfp_SUBPROTON_DUMMY_RAND","SHMS xpfp", 1000, -0.09, 0.09)
        H_ssypfp_SUBPROTON_DUMMY_RAND   = ROOT.TH1D("H_ssypfp_SUBPROTON_DUMMY_RAND","SHMS ypfp", 1000, -0.05, 0.04)
        H_hsxfp_SUBPROTON_DUMMY_RAND    = ROOT.TH1D("H_hsxfp_SUBPROTON_DUMMY_RAND","HMS xfp", 1000, -40.0, 40.0)
        H_hsyfp_SUBPROTON_DUMMY_RAND    = ROOT.TH1D("H_hsyfp_SUBPROTON_DUMMY_RAND","HMS yfp", 1000, -20.0, 20.0)
        H_hsxpfp_SUBPROTON_DUMMY_RAND   = ROOT.TH1D("H_hsxpfp_SUBPROTON_DUMMY_RAND","HMS xpfp", 1000, -0.09, 0.05)
        H_hsypfp_SUBPROTON_DUMMY_RAND   = ROOT.TH1D("H_hsypfp_SUBPROTON_DUMMY_RAND","HMS ypfp", 1000, -0.05, 0.04)
        H_ssdelta_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ssdelta_SUBPROTON_DUMMY_RAND","SHMS delta", 1000, -20.0, 20.0)
        H_ssxptar_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ssxptar_SUBPROTON_DUMMY_RAND","SHMS xptar", 1000, -0.1, 0.1)
        H_ssyptar_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ssyptar_SUBPROTON_DUMMY_RAND","SHMS yptar", 1000, -0.04, 0.04)
        H_q_SUBPROTON_DUMMY_RAND        = ROOT.TH1D("H_q_SUBPROTON_DUMMY_RAND","q", 1000, 0.0, 10.0)
        H_Q2_SUBPROTON_DUMMY_RAND       = ROOT.TH1D("H_Q2_SUBPROTON_DUMMY_RAND","Q2", 1000, Q2min, Q2max)
        H_W_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_W_SUBPROTON_DUMMY_RAND","W ", 1000, Wmin, Wmax)
        H_t_SUBPROTON_DUMMY_RAND       = ROOT.TH1D("H_t_SUBPROTON_DUMMY_RAND","-t", 1000, tmin, tmax)
        H_epsilon_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_epsilon_SUBPROTON_DUMMY_RAND","epsilon", 1000, 0., 1.0)
        H_MM_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY_RAND","MM_{K}", 1000, 0.0, 1.5)
        H_th_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_th_SUBPROTON_DUMMY_RAND","X' tar", 1000, -0.1, 0.1)
        H_ph_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ph_SUBPROTON_DUMMY_RAND","Y' tar", 1000, -0.1, 0.1)
        H_ph_q_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ph_q_SUBPROTON_DUMMY_RAND","Phi Detected (ph_xq)", 1000, -5.0, 5.0)
        H_th_q_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_th_q_SUBPROTON_DUMMY_RAND","Theta Detected (th_xq)", 1000, -0.2, 0.2)
        H_ph_recoil_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_ph_recoil_SUBPROTON_DUMMY_RAND","Phi Recoil (ph_bq)", 1000, -10.0, 10.0)
        H_th_recoil_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_th_recoil_SUBPROTON_DUMMY_RAND","Theta Recoil (th_bq)", 1000, -10.0, 10.0)
        H_pmiss_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_pmiss_SUBPROTON_DUMMY_RAND","pmiss", 1000, 0.0, 10.0)
        H_emiss_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_emiss_SUBPROTON_DUMMY_RAND","emiss", 1000, 0.0, 10.0)
        H_pmx_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_pmx_SUBPROTON_DUMMY_RAND","pmx", 1000, -10.0, 10.0)
        H_pmy_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_pmy_SUBPROTON_DUMMY_RAND","pmy ", 1000, -10.0, 10.0)
        H_pmz_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_pmz_SUBPROTON_DUMMY_RAND","pmz", 1000, -10.0, 10.0)
        H_ct_ep_SUBPROTON_DUMMY_RAND = ROOT.TH1D("H_ct_ep_SUBPROTON_DUMMY_RAND", "Electron-Proton CTime", 1000, -10, 10)
        ...
        for i in range(NumtBins):
            tbinDict["H_Q2_tbin_DATA_{}".format(i+1)] = ROOT.TH1D("H_Q2_tbin_DATA_{}".format(i+1), "Q2 (t bin {})".format(i+1), 1000, Q2min, Q2max)
            tbinDict["H_W_tbin_DATA_{}".format(i+1)] = ROOT.TH1D("H_W_tbin_DATA_{}".format(i+1), "W (t bin {})".format(i+1), 1000, Wmin, Wmax)
            tbinDict["H_t_tbin_DATA_{}".format(i+1)] = ROOT.TH1D("H_t_tbin_DATA_{}".format(i+1), "t (t bin {})".format(i+1), 1000, tmin, tmax)

        ################################################################################################################################################
        # 2D histograms

        MM_vs_CoinTime_DATA = ROOT.TH2D("MM_vs_CoinTime_DATA","Missing Mass vs CTime; MM; Coin_Time",1000, 0, 2, 1000, -2, 2)
        CoinTime_vs_beta_DATA = ROOT.TH2D("CoinTime_vs_beta_DATA", "CTime vs SHMS #beta; Coin_Time; SHMS_#beta", 1000, -2, 2, 1000, 0, 2)
        MM_vs_beta_DATA = ROOT.TH2D("MM_vs_beta_DATA", "Missing Mass vs SHMS #beta; MM; SHMS_#beta", 1000, 0, 2, 1000, 0, 2)
        phiq_vs_t_DATA = ROOT.TH2D("phiq_vs_t_DATA","; #phi ;t", 12, -3.14, 3.14, 24, tmin, tmax)
        polar_phiq_vs_t_DATA = ROOT.TGraphPolar()
        Q2_vs_W_DATA = ROOT.TH2D("Q2_vs_W_DATA", "Q^{2} vs W; Q^{2}; W", 1000, Q2min, Q2max, 1000, Wmin, Wmax)
        ...
        if ParticleType == "pion":
            H_ct_DATA = ROOT.TH1D("H_ct_DATA", "Electron-Pion CTime", 1000, -10, 10)
        if ParticleType == "proton":
            H_ct_DATA = ROOT.TH1D("H_ct_DATA", "Electron-Proton CTime", 1000, -10, 10)            
        H_cal_etottracknorm_DATA = ROOT.TH1D("H_cal_etottracknorm_DATA", "HMS Cal etottracknorm", 1000, 0.2, 1.8)
        H_cer_npeSum_DATA = ROOT.TH1D("H_cer_npeSum_DATA", "HMS Cer Npe Sum", 1000, 0, 30)
        P_cal_etottracknorm_DATA = ROOT.TH1D("P_cal_etottracknorm_DATA", "SHMS Cal etottracknorm", 1000, 0, 1)
        P_hgcer_npeSum_DATA = ROOT.TH1D("P_hgcer_npeSum_DATA", "SHMS HGCer Npe Sum", 1000, 0, 50)
        ...
        H_pmz_DUMMY  = ROOT.TH1D("H_pmz_DUMMY","pmz", 1000, -10.0, 10.0)
        if ParticleType == "pion":
            H_ct_DUMMY = ROOT.TH1D("H_ct_DUMMY", "Electron-Pion CTime", 1000, -10, 10)
        if ParticleType == "proton":
            H_ct_DUMMY = ROOT.TH1D("H_ct_DUMMY", "Electron-Proton CTime", 1000, -10, 10)
        ...
        H_pmz_RAND  = ROOT.TH1D("H_pmz_RAND","pmz", 1000, -10.0, 10.0)
        if ParticleType == "pion":
            H_ct_RAND = ROOT.TH1D("H_ct_RAND", "Electron-Pion CTime", 1000, -10, 10)
        if ParticleType == "proton":
            H_ct_RAND = ROOT.TH1D("H_ct_RAND", "Electron-Proton CTime", 1000, -10, 10)            
        ...
        H_pmz_DUMMY_RAND  = ROOT.TH1D("H_pmz_DUMMY_RAND","pmz", 1000, -10.0, 10.0)
        if ParticleType == "pion":
            H_ct_DUMMY_RAND = ROOT.TH1D("H_ct_DUMMY_RAND", "Electron-Pion CTime", 1000, -10, 10)
        if ParticleType == "proton":
            H_ct_DUMMY_RAND = ROOT.TH1D("H_ct_DUMMY_RAND", "Electron-Proton CTime", 1000, -10, 10)            
        ...
        MM_vs_beta_DATA = ROOT.TH2D("MM_vs_beta_DATA", "Missing Mass vs SHMS #beta; MM; SHMS_#beta", 100, 0, 2, 1000, 0, 2)
        phiq_vs_t_DATA = ROOT.TH2D("phiq_vs_t_DATA","; #phi ;t", 12, -3.14, 3.14, 24, tmin, tmax)
        polar_phiq_vs_t_DATA = ROOT.TGraphPolar()
        Q2_vs_W_DATA = ROOT.TH2D("Q2_vs_W_DATA", "Q^{2} vs W; Q^{2}; W", 1000, Q2min, Q2max, 1000, Wmin, Wmax)
