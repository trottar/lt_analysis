...
# Description:
# ================================================================
# Time-stamp: "2023-04-24 13:55:13 trottar"
# ================================================================
#
...
def defineHists(phi_setting, inpDict):    
    ...
    if ParticleType == "kaon":
        ...
        H_MM_SUBPION_DATA  = ROOT.TH1D("H_MM_SUBPION_DATA","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPION_DUMMY  = ROOT.TH1D("H_MM_SUBPION_DUMMY","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPION_RAND  = ROOT.TH1D("H_MM_SUBPION_RAND","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPION_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPION_DUMMY_RAND","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DATA  = ROOT.TH1D("H_MM_SUBPROTON_DATA","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DUMMY  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_RAND  = ROOT.TH1D("H_MM_SUBPROTON_RAND","MM_{K}", 200, 0.0, 2.0)
        ...
        H_MM_SUBPROTON_DUMMY_RAND  = ROOT.TH1D("H_MM_SUBPROTON_DUMMY_RAND","MM_{K}", 200, 0.0, 2.0)
        ...
        if phi_setting == "Right":
            normfac_subpion_dummy = 1/(1000)
            normfac_subpion_data = 1/(1000)
        if phi_setting == "Left":
            normfac_subpion_dummy = 1/(1000)
            normfac_subpion_data = 1/(1000)
        if phi_setting == "Center":
        ...
        if phi_setting == "Right":
            normfac_subproton_dummy = 1/(1000)
            normfac_subproton_data = 1/(1000)
        if phi_setting == "Left":
            normfac_subproton_dummy = 1/(1000)
            normfac_subproton_data = 1/(1000)
        if phi_setting == "Center":
