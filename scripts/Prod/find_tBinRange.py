...
# Description:
# ================================================================
# Time-stamp: "2023-02-16 20:37:38 trottar"
# ================================================================
#
...
for i,hist in enumerate(histlist):
    ...
    if hist["phi_setting"] == 'Right':
        ...
        MM_Right_tmp = []
        yield_Right = ROOT.TH1D("yield", "Yield", NumtBins*NumPhiBins, 0, 10.0)
    ...
    if hist["phi_setting"] == 'Left':
        ...
        MM_Left_tmp = []
        yield_Left = ROOT.TH1D("yield", "Yield", NumtBins*NumPhiBins, 0, 10.0)
    ...
    if hist["phi_setting"] == 'Center':
        ...
        MM_Center_tmp = []
        yield_Center = ROOT.TH1D("yield", "Yield", NumtBins*NumPhiBins, 0, 10.0)
